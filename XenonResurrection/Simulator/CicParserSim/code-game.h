// 27. dec 2020
// "sub_1FE70", "sub_1F787", "sub_1F6F8", "sub_1F585", "sub_10875", "sub_10DC5", "sub_109A7", "sub_10A73", "sub_205ED", "sub_20627", "sub_2217E", "sub_24178", "sub_24185", "sub_24130", "sub_116A9", "sub_10E6F", "sub_208DC", "sub_116BA", "sub_10762", "sub_1077C", "sub_1078E", "sub_11022", "sub_12BCC", "sub_135EB", "sub_107DC", "sub_107C0", "sub_10E91", "sub_208F9", "sub_1373D", "sub_11689", "sub_10FF0", "sub_13682", "sub_10EF5", "sub_13326", "sub_13A39", "sub_13AB2", "sub_14675", "sub_1465C", "sub_1472D", "sub_13589", "sub_11BEA", "sub_1714A", "sub_10F96", "sub_11C18", "sub_10F2F", "sub_144F3", "sub_11E29", "sub_11D1E", "sub_11E02", "sub_141E2", "sub_141B1", "sub_10A95", "sub_20653", "sub_10EDD", "sub_10EE1", "sub_11CCC", "sub_13A36", "sub_13615", "sub_170F1", "sub_10FB4", "sub_16EEF", "sub_10FD2", "sub_1758F", "sub_13389", "sub_1655B", "sub_172C4", "sub_1EBD0", "sub_10941", "sub_17520", "sub_1EC6F", "sub_14871", "sub_11BB4", "sub_11BA2", "sub_11B90", "sub_11ED3", "sub_14865", "sub_1480B",
...
loc_1F708:                                      //loc_1F708:
    ...
    _ror(_ax, _cl);                             //ror ax, cl
    memoryVideoSet(_es, _di+4, memoryVideoGet(_es, _di+4) & _ah);                //and es:[di+4], ah
    _di += 0x28;                                //add di, 28h
    _bl -= 1;                                   //dec bl
...
void sub_1465C()
{
    ...
    _cx = _pop();                               //pop cx
    _dx = _bx;                                  //mov dx, bx
{sub_10875(); return; };                        //jmp sub_10875
}
...
loc_11C43:                                      //loc_11C43:
    _di = memory16(_ds, _di + 10);              //mov di, [di+0Ah]
{sub_11C18(); return; };                        //jmp short sub_11C18
loc_11C48:                                      //loc_11C48:
...
void sub_144F3()
{
    ...
    if (!(_ax & _ax))                           //jz short loc_1454A
      goto loc_1454A;
    _ASSERT(0);
//    if ((sign)_ax < 0)                          //js short loc_14546
//      goto loc_14546;
...
loc_145A4:                                      //loc_145A4:
    ...
    if (!(_ax & _ax))                           //jz short loc_145C3
      goto loc_145C3;
    _ASSERT(0);
//    if ((sign)_ax < 0)                          //js short loc_145B9
//      goto loc_145B9;
...
void sub_11D1E()
{
    ...
    _cx -= 0x10;                                //sub cx, 10h
    //_ASSERT(0);
    if ((short)_cx <= 0)                                //jle short loc_11D97
      goto loc_11D97;
loc_11D71:                                      //loc_11D71:
    ...
    _cx -= 0x10;                                //sub cx, 10h
    //_ASSERT(0);
    if ((short)_cx > 0)                                //jg short loc_11D71
      goto loc_11D71;
loc_11D97:                                      //loc_11D97:
    _si = _pop();                               //pop si
}
...
void sub_141B1()
{
    ...
    switch (memory16(_cs, _di-2))
    {
        case 0x41e2: sub_141E2(); break;
        default:
            std::cout << "sub_141B1 goto cs:di-2, cs=" << std::hex << (int)_cs << ", ptr=" << std::hex << (int)(memory16(_cs, _di-2)) << std::endl;
            _ASSERT(0);
    }
...
loc_13620:                                      //loc_13620:
    _ax = memory16(_ds, _si);                   //mov ax, [si]
    if ((short)_ax < 0)                          //js short loc_13643  // TODO: (sign)_ax
      goto loc_13643;
...
void sub_16EEF()
{
  ...
  ///  _ASSERT(_bx == 0);
    ...
    _STOP_("sp-trace-fail");                    //sub_16EEF endp_failed
    _STOP_("continues");                        //loc_16F00:
...
void sub_1758F()
{
    ...
    memory16(_ds, _si + 22) = 0x10;             //mov word ptr [si+16h], 10h
    _ax = memory16(_cs, 0x6278);                //mov ax, cs:word_16278
...
loc_1ED43:                                      //loc_1ED43:
    ...
    _ax = 0xa400;                               //mov ax, 0A400h
    _ds = _ax;                                  //mov ds, ax
    memory(_ss, 0xC570) = 0;                    //mov ss:byte_447B0, 0
    memory(_ss, 0xC571) = 1;                    //mov ss:byte_447B0+1, 1
loc_1ED75:                                      //loc_1ED75:
    _dx = 0x03c4;                               //mov dx, 3C4h
    _ah = memory(_ss, 0xC571);                  //mov ah, ss:byte_447B0+1
    _al = 0x02;                                 //mov al, 2
    _out(_dx, _ax);                             //out dx, ax
    _dx = 0x03ce;                               //mov dx, 3CEh
    _ah = memory(_ss, 0xC570);                  //mov ah, ss:byte_447B0
    _al = 0x04;                                 //mov al, 4
    _out(_dx, _ax);                             //out dx, ax
    _push(_si);                                 //push si
    _push(_di);                                 //push di
...
loc_1ED8E:                                      //loc_1ED8E:
    ...
    _di = _pop();                               //pop di
    _si = _pop();                               //pop si
    memory(_ss, 0xC570) += 1;                   //inc ss:byte_447B0
    memory(_ss, 0xC571) <<= 1;                  //shl ss:byte_447B0+1, 1
    if ((char)memory(_ss, 0xC570) < (char)4)    //jl short loc_1ED75
      goto loc_1ED75;
    _dx = 0x03c4;                               //mov dx, 3C4h
    _ax = 0x0f02;                               //mov ax, 0F02h
    _out(_dx, _ax);                             //out dx, ax
...
loc_14A4F:                                      //loc_14A4F:
    ...
    _ASSERT(0);
//    if ((sign)_dx < 0)                          //js short loc_14A4F
//      goto loc_14A4F;
    _di = memory16(_ds, _si + 56);              //mov di, [si+38h]
    _di += _dx;                                 //add di, dx
    memory16(_ds, _si + 58) = _di;              //mov [si+3Ah], di
...
void sub_14865()
{
    ...
    if (memory16(_ds, _si) == 4)                //jz short locret_14870
      goto locret_14870;
{sub_13589(); return; };                        //jmp sub_13589
