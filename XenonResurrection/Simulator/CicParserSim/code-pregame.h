...
{sub_15950(); return; };                        //jmp sub_15950
}
...
void sub_10F78()
{
    ...
    _STOP_("continues");                        //byte_10F8C db 8Fh, 75h, 1, 8Eh, 4Eh, 0ACh,...
}
...
void sub_15926()
{
    ...
    _ax = 0x64;                                 //mov ax, 64h
    sub_1595D();                                //call sub_1595D
{sub_15950(); return; };                        //jmp short sub_15950
}
...
void sub_1370B() // draw sprite
{
loc_1370B:
    _ASSERT(_ds == 0x2853);
    std::cout << "sub_1370B: ds=" << std::hex << (int)_ds << " dbg=" << std::hex << (int) memory16(_ds, _si) << " [_si+4]=" << std::hex << (int) memory16(_ds, _si+4) << "\n";
    ...
    switch (memory16(_ds, _si + 4))
    {
        ...
        case 0x1e00: loc_11E00(); break;
        default:
            std::cout << "sub_1370B: indirect call, [_si+4]=" << std::hex << (int) memory16(_ds, _si+4) << std::endl;
            _ASSERT(0);
            _pop();
            return;
    }
...
//{sub_1370B(); return; };                        //jmp short sub_1370B
...
loc_15B13:                                      //loc_15B13:
    ...
    _si = _pop();                               //pop si
    _cx = 0x0001;                               //mov cx, 1
{sub_1595D(); return; };                        //jmp sub_1595D
}
...
void sub_15E24()
{
    ...
    _dx = _pop();                               //pop dx
{sub_15E24(); return; };                        //jmp short sub_15E24
