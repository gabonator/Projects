...
void sub_109EB()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
    _ASSERT(_bp == 12);
    sub_2058D();
  //_STOP_("call cs:off_109F9[bp]");                //call cs:off_109F9[bp]
}
...
void sub_10B83()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10B91[bp]");                //call cs:off_10B91[bp]
    _ASSERT(_bp == 12);
    sub_20A39();
}
...
void sub_10BC7()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
    _ASSERT(_bp==12);
    sub_20B5B();
  //_STOP_("call cs:off_10BD5[bp]");                //call cs:off_10BD5[bp]
}
...
void sub_10BE9()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
 // _STOP_("call cs:off_10BF7[bp]");                //call cs:off_10BF7[bp]
    _ASSERT(_bp == 12);
    sub_20B8A();
}
...
void sub_10E2B()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10E39[bp]");                //call cs:off_10E39[bp]
    _ASSERT(_bp == 12);
    sub_1F3B5();
}
...
void sub_1080F()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_1081D[bp]");                //call cs:off_1081D[bp]
    sub_1F3EF();
}
...
void sub_10A2F()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10A3D[bp]");                //call cs:off_10A3D[bp]
    sub_205AE();
}
...
void sub_10E4D()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10E5B[bp]");                //call cs:off_10E5B[bp]
    sub_20854();
}
...
void sub_20854()
{
  ...
  _ax = _ax - memory16(_ds, 0x9156);
    _dx -= memory16(_ds, 0x9158) - _flags.sign;
  //_sbb(_dx, memory16(_ds, 0x9158));               //sbb dx, word_31688
...
loc_20879:                                        //loc_20879:
  ...
  _di = 0x1e06;                                   //mov di, 1E06h
    _flags.carry = (int)memory16(_ds, 0x9156) + 1000 >= 0x10000;
...
#warning sbb???
    _flags.carry = (int)memory16(_ds, 0x9156) + 0x64 >= 0x10000;  // ----
...
loc_2089F:                                        //loc_2089F:
  memory16(_ds, 0x9158) += _flags.carry;
...
void sub_10BA5()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10BB3[bp]");                //call cs:off_10BB3[bp]
    sub_20AD0();
}
...
void sub_136FC()
{
  ...
  _si = _pop();                                   //pop si
  goto sub_136FC;                                 //jmp short sub_136FC
...
void sub_1370B()
{
  ...
  _si = _pop();                                   //pop si
  goto sub_1370B;                                 //jmp short sub_1370B
