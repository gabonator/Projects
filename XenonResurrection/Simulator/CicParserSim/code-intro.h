/*
todo: switche, lea, return label, kontrolovat CS pri kazdej funkcii!!!!!
 rcl-carry
 call    near ptr sub_20A47 je ako goto? - goto func entry
 call near ptr meni stack!!!
 idiv nasobi!!
 
 verify: flag = x & 0x8000
 */
// startup - 2
...
void sub_10D5F()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10D6D[bp]");                //call cs:off_10D6D[bp]
    /*
...
*/
    switch(_bp)
    {
        ...
        case 8:sub_1F3C7(); break;
        case 12:sub_21836(); break;
    }
}
...
void sub_10A0D()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
 // _STOP_("call cs:off_10A1B[bp]");                //call cs:off_10A1B[bp]
    switch(_bp)
    {
...
void sub_10A51()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
 //_STOP_("call cs:off_10A5F[bp]");                //call cs:off_10A5F[bp]
    switch (_bp)
    {
...
void sub_10AFB()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10B09[bp]");                //call cs:off_10B09[bp]
    switch (_bp)
    {
...
void sub_10D1B()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10D29[bp]");                //call cs:off_10D29[bp]
    switch (_bp)
    {
        case 0: sub_211CC(); break; /// planes
        case 4: sub_24AAA(); break; // b800
        case 8: sub_229C0(); break; // neviem
...
void sub_10D81()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10D8F[bp]");                //call cs:off_10D8F[bp]
    switch (_bp)
    {
...
void sub_10DE7()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10DF5[bp]");                //call cs:off_10DF5[bp]
    switch (_bp)
    {
...
void sub_10B3F()
{
  ...
  _bp <<= 1;                                      //shl bp, 1
  _bp <<= 1;                                      //shl bp, 1
  //_STOP_("call cs:off_10B4D[bp]");                //call cs:off_10B4D[bp]
    switch (_bp)
    {
...
void sub_1F492() // full background draw?
{
  _dx = 0x03ce;                                   //mov dx, 3CEh
  _ax = 0x0f01;                                   //mov ax, 0F01h
  _out(_dx, _ax);                                 //out dx, ax
...
loc_1F4D2:                                        //loc_1F4D2:
  ...
  _ax <<= 1;                                      //shl ax, 1
    _rcl(_dx, 1);  _flags.carry = !!(_ax & 0x8000);    //rcl dx, 1
  _ax <<= 1;                                      //shl ax, 1
    _rcl(_dx, 1);   _flags.carry = !!(_ax & 0x8000);   //rcl dx, 1
  _ax <<= 1;                                      //shl ax, 1
    _rcl(_dx, 1);  _flags.carry = !!(_ax & 0x8000);   //rcl dx, 1
...
loc_160B9:                                        //loc_160B9:
  ...
  _ASSERT(0 /* check carry */); _rcl(_dl, 1);     //rcl dl, 1
  _ASSERT(0 /* check carry */); _rcl(_dl, 1);     //rcl dl, 1
...
beg:
  ...
  _push(_si);                                     //push si
///////////#warning call near ptr!!!!
  //////////_push(_cs);                                     //push cs
  sub_20A5C();                                    //call near ptr sub_20A5C
  _si = _pop();                                   //pop si
  _xchg(_si, _bp);                                //xchg si, bp
  _di += 0x0002;                                  //add di, 2
  //goto near ptr sub_20A47;                        //jmp short near ptr
    goto beg;
