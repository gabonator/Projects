...
function sub_10BB1() {
    ...
    indirectCall(ds, memory16get(ds*16+0x3E));
    r16[ax] = pop();
    memory16set(ds*16+0x5A, r16[ax]);
}
function sub_10BC4() {
    ...
    case 0:
        ...
        push(r16[ax]);
        push(r16[dx]);
        indirectCall(ds, memory16get(ds*16+0x24));
        ...
        sub_10BB1();
        sub_19AF6();
        indirectCall(ds, memory16get(ds*16+0x1C));
        si = 0x0162;
        r16[cx] = 0x0010;
    case 0x10C15:
        push(r16[cx]);
...
function sub_10EC0() {
    ...
    memory16set(ds*16+0x5A, r16[dx]);
    indirectCall(ds, memory16get(ds*16+0xC));
    r16[dx] = pop();
    memory16set(ds*16+0x5A, r16[dx]);
}
function sub_10EE8() {
...
function sub_11162() {
    ...
    case 0x1117A:
        ...
        push(ds);
        push(si);
        indirectCall(ds, memory16get(ds*16+0x40));
        si = pop();
        ds = pop();
    case 0x11191:
        si += 0x001c;
...
function sub_16B3B() {
    ...
    r16[ax] = 0x0004;
    si = 0x6616;
    indirectCall(ds, memory16get(ds*16+0xE));
    r16[ax] = 0x000d;
    si = 0x66f6;
    indirectCall(ds, memory16get(ds*16+0xE));
    r16[ax] = 0x0015;
...
function* sub_16B9B() {
    ...
    do switch (pc) {
    case 0:
        indirectCall(ds, memory16get(ds*16+0x26));
        indirectCall(ds, memory16get(ds*16+0x28));
...
function sub_16CD7() {
    ...
    case 0:
        ...
        r16[ax] = 0x0008;
        si = 0x9401;
        indirectCall(ds, memory16get(ds*16+0x46));
        r16[ax] = 0x0108;
        si = 0x9421;
        indirectCall(ds, memory16get(ds*16+0x46));
        r16[ax] = 0x0208;
...
function sub_17047() {
    ...
    memory16get(ds*16+0x6C45) &= 0x0007;
    indirectCall(ds, memory16get(ds*16+0x12));
}
function sub_1705D() {
    var pc = 0;
    do switch (pc) {
...
function sub_1709D() {
    ...
    case 0x170BB:
        ...
        sub_195EA();
        sub_1930A();
        indirectCall(ds, memory16get(ds*16+0x14));
        sub_17180();
        r16[dx] = 0x0008;
        sub_17132();
        sub_15FE4();
...
function sub_170E6() {
    ...
    case 0x17104:
        ...
        sub_1961D();
        sub_192DA();
        indirectCall(ds, memory16get(ds*16+0x16));
        sub_17180();
        r16[dx] = 0xfff8;
        sub_17132();
        sub_15FE4();
...
function sub_18351() {
    ...
    case 0x18630:
        ...
        memory16get(ds*16+0x7ED0) += 0x0008;
    ...
    case 0x1866A:
        ...
        r16[bx] = memory16get(ds*16+0xB1E);
        memory16set(ds*16+0x7ECE, r16[bx]);
        memory16get(ds*16+0x7ECE) += 0x0018;
        memory16set(ds*16+0x7ED0, r16[ax]);
        memory16get(ds*16+0x7ED0) += 0x0008;
        memory16set(ds*16+0x7ECC, 0x0001);
        memory16set(ds*16+0x7ED2, 0x000a);
    ...
    case 0x18975:
        ...
        break;
    case 0x1897F:
        memory16get(ds*16+0xB26) += 0x000d;
        pc = 0x18A8F;
        break;
    case 0x18987:
        r16[ax] = memory16get(ds*16+0xB20);
...
function sub_18CBE() {
    ...
    case 0x18CD9:
        ...
        memory16get(ds*16+0x795F) += 0x0004;
        sub_18014();
        push(r16[ax]);
        sub_181C6();
        r16[ax] = pop();
...
function sub_192DA() {
    ...
    di = 0x5b1c;
    sub_1926D();
    memory16get(ds*16+0x8BFA) += 0x0001;
    memory16get(ds*16+0x8BFA) &= 0x0003;
    if (memory16get(ds*16+0x8BFA) != 0)
        return;
    memory16get(ds*16+0x8BF8) += 0x0008;
    return;
}
function sub_1930A() {
    var pc = 0;
...
function sub_19553() {
    ...
    case 0:
        ...
        indirectCall(ds, memory16get(ds*16+0x20));
        return;
    case 0x19568:
        memory16set(ds*16+0xB1E, 0x0000);
        indirectCall(ds, memory16get(ds*16+0x22));
        return;
    } while (1);
}
function sub_19577() {
...
function loc_19650() {
    ...
    do switch (pc) {
    case 0:
        indirectCall(ds, memory16get(ds*16+0x3C));
        r16[ax] = memory16get(ds*16+0x8BEC);
        if (r16[ax] != 0x0004) {
            pc = 0x19687;
            break;
...
function sub_196DD() {
    indirectCall(ds, memory16get(ds*16+0x0));
    sub_1933F();
    indirectCall(ds, memory16get(ds*16+0x10));
    indirectCall(ds, memory16get(ds*16+0x18));
    sub_1ADCB();
    sub_1BC92();
}
function loc_196F3() {
...
function sub_1A16B() {
    ...
    case 0:
        ...
        indirectCall(ds, memory16get(ds*16+0x30));
        return;
    case 0x1A174:
        r8[ah] = r8[ah] ^ r8[ah];
        r16[ax] -= 1;
        ...
        r16[bx] += 1;
        indirectCall(ds, memory16get(ds*16+0x2C));
        r16[ax] = r16[ax] ^ r16[ax];
        r8[al] = memory[ds*16+r16[bx]];
        r16[bx] += 1;
        si += r16[ax];
        ...
        push(di);
        push(si);
        indirectCall(ds, memory16get(ds*16+0x2E));
        si = pop();
        di = pop();
        r16[cx] = pop();
        r16[bx] = pop();
...
function sub_1A1BC() {
    ...
    case 0:
        ...
        push(r16[bx]);
        push(si);
        indirectCall(ds, memory16get(ds*16+0x32));
        si = pop();
        r16[bx] = pop();
        r16[ax] = pop();
    case 0x1A1CE:
...
function sub_1A257() {
    ...
    case 0x1A2AF:
        ...
        si = 0x9bb8;
        si += r16[ax];
        indirectCall(ds, memory16get(ds*16+si));
        pc = 0x1A2AF;
        break;
        return;
    } while (1);
...
function loc_1A2D3() {
    ...
    case 0x1A2F1:
        ...
        _STOP_("db 0C6h, 1Ah, 0EBh, 0ECh, 0C3h");
        return;
    } while (1);
}
function sub_1A44F() {
...
function sub_1AE81() {
    ...
    case 0x1AEC2:
        memory16set(ds*16+0x96F4, 0x0001);
        indirectCall(ds, memory16get(ds*16+0x4A));
        return;
    } while (1);
}
function sub_1AECD() {
...
function sub_1A3CF() {
    ...
    case 0x1A419:
        _cbw();
        memory16get(ds*16+si + 4) += r16[ax];
        r16[bx] -= 1;
        r8[al] = memory[ds*16+r16[bx]];
        _cbw();
        memory16get(ds*16+si + 8) += 1;
...
function sub_1A2F6() {
    ...
    case 0x1A32A:
        indirectCall(ds, memory16get(ds*16+0x34));
        indirectCall(ds, memory16get(ds*16+0x44));
        sub_19B1C();
        indirectCall(ds, memory16get(ds*16+0x1C));
        indirectCall(ds, memory16get(ds*16+0x38));
    case 0x1A33D:
        r16[cx] = pop();
        if (--r16[cx]) {
            pc = 0x1A304;
