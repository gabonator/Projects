...
loc_004f:                                       //loc_004f:
    ...
    _ds = _ax;                                  //mov ds, ax
    memory16(_ds, 144) = 0x08d0;                //mov word ptr [0x90], 0x8d0
    memory16(_ds, 146) = _cs;                   //mov word ptr [0x92], cs
    _ds = _pop();                               //pop ds
    ...
    _al = _ah;                                  //mov al, ah
    _out(64, _al);                              //out 0x40, al
    sub_53a2();                                 //call sub_53a2
    sub_52ec();                                 //call sub_52ec
...
loc_09bf:                                       //loc_09bf:
    ...
    if (_ah != 0x10)                            //jnz loc_09cf
        goto loc_09cf;
    _STOP_("goto loc_0af6");                    //jmp loc_0af6
loc_09cf:                                       //loc_09cf:
    _bx = _ax;                                  //mov bx, ax
    _lodsw<MemData, DirForward>();              //lodsw
    _cx = 0x0004;                               //mov cx, 0x4
...
loc_0abe:
    ...
    if (_dl == 0)                               //jz loc_0a7e
        _STOP_("goto loc_0a7e");
    _rol(_ax, 1);                               //rol ax, 1
    if (_FIXME_)                                //jnc loc_0ac8
        goto loc_0ac8;
    _bx += 1;                                   //inc bx
    _bx += 1;                                   //inc bx
loc_0ac8:                                       //loc_0ac8:
...
void sub_0e33()
{
    ...
    _les(_di, _ds, 0x000c);                     //les di, [0xc]
    _stosb<MemData, DirForward>();              //stosb
...
void sub_107d()
{
    ...
    _ax = _ax ^ _ax;                            //xor ax, ax
    _es = _ax;                                  //mov es, ax
    _push(memory16(_es, 24));                   //push word ptr es:[0x18]
    _push(memory16(_es, 26));                   //push word ptr es:[0x1a]
    memory16(_es, 24) = 0x10bc;                 //mov word ptr es:[0x18], 0x10bc
    memory16(_es, 26) = _cs;                    //mov word ptr es:[0x1a], cs
    _al = 0x01;                                 //mov al, 0x1
...
loc_10b1:                                       //loc_10b1:
    ...
    _STOP_("db 06h");                           //db 06h
loc_10c5:                                       //loc_10c5:
    memory16(_es, 26) = _pop();                 //pop word ptr es:[0x1a]
    memory16(_es, 24) = _pop();                 //pop word ptr es:[0x18]
    _flags.interrupt = true;                    //sti
    _es = _pop();                               //pop es
    _ds = _pop();                               //pop ds
}
...
loc_1161:                                       //loc_1161:
    _bx += 1;                                   //inc bx
    _bx += 1;                                   //inc bx
    if (memory16(_ds, _bx + -2) != 0xffffffff)  //jnz loc_1161
        goto loc_1161;
...
loc_1174:                                       //loc_1174:
    _bx += 1;                                   //inc bx
    _bx += 1;                                   //inc bx
    if (memory16(_ds, _bx + -2) != 0xffffffff)  //jnz loc_1174
        goto loc_1174;
...
loc_1180:                                       //loc_1180:
    _si += 1;                                   //inc si
    _si += 1;                                   //inc si
    if (memory16(_ds, _si) != 0xffffffff)       //jnz loc_1180
        goto loc_1180;
...
loc_128d:                                       //loc_128d:
    ...
    _dx += 1;                                   //inc dx
    if (_cx != 0xffffffff)                      //jnz loc_128d
        goto loc_128d;
    _di = _pop();                               //pop di
    _si = _pop();                               //pop si
    _cx = _pop();                               //pop cx
...
loc_12ce:                                       //loc_12ce:
    ...
    if (_si == 0xffffffff)                      //jz loc_1331
        goto loc_1331;
    if (_si == 0xfffffffe)                      //jz loc_1327
        goto loc_1327;
...
void sub_183f()
{
    _ax = 0x168f;                               //mov ax, 0x168f
    _ds = _ax;                                  //mov ds, ax
    if (memory16(_ds, 10) < 0x07cc)             //jc loc_183e
...
loc_1c72:                                       //loc_1c72:
    ...
    if (memory16(_ds, _si + 4) != 0xffffffff)   //jnz loc_1c7f
        goto loc_1c7f;
...
void sub_3126()
{
    ...
    memory(_es, 8192) = _al;                    //mov es:[0x2000], al
    if (memory(_es, 8192) != _al)               //jnz loc_315e
        goto loc_315e;
    _ax = 0x0103;                               //mov ax, 0x103
    _out(_dx, _ax);                             //out dx, ax
    memory(_es, _si) = 0xaa;                    //mov byte ptr es:[si], 0xaa
    if (memory(_es, _si) != 0x55)               //jnz loc_315e
        goto loc_315e;
    _flags.carry = false;                       //clc
    return;                                     //ret
loc_315e:                                       //loc_315e:
...
loc_39d1:                                       //loc_39d1:
    ...
    _cl = 0x04;                                 //mov cl, 0x4
loc_39e0:                                       //loc_39e0:
    if (memory16(_ds, _si + 4) != 0xffffffff)   //jnz loc_39e9
        goto loc_39e9;
...
loc_3c7b:                                       //loc_3c7b:
    ...
    _push(_si);                                 //push si
    sub_5133();                                 //call sub_5133
    if (_FIXME_)                                //jnz loc_3cd4
        goto loc_3cd4;
    _push(_di);                                 //push di
    sub_5133();                                 //call sub_5133
    if (_FIXME_)                                //jnz loc_3c9e
        goto loc_3c9e;
...
loc_3d12:                                       //loc_3d12:
    if (!(memory(_ds, _si + 5) & 0x20))         //jz loc_3d8a
        goto loc_3d8a;
    if (memory16(_ds, 21138) != 0xffffffff)     //jnz loc_3d8a
        goto loc_3d8a;
...
loc_3d3f:                                       //loc_3d3f:
    ...
    if ((short)_ax < (short)_FIXME_)            //jl loc_3d55
        goto loc_3d55;
    _ax = _ax ^ _ax;                            //xor ax, ax
loc_3d55:                                       //loc_3d55:
    memory16(_ds, _si + 14) = _ax;              //mov word ptr [si+0xe], ax
...
loc_3d77:                                       //loc_3d77:
    ...
    if ((short)memory16(_ds, _si + 14) <= (short)_FIXME_)
        goto loc_3d87;
...
void sub_40fa()
{
    ...
    _ax = 0x000a;                               //mov ax, 0xa
loc_410b:                                       //loc_410b:
    if (memory16(_ds, _si + 4) == 0xffffffff)   //jz loc_4133
        goto loc_4133;
    _bx = _bx ^ _bx;                            //xor bx, bx
...
void sub_4561()
{
    ...
    if ((short)memory16(_ds, 21118) > (short)0xffffffff)
        goto loc_4585;
    sub_4c65();                                 //call sub_4c65
...
void sub_4657()
{
    ...
    _cx = 0x0004;                               //mov cx, 0x4
loc_4674:                                       //loc_4674:
    if (memory16(_ds, _si + 4) == 0xffffffff)   //jz loc_4654
...
loc_49bc:                                       //loc_49bc:
    ...
    _dx = memory16(_ds, 21116);                 //mov dx, word ptr [0x527c]
loc_49ca:                                       //loc_49ca:
    if (memory16(_ds, _di + 4) != 0xffffffff)   //jnz loc_49d3
        goto loc_49d3;
...
void sub_4ae9()
{
    if (memory16(_ds, 21138) == 0xffffffff)     //jz loc_4b48
        goto loc_4b48;
...
loc_5825:                                       //loc_5825:
    ...
    if (memory(_ds, 25865) != 0x00)             //jnz loc_5891
        goto loc_5891;
    _si = 0x528e;                               //mov si, 0x528e
    if (memory16(_ds, _si + 4) == 0xffffffff)   //jz loc_5891
        goto loc_5891;
    sub_5095();                                 //call sub_5095
...
void sub_58c8()
{
    ...
    _cl = 0x04;                                 //mov cl, 0x4
loc_58d0:                                       //loc_58d0:
    if (memory16(_ds, _si + 4) == 0xffffffff)   //jz loc_5926
        goto loc_5926;
    _ax = memory16(_ds, _si + 6);               //mov ax, word ptr [si+0x6]
    _ax |= _ax;                                 //or ax, ax
...
void sub_592d()
{
    ...
    _cx = 0x0004;                               //mov cx, 0x4
loc_5934:                                       //loc_5934:
    if (memory16(_ds, _di + 4) != 0xffffffff)   //jnz loc_593d
        goto loc_593d;
    _cx = _pop();                               //pop cx
    _flags.carry = false;                       //clc
    return;                                     //ret
...
void sub_5945()
{
    ...
    _si = 0x7699;                               //mov si, 0x7699
loc_5953:                                       //loc_5953:
    if (memory16(_ds, _si + 4) == 0xffffffff)   //jz loc_5965
        goto loc_5965;
    _bx = memory16(_ds, _si + 6);               //mov bx, word ptr [si+0x6]
    _bh &= 0x1f;                                //and bh, 0x1f
    _bx <<= 1;                                  //shl bx, 1
