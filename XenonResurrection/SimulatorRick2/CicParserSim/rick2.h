...
loc_108AA:                                      //loc_108AA:
    ...
    _di += _cx;                                 //add di, cx
    _movsb<MemVideo, MemVideo, DirForward>();
    _di += (short)0xff20;                              //add di, 0FF20h
    _cx = _bp;                                  //mov cx, bp
...
loc_192C4:                                      //loc_192C4:
    ...
    if (_dx != 0)                               //jnz short loc_192C4
      goto loc_192C4;
    _di += (short)0xff84;                              //add di, 0FF84h
    _cx = _bp;                                  //mov cx, bp
...
loc_1A2AF:                                      //loc_1A2AF:
    ...
    std::cout << "Skip intro\n";
    //_indirectCall(_ds, memory16(_ds, _si));                    //call word ptr [si]
