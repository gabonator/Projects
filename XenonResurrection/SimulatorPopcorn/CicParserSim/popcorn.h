...
loc_2AF6F:                                      //loc_2AF6F:
    ...
    sub_2ACB0();                                //call sub_2ACB0
    _popf();                                    //popf
    if (!_flags.carry)                                //jnb short loc_2AF96
        goto loc_2AF96;
...
loc_2AFB8:                                      //loc_2AFB8:
    ...
    // g1 copy map
    std::cout <<"g1 copy map" << (int)_es << ":" << (int)_di << " = " <<
    (int)_ds << ":" << (int)_si << "\n";
    std::cout << "dest = " << (int)_es*16+_di << " source = " << (int)_ds*16+_si
        << "\n";
    // should be 1C46:0000
//    _ASSERT(memory(_ds, _si) == 0);
//    _ASSERT(memory(_es, _di) == 0);
    _rep_movsb<MemAuto, MemAuto, DirAuto>();    //rep movsb
...
loc_2B98B:                                      //loc_2B98B:
    ...
    if (memory(_ds, 0x2E78) == 0x01)            //jz short loc_2B99D
        goto loc_2B99D;
    _ax = _pop();                               //pop ax
    return 0x2AF6F; //_STOP_("goto loc_2AF6F");                   //jmp loc_2AF6F
loc_2B99D:                                      //loc_2B99D:
    _di = 0x344f;                               //mov di, 344Fh
    _bh = _bh ^ _bh;                            //xor bh, bh
    _bl = memory(_ds, 0x3F0A);                  //mov bl, ds:3F0Ah
...
loc_2BD56:                                      //loc_2BD56:
    ...
    _sync();
    if (!_flags.carry)                                //jnb short loc_2BD86
        goto loc_2BD86;
    _di = _pop();                               //pop di
    _dl = 0x0e;                                 //mov dl, 0Eh
    _ax = _ax ^ _ax;                            //xor ax, ax
...
void sub_2C274() // keyboard input/mouse
{
    WORD _cs = _seg004;
...
loc_2C742:                                      //loc_2C742:
    ...
    if (!_flags.carry)                                //jnb short loc_2C755
        goto loc_2C755;
    _cx = _pop();                               //pop cx
    sub_2EDF4();                                //call sub_2EDF4
    memory(_ds, 0x2E78) = 0x01;                 //mov byte ptr ds:2E78h, 1
...
void sub_2CA70()
{
    ...
    _rep_movsb<MemAuto, MemAuto, DirAuto>();
    _cx = _bp;                                  //mov cx, bp
    _cl &= 0x03;                                //and cl, 3
...
loc_2CABA:                                      //loc_2CABA:
    ...
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    memoryVideoSet(_es, _di + 2, memoryVideoGet16(_es, _di + 2) ^ _al);
...
loc_2CEB3:                                      //loc_2CEB3:
    _lodsw<MemAuto, DirAuto>();                 //lodsw
    memoryVideoXor16(_es, _bx, _ax);//xor es:[bx], ax
    _bx += 1;                                   //inc bx
    _bx += 1;                                   //inc bx
    if (--_cx)                                  //loop loc_2CEB3
        goto loc_2CEB3;
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    memoryVideoXor(_es, _bx, _al);  //xor es:[bx], al
    _di += 1;                                   //inc di
    _di += 1;                                   //inc di
    _cx = _dx;                                  //mov cx, dx
...
void sub_2D447() // gabo carry not sure
{
    _bp = _si;                                  //mov bp, si
    _si += 0x0004;                              //add si, 4
    _di = _bp;                                  //mov di, bp
...
loc_2D4CE:                                      //loc_2D4CE:
    ...
    if (--_cx)                                  //loop loc_2D4CE
        goto loc_2D4CE;
    _flags.carry = false; // gabo not sure
    _es = _dx;                                  //mov es, dx
    return;                                     //retn
loc_2D4E1:                                      //loc_2D4E1:
    _di += 0x2000;                              //add di, 2000h
...
void sub_2DE93()
{
    ...
    if (_flags.carry)                           //jb short nullsub_2
        return; // gabo _STOP_("goto nullsub_2");
    _flags.carry = _dl & 1;                     //shr dl, 1
    _dl >>= 1;
    if (_flags.carry)                           //jb short nullsub_2
        return; // gabo _STOP_("goto nullsub_2");
...
void sub_2E181()
{
    ...
    if (_flags.carry)                           //jb short nullsub_3
        return; // gabo?? _STOP_("goto nullsub_3");
    _flags.carry = _dl & 1;                     //shr dl, 1
    _dl >>= 1;
    if (_flags.carry)                           //jb short nullsub_3
        return; // gabo?? _STOP_("goto nullsub_3");
...
loc_2E1EE:                                      //loc_2E1EE:
    ...
    if (_dx <= _cx)                             //jbe short loc_2E1FF
        goto loc_2E1FF;
    _WARN_("goto loc_2DF5C");                   //jmp loc_2DF5C
loc_2E1FF:                                      //loc_2E1FF:
    _al = memory(_ds, 0x2D39);                  //mov al, ds:2D39h
    memory(_ds, _bx + 6) = _al;                 //mov [bx+6], al
    _ah = _ah ^ _ah;                            //xor ah, ah
...
void sub_2E52D()
{
    ...
    if (_ah != 0)                               //jnz short locret_2E52C
        return; //_STOP_("goto locret_2E52C");
...
loc_2E7AC:                                      //loc_2E7AC:
    ...
    memoryVideoSet16(_es, _di, memoryVideoGet16(_es, _di) ^ _ax);//xor es:[di], ax
    _lodsw<MemAuto, DirAuto>();                 //lodsw
    memoryVideoSet16(_es, _di + 2, memoryVideoGet16(_es, _di + 2) ^ _ax);
...
void sub_2E9B5()
{
    ...
    if (memory(_ds, _si + 3) != 0x00)           //jnz short nullsub_1
        return; // gabo? //{_STOP_("goto nullsub_1");}
...
loc_2ECB1:                                      //loc_2ECB1:
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    memoryVideoXor(_es, _di, _al);  //xor es:[di], al
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    memoryVideoXor(_es, _di + 1, _al);
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    memoryVideoXor(_es, _di + 2, _al);
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    memoryVideoXor(_es, _di + 3, _al);
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    memoryVideoXor(_es, _di + 4, _al);
...
loc_2ED69:                                      //loc_2ED69:
    ...
    _flags.carry = true;                        //stc
loc_2ED73:                                      //loc_2ED73:
    _al = _al + memory(_ds, _di) + _flags.carry;
    _bl = _al;                                  //mov bl, al
...
void sub_2F9B6()
{
    ...
    if (_flags.carry)                                //jnb short loc_2F9BF
        goto loc_2F9BF;
...
void sub_2FCFF()
{
    ...
    _di = 0x0000;                               //mov di, 0
    _cx = 0x0003;                               //mov cx, 3
    _rep_movsw<MemAuto, MemAuto, DirAuto>();
loc_2FD2A:                                      //loc_2FD2A:
    _push(_es);                                 //push es
    _ax = 0xb800;                               //mov ax, 0B800h
    _es = _ax;                                  //mov es, ax
...
loc_2FD67:                                      //loc_2FD67:
    _push(_di);                                 //push di
    _flags.carry = true;                        //stc
    memoryVideoSet(_es, _di, memoryVideoGet(_es, _di) << 1);             //shl byte ptr es:[di], 1
    _di -= 1;                                   //dec di
    _bl = 0x0d;                                 //mov bl, 0Dh
loc_2FD6F:                                      //loc_2FD6F:
    _tl = memoryVideoGet(_es, _di);
    _rcl(_tl, 1);
    memoryVideoSet(_es, _di, _tl);
    _di -= 1;                                   //dec di
    _bl -= 1;                                   //dec bl
...
loc_3006F:                                      //loc_3006F:
    ...
    _bx = _bx ^ _bx;                            //xor bx, bx
    _ds = _bx;                                  //mov ds, bx
    _ax = _ax + memoryBiosGet16(_ds, 0x46C);           //add ax, ds:46Ch
    _ax = _ax + memoryBiosGet16(_ds, 0x46E);           //add ax, ds:46Eh
    _ds = _cx;                                  //mov ds, cx
...
loc_300DE:                                      //loc_300DE:
    memory16(_ds, _si + 12) = _dx;              //mov [si+0Ch], dx
    _ax = memory16(_ds, _si + 14);              //mov ax, [si+0Eh]
    _imul(memory16(_ds, _si + 4));              //imul word ptr [si+4]
    _imul(memory16(_ds, _si + 4));              //imul word ptr [si+4]
    _cx = 0x0064;                               //mov cx, 64h
    _idiv(_cx);                                 //idiv cx
...
loc_3010B:                                      //loc_3010B:
    ...
    _bx = _di;                                  //mov bx, di
    _cx = 0x000c;                               //mov cx, 0Ch
    _rep_movsw<MemVideo, MemAuto, DirBackward>();
    _di = _bx;                                  //mov di, bx
...
loc_30126:                                      //loc_30126:
    ...
    _cx = 0x000a;                               //mov cx, 0Ah
    _di -= 0x0004;                              //sub di, 4
    _rep_stosw<MemVideo, DirBackward>();
    _di = _bx;                                  //mov di, bx
    _cx = 0x0032;                               //mov cx, 32h
loc_30138:                                      //loc_30138:
    sub_2C26C();                                //call sub_2C26C
...
loc_3018F:                                      //loc_3018F:
    ...
    _bx = _di;                                  //mov bx, di
    _cx = 0x000c;                               //mov cx, 0Ch
    _rep_movsw<MemVideo, MemAuto, DirForward>();
    _di = _bx;                                  //mov di, bx
