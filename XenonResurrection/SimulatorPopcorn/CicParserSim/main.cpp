...
void memoryVideoXor(WORD seg, WORD ofs, BYTE a)
{
    BYTE b = memoryVideoGet(seg, ofs);
    b ^= a;
    memoryVideoSet(seg, ofs, b);
}

//void memoryVideoXor16(WORD seg, WORD ofs, WORD a)
//{
//    WORD b = memoryVideoGet16(seg, ofs);
//    b ^= a;
//    memoryVideoSet16(seg, ofs, b);
//}
...
void sub_2D5A5();
void sub_2DE93();
void sub_2E70E() { std::cout << "missing imp 1\n"; }
void sub_2E8CF();
void sub_2D693();
void sub_2DE08()  { std::cout << "missing imp 3\n"; }
void sub_2DE51() { std::cout << "missing imp 5\n"; }
void sub_2DD39()  { std::cout << "missing imp 4\n"; }
void sub_2D9CA();
void sub_2DE20()  { std::cout << "missing imp 5\n"; }
void sub_2D65F()  { std::cout << "missing imp 2\n"; }
void sub_2D7BD();
...
void _indirectCall(WORD ptr)
{
    switch (ptr)
    {
        case 0x1785: sub_2C3A5(); return; // 2c3a5
        case 0x16d2: sub_2C2F2(); return; // 2c2f2
        case 0x390d: sub_2E52D(); return;
        case 0x28cb: sub_2D4EB(); return;
        case 0x3561: sub_2E181(); return;
        case 0x3b2a: sub_2E74A(); return;
        case 0x39fa: sub_2E61A(); return;
        case 0x3c66: sub_2E886(); return;
        case 0x3cf3: sub_2E913(); return;
        case 0x3386: sub_2DFA6(); return;
        case 0x3d3c: sub_2E95C(); return;
        case 0x2985: sub_2D5A5(); return;
        case 0x3273: sub_2DE93(); return;
        case 0x3aee: sub_2E70E(); return;
        case 0x3caf: sub_2E8CF(); return;
    ...
    std::cout << "Skip indirect case 0x" << std::hex << ptr << ": sub_" << (int)(_seg004*16+ptr) << "();\n";
    //_ASSERT(0);
}
...
void _interrupt(BYTE i)
{
    ...
    if (i == 0x21 && _ah == 0x3d)
    {
        ...
        char fullname[128] = "/Users/gabrielvalky/Documents/git/Projects/XenonResurrection/InputPopcorn/res/";
    ...
    if (i == 0x16 && _ah == 0x00)
    {
        ...
        switch (lastPressed)
        {
            ...
            case SDL_SCANCODE_Z: _ax = 0x4300; break;
            case SDL_SCANCODE_X: _ax = 0x011b; break;
            case SDL_SCANCODE_C: _ax = 0x4400; break;
...
BYTE& memory(WORD segment, WORD offset)
{
    ...
    if (segment*16 + offset == 0x1000*16 + 0x2f18)
    {
        int f=9;
    }
...
void onKey(int k, int p)
{
    if (p==1)
    {
        ...
        switch (k)
        {
            case SDL_SCANCODE_LEFT: go = -1; break; //memory(_ds, 0x2E54) = 100; break;
            case SDL_SCANCODE_RIGHT: go = 1; break; //memory(_ds, 0x2E54) = 50;  break;
            case SDL_SCANCODE_UP:  memory(_seg000, 0x2D4C) = 0x01; break;
//            case SDL_SCANCODE_LEFT: code = 4; break;
        }
    } else {
        switch (k)
        {
            case SDL_SCANCODE_UP:  memory(_seg000, 0x2D4C) = 0x0; break;
            case SDL_SCANCODE_LEFT: go = 0; break;
            case SDL_SCANCODE_RIGHT: go = 0; break;
//            case SDL_SCANCODE_LEFT: code = 4; break;
        }
    }
