...
void off_18FF8() { sub_1017D(); }
void off_18FFA() { _ASSERT(0); }
void off_18FFC() { sub_13E92(); }
...
void start()  // Entry function
{
    ...
    _bp = 0x8000;//memory16(_ds, 0x2);                   //mov bp, ds:2
    _bx = _segargs; //memory16(_ds, 0x2C);                  //mov bx, ds:2Ch
    _ds = _dx;                                  //mov ds, dx
...
loc_100C8:                                      //loc_100C8:
    ...
    _ss = _dx;                                  //mov ss, dx
    _sp = _di;                                  //mov sp, di
    std::cout<< "===== Override sp, skip commandline\n";
    _sp = 128;
...
loc_10143:                                      //loc_10143:
    _bp = _sp;                                  //mov bp, sp
    _ah = 0x4c;                                 //mov ah, 4Ch
    _al = memory(_ss, _bp + 2);                    //mov al, [bp+2]
    _interrupt(33);                             //int 21h
}
...
void loc_1018D()
{
    ...
    _dx = 0x186F6-0x186a0;
//    assert(0); //_dx = _STOP_;                               //mov dx, offset unk_186F6
loc_10194:                                      //loc_10194:
    _ds = memory16(_cs, 0x1A3);                 //mov ds, cs:word_101A3
    sub_10185();                                //call sub_10185
    _ax = 0x0003;                               //mov ax, 3
...
void sub_101A5()
{
    ...
    _bp = _sp;                                  //mov bp, sp
    _sp -= 0x0004;                              //sub sp, 4
    memory16(_ss, _bp + var_4) = 0x0001;             //mov [bp+var_4], 1
    memory16(_ss, _bp + var_2) = 0x0003;             //mov [bp+var_2], 3
...
void sub_10300()
{
    ...
    memory16(_ss, _bp + var_10) = 0x0000;            //mov [bp+var_10], 0
    ...
    _sp += 0x0006;                              //add sp, 6
    if (memory16(_ss, _bp + var_10) != 0x0000)       //jnz short loc_10327
        goto loc_10327;
    _ax = _ax ^ _ax;                            //xor ax, ax
    goto loc_10341;                             //jmp short loc_10341
loc_10327:                                      //loc_10327:
    memory16(_ss, _bp + var_10) = 0x0002;            //mov [bp+var_10], 2
    _FIXME_;                                    //lea ax, [bp+var_10]
    _push(_ax);                                 //push ax
    _FIXME_;                                    //lea ax, [bp+var_10]
    _push(_ax);                                 //push ax
...
void sub_10345()
{
    ...
    _ax += 1;                                   //inc ax
    memory16(_ss, _bp + var_2) = _ax;                //mov [bp+var_2], ax
    memory16(_ss, _bp + var_6) = 0x0000;             //mov [bp+var_6], 0
    goto loc_1040B;                             //jmp loc_1040B
loc_10372:                                      //loc_10372:
    _bx = memory16(_ss, _bp + var_6);                //mov bx, [bp+var_6]
    _bx <<= 1;                                  //shl bx, 1
    _bx = _bx + memory16(_ss, _bp + arg_0);          //add bx, [bp+arg_0]
...
loc_103B2:                                      //loc_103B2:
    ...
    _si += 1;                                   //inc si
    _di += 1;                                   //inc di
    memory16(_ss, _bp + var_8) += 1;                 //inc [bp+var_8]
loc_103BB:                                      //loc_103BB:
    if ((short)memory16(_ss, _bp + var_8) < (short)0x0004)//jl short loc_103B2
        goto loc_103B2;
    memory16(_ss, _bp + var_8) = 0x0000;             //mov [bp+var_8], 0
    goto loc_10400;                             //jmp short loc_10400
loc_103C8:                                      //loc_103C8:
    memory16(_ss, _bp + var_C) = 0x0000;             //mov [bp+var_C], 0
...
loc_103D4:                                      //loc_103D4:
    ...
    _sar(_ax, 1);                               //sar ax, 1
    _sar(_ax, 1);                               //sar ax, 1
    _al = _al + memory16(_ss, _bp + var_C);          //add al, byte ptr [bp+var_C]
    memory(_ds, _di) = _al;                     //mov [di], al
    _di += 1;                                   //inc di
    _al = memory(_ds, _si);                     //mov al, [si]
    _ah = 0x00;                                 //mov ah, 0
    ...
    _cx = 0x0006;                               //mov cx, 6
    _ax <<= _cl;                                //shl ax, cl
    memory16(_ss, _bp + var_C) = _ax;                //mov [bp+var_C], ax
    _si += 1;                                   //inc si
    memory16(_ss, _bp + var_A) += 1;                 //inc [bp+var_A]
loc_103F5:                                      //loc_103F5:
    _ax = memory16(_ss, _bp + var_A);                //mov ax, [bp+var_A]
    if ((short)_ax < (short)memory16(_ss, _bp + var_4))//jl short loc_103D4
        goto loc_103D4;
    memory16(_ss, _bp + var_8) += 1;                 //inc [bp+var_8]
loc_10400:                                      //loc_10400:
    _ax = memory16(_ss, _bp + var_8);                //mov ax, [bp+var_8]
    if ((short)_ax < (short)memory16(_ss, _bp + var_2))//jl short loc_103C8
        goto loc_103C8;
    memory16(_ss, _bp + var_6) += 1;                 //inc [bp+var_6]
loc_1040B:                                      //loc_1040B:
    if ((short)memory16(_ss, _bp + var_6) >= (short)0x0003)
        goto loc_10414;
...
void sub_1041A()
{
    ...
    _push(_bp);                                 //push bp
    _bp = _sp;                                  //mov bp, sp
    _push(memory16(_ss, _bp + arg_0));               //push [bp+arg_0]
    sub_144B8();                                //call sub_144B8
    _sp = _bp;                                  //mov sp, bp
    _si = _ax;                                  //mov si, ax
    _push(memory16(_ss, _bp + arg_0));               //push [bp+arg_0]
...
loc_10747:                                      //loc_10747:
    _si |= _si;                                 //or si, si
    if ((short)_si < (short)_FIXME_)            //jl short loc_10762
        goto loc_10762;
    _si = _si ^ _si;                            //xor si, si
loc_1074D:                                      //loc_1074D:
    _dx = _di;                                  //mov dx, di
...
void sub_10779()
{
    ...
    _bp = _sp;                                  //mov bp, sp
    _sp -= 0x0008;                              //sub sp, 8
    memory16(_ss, _bp + var_6) = 0x0068;             //mov [bp+var_6], 68h
    memory16(_ss, _bp + var_4) = 0x0070;             //mov [bp+var_4], 70h
...
loc_107F4:                                      //loc_107F4:
    ...
    _sp += 0x0006;                              //add sp, 6
    _si = _si ^ _si;                            //xor si, si
    memory16(_ss, _bp + var_1) = 0x0000;             //mov [bp+var_1], 0
loc_1080D:                                      //loc_1080D:
    sub_1063F();                                //call sub_1063F
    memory16(_ss, _bp + var_1) = _al;                //mov [bp+var_1], al
...
loc_10825:                                      //loc_10825:
    ...
    sub_1234E();                                //call sub_1234E
    _sp += 0x0006;                              //add sp, 6
    if (memory16(_ss, _bp + var_1) == 0x0032)        //jz short loc_10858
        goto loc_10858;
    if (memory16(_ss, _bp + var_1) != 0x0050)        //jnz short loc_10863
        goto loc_10863;
loc_10858:                                      //loc_10858:
    _si += 1;                                   //inc si
    _ax = _si;                                  //mov ax, si
    ...
    _si = _dx;                                  //mov si, dx
loc_10863:                                      //loc_10863:
    if (memory16(_ss, _bp + var_1) == 0x0038)        //jz short loc_10872
        goto loc_10872;
    if (memory16(_ss, _bp + var_1) == 0x0048)        //jz short loc_10872
        goto loc_10872;
...
loc_1093B:                                      //loc_1093B:
    ...
    memory16(_ss, _bp + var_8) += 1;                 //inc [bp+var_8]
loc_10957:                                      //loc_10957:
    if ((short)memory16(_ss, _bp + var_8) < (short)0x0007)//jl short loc_1093B
        goto loc_1093B;
    _ax = _si;                                  //mov ax, si
    _sp = _bp;                                  //mov sp, bp
    _bp = _pop();                               //pop bp
...
void sub_10965()
{
    ...
    memory16(_ss, _bp + var_2) = _al;                //mov [bp+var_2], al
    _push(_ss);                                 //push ss
    _FIXME_;                                    //lea ax, [bp+var_2]
    _push(_ax);                                 //push ax
    _push(memory16(_ss, _bp + arg_0));               //push [bp+arg_0]
...
loc_10B7D:                                      //loc_10B7D:
    if ((short)_si < (short)0x0007)             //jl short loc_10B62
        goto loc_10B62;
loc_10B82:                                      //loc_10B82:
    if (memory16(_ss, _bp + var_2) != 0x0005)        //jnz short loc_10BC3
        goto loc_10BC3;
    _push(_ds);                                 //push ds
...
loc_10BBE:                                      //loc_10BBE:
    if ((short)_si < (short)0x0004)             //jl short loc_10BA4
        goto loc_10BA4;
loc_10BC3:                                      //loc_10BC3:
    if ((short)memory16(_ss, _bp + var_2) <= (short)0x0000)
        goto loc_10BD2;
    if ((short)memory16(_ss, _bp + var_2) >= (short)0x0006)
        goto loc_10BD2;
    goto loc_10A86;                             //jmp loc_10A86
loc_10BD2:                                      //loc_10BD2:
    if (memory16(_ss, _bp + var_2) != 0x0006)        //jnz short loc_10BDC
        goto loc_10BDC;
    _ax = _ax ^ _ax;                            //xor ax, ax
...
void sub_10DE9()
{
    ...
    memory16(_ss, _bp + var_10) = 0x0003;            //mov [bp+var_10], 3
    _FIXME_;                                    //lea ax, [bp+var_10]
    _push(_ax);                                 //push ax
    _FIXME_;                                    //lea ax, [bp+var_10]
    _push(_ax);                                 //push ax
    ...
    sub_14230();                                //call sub_14230
    _sp += 0x0006;                              //add sp, 6
    _ax = memory16(_ss, _bp + var_E);                //mov ax, [bp+var_E]
    _ax &= 0x0001;                              //and ax, 1
    _push(_ax);                                 //push ax
    _ax = _di;                                  //mov ax, di
    _dx = 0x0006;                               //mov dx, 6
    ...
    _ax = _pop();                               //pop ax
    memory16(_ds, _bx + 2508) = _ax;            //mov [bx+9CCh], ax
    memory16(_ss, _bp + var_10) = 0x000b;            //mov [bp+var_10], 0Bh
    _FIXME_;                                    //lea ax, [bp+var_10]
    _push(_ax);                                 //push ax
    _FIXME_;                                    //lea ax, [bp+var_10]
    _push(_ax);                                 //push ax
    ...
    sub_14230();                                //call sub_14230
    _sp += 0x0006;                              //add sp, 6
    _si = memory16(_ss, _bp + var_C);                //mov si, [bp+var_C]
    _si |= _si;                                 //or si, si
    if ((short)_si <= (short)_FIXME_)           //jle short loc_10E43
        goto loc_10E43;
    _ax = 0x0001;                               //mov ax, 1
...
loc_10EAC:                                      //loc_10EAC:
    ...
    memory16(_ss, _bp + var_4) = _di;                //mov [bp+var_4], di
    _bx = _si;                                  //mov bx, si
    _bx <<= 1;                                  //shl bx, 1
    ...
    _ax += 0x0003;                              //add ax, 3
    memory16(_ss, _bp + var_2) = _ax;                //mov [bp+var_2], ax
    if ((short)memory16(_ss, _bp + var_4) <= (short)0x0000)
        goto loc_10EFB;
...
loc_10EFB:                                      //loc_10EFB:
    if ((short)_di <= (short)memory16(_ss, _bp + var_2))//jle short loc_10F0A
        goto loc_10F0A;
loc_10F00:                                      //loc_10F00:
    _bx = _si;                                  //mov bx, si
    _bx <<= 1;                                  //shl bx, 1
...
loc_10F3E:                                      //loc_10F3E:
    ...
    if (memory16(_ds, _bx + 2536) != 0xffff)    //jnz short loc_10F95
        goto loc_10F95;
    if (memory16(_ss, _bp + var_4) == 0x0000)        //jz short loc_10F89
        goto loc_10F89;
    _bx = _si;                                  //mov bx, si
    _bx <<= 1;                                  //shl bx, 1
...
loc_110DC:                                      //loc_110DC:
    ...
    _ax = -_ax;                                 //neg ax
    _si = _ax;                                  //mov si, ax
    memory16(_ss, _bp + var_2) = 0x0000;             //mov [bp+var_2], 0
    goto loc_110FC;                             //jmp short loc_110FC
loc_110F7:                                      //loc_110F7:
    memory16(_ss, _bp + var_2) = 0x0001;             //mov [bp+var_2], 1
loc_110FC:                                      //loc_110FC:
    _si += 1;                                   //inc si
...
loc_1112E:                                      //loc_1112E:
    ...
    _mul(memory16(_ss, _bp + var_6));                //mul [bp+var_6]
    _dx = _pop();                               //pop dx
    _dx += _ax;                                 //add dx, ax
    memory16(_ss, _bp + var_4) = _dx;                //mov [bp+var_4], dx
...
loc_111D7:                                      //loc_111D7:
    ...
    _dx = _pop();                               //pop dx
    _dx += _ax;                                 //add dx, ax
    _dx = _dx + memory16(_ss, _bp + var_2);          //add dx, [bp+var_2]
...
loc_113FD:                                      //loc_113FD:
    if ((short)memory16(_ss, _bp + arg_0) >= (short)0x0008)
        goto loc_11410;
    _push(memory16(_ds, 0x9DA));                //push word_1907A
    _push(_di);                                 //push di
    _ax = _ax ^ _ax;                            //xor ax, ax
    ...
    _sp = _bp;                                  //mov sp, bp
loc_11410:                                      //loc_11410:
    if ((short)memory16(_ss, _bp + arg_0) <= (short)0x0117)
        goto loc_11425;
    _push(memory16(_ds, 0xA38));                //push word_190D8
    _push(_di);                                 //push di
    _ax = 0x0138;                               //mov ax, 138h
    ...
    _sp = _bp;                                  //mov sp, bp
loc_11425:                                      //loc_11425:
    if ((short)memory16(_ss, _bp + arg_2) >= (short)0x0011)
        goto loc_11439;
    ...
    _sp = _bp;                                  //mov sp, bp
loc_11439:                                      //loc_11439:
    if ((short)memory16(_ss, _bp + arg_2) <= (short)0x00ab)
        goto loc_1144E;
    _push(memory16(_ds, 0x9BA));                //push word_1905A
    _ax = 0x00c7;                               //mov ax, 0C7h
    _push(_ax);                                 //push ax
...
loc_114E9:                                      //loc_114E9:
    if (memory16(_ss, _bp + var_2) == 0x0000)        //jz short loc_1152C
        goto loc_1152C;
    _bx = memory16(_ds, 0xA3C);                 //mov bx, word_190DC
    _bx <<= 1;                                  //shl bx, 1
    _bx <<= 1;                                  //shl bx, 1
...
loc_1178C:                                      //loc_1178C:
    ...
    _sar(_di, 1);                               //sar di, 1
    _sar(_di, 1);                               //sar di, 1
    memory16(_ss, _bp + var_8) = 0x0014;             //mov [bp+var_8], 14h
loc_11799:                                      //loc_11799:
    _ax = _ax ^ _ax;                            //xor ax, ax
...
loc_117C8:                                      //loc_117C8:
    ...
    _ax = -_ax;                                 //neg ax
loc_117D1:                                      //loc_117D1:
    if ((short)_ax <= (short)memory16(_ss, _bp + var_6))//jle short loc_117ED
        goto loc_117ED;
...
loc_11811:                                      //loc_11811:
    ...
    sub_11452();                                //call sub_11452
    _ax = memory16(_ss, _bp + var_8);                //mov ax, [bp+var_8]
    memory16(_ss, _bp + var_8) -= 1;                 //dec [bp+var_8]
    _ax |= _ax;                                 //or ax, ax
    if ((short)_ax <= (short)_FIXME_)           //jle short loc_11824
        goto loc_11824;
...
loc_11838:                                      //loc_11838:
    ...
    _ax = _ax ^ _ax;                            //xor ax, ax
    _push(_ax);                                 //push ax
    _push(memory16(_ss, _bp + var_A));               //push [bp+var_A]
    sub_16A19();                                //call sub_16A19
    _sp += 0x0008;                              //add sp, 8
...
void sub_1199B()
{
    ...
    _ax = _di;                                  //mov ax, di
    _ax = _ax - memory16(_ss, _bp + arg_2);          //sub ax, [bp+arg_2]
    _ax |= _ax;                                 //or ax, ax
    if ((short)_ax >= 0)                        //jge short loc_119C2
        goto loc_119C2;
    _ax = -_ax;                                 //neg ax
loc_119C2:                                      //loc_119C2:
    if ((short)_ax >= (short)memory16(_ss, _bp + arg_4))//jge short loc_119D5
        goto loc_119D5;
...
loc_119D5:                                      //loc_119D5:
    if ((short)_di >= (short)memory16(_ss, _bp + arg_2))//jge short loc_119E5
        goto loc_119E5;
    memory16(_ds, _si) = 0x0000;                //mov word ptr [si], 0
...
loc_11B66:                                      //loc_11B66:
    ...
    memory16(_ss, _bp + var_6) = _ax;                //mov [bp+var_6], ax
loc_11B7C:                                      //loc_11B7C:
    if ((short)memory16(_ss, _bp + var_6) < (short)0x0001)//jl short loc_11B8E
        goto loc_11B8E;
    _ax = memory16(_ds, 0x988);                 //mov ax, word_19028
    _cx = 0x0006;                               //mov cx, 6
    _sar(_ax, _cl);                             //sar ax, cl
...
loc_11CBE:                                      //loc_11CBE:
    ...
    _push(_ax);                                 //push ax
    _ax = _di;                                  //mov ax, di
    _ax = _ax + memory16(_ss, _bp + var_2);          //add ax, [bp+var_2]
    _push(_ax);                                 //push ax
    _ax = _ax ^ _ax;                            //xor ax, ax
    _push(_ax);                                 //push ax
    sub_1199B();                                //call sub_1199B
...
loc_11E7D:                                      //loc_11E7D:
    ...
    memory16(_ss, _bp + var_6) = _ax;                //mov [bp+var_6], ax
loc_11E93:                                      //loc_11E93:
    if ((short)memory16(_ss, _bp + var_6) < (short)0x0001)//jl short loc_11EA5
        goto loc_11EA5;
    _ax = memory16(_ds, 0x988);                 //mov ax, word_19028
    _cx = 0x0006;                               //mov cx, 6
    _sar(_ax, _cl);                             //sar ax, cl
...
loc_11F7A:                                      //loc_11F7A:
    ...
    _sar(_ax, 1);                               //sar ax, 1
    _dx = memory16(_ds, 0x9C6);                 //mov dx, word_19066
    _dx = _dx - memory16(_ss, _bp + var_2);          //sub dx, [bp+var_2]
    _dx -= _ax;                                 //sub dx, ax
    _push(_dx);                                 //push dx
    _ax = 0x0001;                               //mov ax, 1
    _push(_ax);                                 //push ax
...
loc_11FDA:                                      //loc_11FDA:
    ...
    _push(_ax);                                 //push ax
    _ax = _di;                                  //mov ax, di
    _ax = _ax - memory16(_ss, _bp + var_2);          //sub ax, [bp+var_2]
    _push(_ax);                                 //push ax
    _ax = 0x0001;                               //mov ax, 1
    _push(_ax);                                 //push ax
    sub_1199B();                                //call sub_1199B
...
loc_1216E:                                      //loc_1216E:
    ...
    goto loc_12181;                             //jmp short loc_12181
loc_12175:                                      //loc_12175:
    memory16(_ss, _bp + var_4) = 0x0002;             //mov [bp+var_4], 2
    goto loc_12181;                             //jmp short loc_12181
loc_1217C:                                      //loc_1217C:
    memory16(_ss, _bp + var_4) = 0x0003;             //mov [bp+var_4], 3
loc_12181:                                      //loc_12181:
...
loc_121A2:                                      //loc_121A2:
    ...
    goto loc_121B5;                             //jmp short loc_121B5
loc_121A9:                                      //loc_121A9:
    memory16(_ss, _bp + var_2) = 0x0002;             //mov [bp+var_2], 2
    goto loc_121B5;                             //jmp short loc_121B5
loc_121B0:                                      //loc_121B0:
    memory16(_ss, _bp + var_2) = 0x0003;             //mov [bp+var_2], 3
loc_121B5:                                      //loc_121B5:
...
void sub_122D0()
{
    ...
    _di >>= 1;                                  //shr di, 1
    _di += _ax;                                 //add di, ax
    _si = memory16(_ss, _bp + arg_4);                //mov si, [bp+arg_4]
...
void sub_13C3B()
{
    ...
    _push(_bp);                                 //push bp
    _bp = _sp;                                  //mov bp, sp
    _ah = memory16(_ss, _bp + arg_0);                //mov ah, [bp+arg_0]
    _interrupt(22);                             //int 16h
    if (!_flags.zero)                           //jnz short loc_13C4D
        goto loc_13C4D;
    if (memory16(_ss, _bp + arg_0) != 0x0001)        //jnz short loc_13C4D
        goto loc_13C4D;
    _ax = _ax ^ _ax;                            //xor ax, ax
loc_13C4D:                                      //loc_13C4D:
    _bp = _pop();                               //pop bp
...
void sub_13CDF()
{
    ...
    _bp = _sp;                                  //mov bp, sp
    _sp -= 0x0004;                              //sub sp, 4
    memory16(_ss, _bp + var_3) = 0x0000;             //mov [bp+var_3], 0
...
loc_13CFE:                                      //loc_13CFE:
    _ax = memory16(_ss, _bp + arg_2);                //mov ax, [bp+arg_2]
    memory16(_ss, _bp + arg_2) -= 1;                 //dec [bp+arg_2]
    _ax |= _ax;                                 //or ax, ax
...
loc_13D0B:                                      //loc_13D0B:
    ...
    memory16(_ss, _bp + arg_4) += 1;                 //inc [bp+arg_4]
    _al = memory(_ds, _bx);                     //mov al, [bx]
    memory16(_ss, _bp + var_3) = _al;                //mov [bp+var_3], al
    _ah = 0x00;                                 //mov ah, 0
...
loc_13D70:                                      //loc_13D70:
    ...
    _al = memory16(_ss, _bp + var_3);                //mov al, [bp+var_3]
    memory16(_ss, _bp + var_2) = _ax;                //mov [bp+var_2], ax
    _ax = _si;                                  //mov ax, si
    _ax += 1;                                   //inc ax
    _push(_ax);                                 //push ax
...
loc_13E4F:                                      //loc_13E4F:
    ...
    if (memory(_ds, _bx) == 0x00)               //jz short loc_13E6B
        goto loc_13E6B;
    memory16(_ss, _bp + arg_0) += 1;                 //inc [bp+arg_0]
    _al = memory(_ds, _bx);                     //mov al, [bx]
    //_FIXME_;                                    //les bx, [bp+arg_2]
    _bx = memory16(_ss, _bp + arg_2);
    _es = memory16(_ss, _bp + arg_2+2);
    //_les(_bx, _ds, temp);
    //_ASSERT(_es);
    
    memory16(_ss, _bp + arg_2) += 1;            //inc word ptr [bp+arg_2]
    if (_al == memoryBiosGet(_es, _bx))                //jz short loc_13E4F
        goto loc_13E4F;
    _ax = _ax ^ _ax;                            //xor ax, ax
...
void sub_13EAF()
{
    ...
    _push(_bp);                                 //push bp
    _bp = _sp;                                  //mov bp, sp
    _al = memory16(_ss, _bp + arg_0);                //mov al, [bp+arg_0]
...
loc_14032:                                      //loc_14032:
    ...
    _bx = memory16(_ds, 0x370);                 //mov bx, word_18A10
    _bx <<= 1;                                  //shl bx, 1
    assert(0);//_indirectCall(memory16(_ds, _bx + 2642));   //call word ptr [bx+0A52h]
...
void sub_1405E()
{
    ...
    _push(_bp);                                 //push bp
    _bp = _sp;                                  //mov bp, sp
    if (memory16(_ss, _bp + arg_0) != 0x0000)        //jnz short loc_1406C
        goto loc_1406C;
...
void loc_14132()
{
    _al = memory16(_ss, _bp + 4);                    //mov al, [bp+4]
...
void sub_14183()
{
    ...
    _push(memory16(_ss, _bp + arg_4));               //push [bp+arg_4]
    _push(memory16(_ss, _bp + arg_6));               //push [bp+arg_6]
...
loc_1419F:                                      //loc_1419F:
    _di = memory16(_ss, _bp + arg_4);                //mov di, [bp+arg_4]
    _di = _di - memory16(_ss, _bp + arg_0);          //sub di, [bp+arg_0]
    _di += 1;                                   //inc di
    _si = memory16(_ss, _bp + arg_2);                //mov si, [bp+arg_2]
...
loc_141AB:                                      //loc_141AB:
    ...
    _ax = _di;                                  //mov ax, di
    _ax <<= 1;                                  //shl ax, 1
    memory16(_ss, _bp + arg_8) += _ax;               //add [bp+arg_8], ax
    _si += 1;                                   //inc si
loc_141C7:                                      //loc_141C7:
    if ((short)_si <= (short)memory16(_ss, _bp + arg_6))//jle short loc_141AB
        goto loc_141AB;
    _ax = 0x0001;                               //mov ax, 1
loc_141CF:                                      //loc_141CF:
    _bp = _pop();                               //pop bp
...
loc_141E4:                                      //loc_141E4:
    ...
    _si += 1;                                   //inc si
loc_14200:                                      //loc_14200:
    if ((short)_si <= (short)memory16(_ss, _bp + arg_6))//jle short loc_141E4
        goto loc_141E4;
    _ax = 0x0001;                               //mov ax, 1
    _bp = _pop();                               //pop bp
    _di = _pop();                               //pop di
...
void sub_14255()
{
    ...
    memory16(_ss, _bp + var_E) = _cx;           //mov word ptr [bp+var_E], cx
    memory16(_ss, _bp + var_10) = _ss;          //mov word ptr [bp+var_E+2], ss
    memory16(_ss, _bp + var_A) = 0x0055;             //mov [bp+var_A], 55h
    memory16(_ss, _bp + var_9) = 0x00cd;             //mov [bp+var_9], 0CDh
    _ax = memory16(_ss, _bp + arg_0);                //mov ax, [bp+arg_0]
    memory16(_ss, _bp + var_8) = _al;                //mov [bp+var_8], al
    memory16(_ss, _bp + var_7) = 0xcb5d;             //mov [bp+var_7], 0CB5Dh
    if (_al < 0x25)                             //jb short loc_14293
        goto loc_14293;
    if (_al > 0x26)                             //ja short loc_14293
        goto loc_14293;
    memory16(_ss, _bp + var_7) = 0x36;               //mov byte ptr [bp+var_7], 36h
    memory16(_ss, _bp + var_E) = 0x068f;             //mov [bp+var_7+1], 68Fh
    memory16(_ss, _bp + var_4) = _cx;                //mov [bp+var_4], cx
    memory16(_ss, _bp + var_2) = 0xcb5d;             //mov [bp+var_2], 0CB5Dh
loc_14293:                                      //loc_14293:
    ...
    _ds = _pop();                               //pop ds
    _es = _pop();                               //pop es
    switch (_bp + var_E)                        //call [bp+var_E]
    {
    ...
    _push(_ds);                                 //push ds
    _push(_es);                                 //push es
    _ds = memory16(_ss, _bp + var_10);               //mov ds, [bp+var_10]
    _si = memory16(_ss, _bp + arg_6);                //mov si, [bp+arg_6]
...
void sub_142F2()
{
    ...
    _si = memory16(_ss, _bp + arg_0);                //mov si, [bp+arg_0]
    _si |= _si;                                 //or si, si
    if ((short)_si < (short)_FIXME_)            //jl short loc_14311
        goto loc_14311;
...
loc_1433F:                                      //loc_1433F:
    ...
    _dx = memory16(_ss, _bp + arg_2);                //mov dx, [bp+arg_2]
    _bx = memory16(_ss, _bp + arg_4);                //mov bx, [bp+arg_4]
    _bp = memory16(_ss, _bp + arg_6);                //mov bp, [bp+arg_6]
    _si = _si ^ _si;                            //xor si, si
...
void sub_143BC()
{
    ...
    _push(_es);                                 //push es
    _di = memory16(_ss, _bp + arg_6);                //mov di, [bp+arg_6]
    _push(_ds);                                 //push ds
    _es = _pop();                               //pop es
    _bx = memory16(_ss, _bp + arg_4);                //mov bx, [bp+arg_4]
    ...
    if (_bl < 0x02)                             //jb short loc_1442A
        goto loc_1442A;
    _ax = memory16(_ss, _bp + arg_8);                //mov ax, [bp+arg_8]
    _cx = memory16(_ss, _bp + arg_A);                //mov cx, [bp+arg_A]
    _cx |= _cx;                                 //or cx, cx
    if ((short)_cx >= 0)                        //jge short loc_143F2
        goto loc_143F2;
    if (memory16(_ss, _bp + arg_2) == 0x0000)        //jz short loc_143F2
        goto loc_143F2;
...
loc_14424:                                      //loc_14424:
    _al = _al + memory16(_ss, _bp + arg_0);          //add al, [bp+arg_0]
loc_14427:                                      //loc_14427:
...
void sub_14439()
{
    ...
    _push(_bp);                                 //push bp
    _bp = _sp;                                  //mov bp, sp
    if (memory16(_ss, _bp + arg_4) != 0x000a)        //jnz short loc_14448
        goto loc_14448;
    _ax = memory16(_ss, _bp + arg_0);                //mov ax, [bp+arg_0]
    _cwd();                                     //cwd
...
loc_144CC:                                      //loc_144CC:
    ...
    memory16(_ss, _bp + var_4) = _ax;                //mov [bp+var_4], ax
    _bx = memory16(_ss, _bp + var_4);                //mov bx, [bp+var_4]
...
loc_1451D:                                      //loc_1451D:
    memory16(_ss, _bp + var_4) = _si;                //mov [bp+var_4], si
    _si = memory16(_ds, _si + 2);               //mov si, [si+2]
...
loc_14525:                                      //loc_14525:
    ...
    _cx = _pop();                               //pop cx
    memory16(_ss, _bp + var_2) = _ax;                //mov [bp+var_2], ax
    if (memory16(_ss, _bp + var_2) != 0xffff)        //jnz short loc_14544
        goto loc_14544;
    _ax = _ax ^ _ax;                            //xor ax, ax
    goto loc_1454E;                             //jmp short loc_1454E
loc_14544:                                      //loc_14544:
    _si = memory16(_ss, _bp + var_2);                //mov si, [bp+var_2]
    memory16(_ds, _si) = _di;                   //mov [si], di
    _ax = _si;                                  //mov ax, si
    _ax += 0x0002;                              //add ax, 2
loc_1454E:                                      //loc_1454E:
...
void sub_14554()
{
    ...
    if (_ax == 0)                               //jz short loc_14590
        goto loc_14590;
    _push(memory16(_ss, _bp + arg_8));               //push [bp+arg_8]
    _push(memory16(_ss, _bp + arg_A));               //push [bp+arg_A]
    _ax = memory16(_ss, _bp + arg_4);                //mov ax, [bp+arg_4]
    _ax = _ax - memory16(_ss, _bp + arg_0);          //sub ax, [bp+arg_0]
    _ax = _ax + memory16(_ss, _bp + arg_8);          //add ax, [bp+arg_8]
    _push(_ax);                                 //push ax
    _ax = memory16(_ss, _bp + arg_6);                //mov ax, [bp+arg_6]
    _ax -= _si;                                 //sub ax, si
    _ax = _ax + memory16(_ss, _bp + arg_A);          //add ax, [bp+arg_A]
    _push(_ax);                                 //push ax
    sub_14993();                                //call sub_14993
    _ax |= _ax;                                 //or ax, ax
...
loc_14594:                                      //loc_14594:
    memory16(_ss, _bp + var_6) = _si;                //mov [bp+var_6], si
    _ax = memory16(_ss, _bp + arg_6);                //mov ax, [bp+arg_6]
    memory16(_ss, _bp + var_4) = _ax;                //mov [bp+var_4], ax
    memory16(_ss, _bp + var_2) = 0x0001;             //mov [bp+var_2], 1
    if ((short)_si >= (short)memory16(_ss, _bp + arg_A))//jge short loc_145B5
        goto loc_145B5;
    _ax = memory16(_ss, _bp + arg_6);                //mov ax, [bp+arg_6]
    memory16(_ss, _bp + var_6) = _ax;                //mov [bp+var_6], ax
    memory16(_ss, _bp + var_4) = _si;                //mov [bp+var_4], si
    memory16(_ss, _bp + var_2) = 0xffff;             //mov [bp+var_2], 0FFFFh
loc_145B5:                                      //loc_145B5:
    _di = memory16(_ss, _bp + var_6);                //mov di, [bp+var_6]
...
loc_145BA:                                      //loc_145BA:
    ...
    _push(_ax);                                 //push ax
    sub_14958();                                //call sub_14958
    _di = _di + memory16(_ss, _bp + var_2);          //add di, [bp+var_2]
loc_145E1:                                      //loc_145E1:
    _ax = memory16(_ss, _bp + var_4);                //mov ax, [bp+var_4]
    _ax = _ax + memory16(_ss, _bp + var_2);          //add ax, [bp+var_2]
...
void sub_145F4()
{
    ...
    _bp = _sp;                                  //mov bp, sp
    _al = 0x01;                                 //mov al, 1
    _cx = memory16(_ss, _bp + arg_2);                //mov cx, [bp+arg_2]
...
loc_1460D:                                      //loc_1460D:
    ...
    _cl = _cl & memory16(_ss, _bp + arg_2);          //and cl, byte ptr [bp+arg_2]
    _al |= _cl;                                 //or al, cl
    _ah = 0x3d;                                 //mov ah, 3Dh
    _interrupt(33);                             //int 21h
...
loc_146A5:                                      //loc_146A5:
    ...
    _si += 0x0002;                              //add si, 2
    memory16(_ss, _bp + arg_2) += 1;                 //inc [bp+arg_2]
loc_146AD:                                      //loc_146AD:
    _ax = memory16(_ss, _bp + arg_2);                //mov ax, [bp+arg_2]
    if ((short)_ax <= (short)memory16(_ss, _bp + arg_0))//jle short loc_146A5
        goto loc_146A5;
    _bp = _pop();                               //pop bp
    _si = _pop();                               //pop si
    _stackReduce(6);                            //retn 6
...
loc_146CB:                                      //loc_146CB:
    ...
    goto loc_14803;                             //jmp loc_14803
loc_146D5:                                      //loc_146D5:
    if (memory16(_ss, _bp + arg_0) == 0x0001)        //jz short loc_146DE
        goto loc_146DE;
    goto loc_14803;                             //jmp loc_14803
loc_146DE:                                      //loc_146DE:
    memory16(_ss, _bp + arg_8) += 1;                 //inc [bp+arg_8]
    memory16(_ss, _bp + arg_6) += 1;                 //inc [bp+arg_6]
    memory16(_ss, _bp + arg_4) += 1;                 //inc [bp+arg_4]
    memory16(_ss, _bp + arg_2) += 1;                 //inc [bp+arg_2]
    if (memory16(_ss, _bp + arg_A) == 0x0006)        //jz short loc_146F3
        goto loc_146F3;
    goto loc_1477B;                             //jmp loc_1477B
loc_146F3:                                      //loc_146F3:
    _al = memory16(_ss, _bp + arg_6);                //mov al, [bp+arg_6]
    _ah = 0x00;                                 //mov ah, 0
    _push(_ax);                                 //push ax
    _al = memory16(_ss, _bp + arg_8);                //mov al, [bp+arg_8]
    _ah = 0x00;                                 //mov ah, 0
    _push(_ax);                                 //push ax
    _al = memory16(_ss, _bp + arg_2);                //mov al, [bp+arg_2]
    _ah = 0x00;                                 //mov ah, 0
    _push(_ax);                                 //push ax
    _al = memory16(_ss, _bp + arg_4);                //mov al, [bp+arg_4]
    _ah = 0x00;                                 //mov ah, 0
    _push(_ax);                                 //push ax
    _al = memory16(_ss, _bp + arg_6);                //mov al, [bp+arg_6]
    _ah = 0x00;                                 //mov ah, 0
...
loc_14803:                                      //loc_14803:
    ...
    _ah = memory16(_ss, _bp + arg_A);                //mov ah, [bp+arg_A]
    _al = memory16(_ss, _bp + arg_0);                //mov al, [bp+arg_0]
    _ch = memory16(_ss, _bp + arg_6);                //mov ch, [bp+arg_6]
    _cl = memory16(_ss, _bp + arg_8);                //mov cl, [bp+arg_8]
    _dh = memory16(_ss, _bp + arg_2);                //mov dh, [bp+arg_2]
    _dl = memory16(_ss, _bp + arg_4);                //mov dl, [bp+arg_4]
    sub_13E83();                                //call sub_13E83
loc_1481C:                                      //loc_1481C:
    _sp = _bp;                                  //mov sp, bp
    _bp = _pop();                               //pop bp
...
void sub_14822()
{
    ...
    _div(_bx);                                  //div bx
    memory16(_ss, _bp + var_2) = _al;                //mov [bp+var_2], al
    _al = memory16(_ss, _bp + var_2);                //mov al, [bp+var_2]
    _ah = 0x00;                                 //mov ah, 0
    _dl = memory(_ds, 0x37A);                   //mov dl, byte_18A1A
    _dh = 0x00;                                 //mov dh, 0
    _mul(_dx);                                  //mul dx
    _dx = _si;                                  //mov dx, si
    _dl -= _al;                                 //sub dl, al
    memory16(_ss, _bp + var_1) = _dl;                //mov [bp+var_1], dl
    _ah = memory16(_ss, _bp + var_2);                //mov ah, [bp+var_2]
    _al = memory16(_ss, _bp + var_1);                //mov al, [bp+var_1]
    _sp = _bp;                                  //mov sp, bp
    _bp = _pop();                               //pop bp
    _si = _pop();                               //pop si
...
void sub_14892()
{
    ...
    _ax = _di;                                  //mov ax, di
    memory16(_ss, _bp + var_6) = _ax;                //mov [bp+var_6], ax
    _ax = memory16(_ss, _bp + arg_6+2);           //mov ax, word ptr [bp+arg_6+2]
...
loc_148B4:                                      //loc_148B4:
    ...
    if (_ax == 0)                               //jz short loc_148C7
        goto loc_148C7;
    _push(memory16(_ss, _bp + arg_6+2));          //push word ptr [bp+arg_6+2]
    _push(memory16(_ss, _bp + arg_6));          //push word ptr [bp+arg_6]
    sub_14822();                                //call sub_14822
    memory16(_ss, _bp + var_A) = _ax;                //mov [bp+var_A], ax
loc_148C7:                                      //loc_148C7:
    _ax = memory16(_ss, _bp + arg_2+2);           //mov ax, word ptr [bp+arg_2+2]
...
loc_148D7:                                      //loc_148D7:
    ...
    if (_ax == 0)                               //jz short loc_148EA
        goto loc_148EA;
    _push(memory16(_ss, _bp + arg_2+2));          //push word ptr [bp+arg_2+2]
    _push(memory16(_ss, _bp + arg_2));          //push word ptr [bp+arg_2]
    sub_14822();                                //call sub_14822
    memory16(_ss, _bp + var_8) = _ax;                //mov [bp+var_8], ax
loc_148EA:                                      //loc_148EA:
    _ax = memory16(_ss, _bp + arg_0);                //mov ax, [bp+arg_0]
    memory16(_ss, _bp + arg_0) -= 1;                 //dec [bp+arg_0]
    _ax |= _ax;                                 //or ax, ax
    if (_ax == 0)                               //jz short loc_14947
        goto loc_14947;
    if (memory16(_ss, _bp + var_2) == 0x0000)        //jz short loc_14910
        goto loc_14910;
    _FIXME_;                                    //lea ax, [bp+var_8]
    _push(_ax);                                 //push ax
...
loc_14910:                                      //loc_14910:
    ...
    memory16(_ss, _bp + arg_2) += 0x0002;       //add word ptr [bp+arg_2], 2
loc_1491A:                                      //loc_1491A:
    if (memory16(_ss, _bp + var_4) == 0x0000)        //jz short loc_1493B
        goto loc_1493B;
...
loc_1493B:                                      //loc_1493B:
    ...
    memory16(_ss, _bp + arg_6) += 0x0002;       //add word ptr [bp+arg_6], 2
loc_14945:                                      //loc_14945:
...
void sub_14993()
{
    ...
    if (_ax > _cx)                              //ja short loc_149D5
        goto loc_149D5;
    _ax = memory16(_ss, _bp + arg_6);                //mov ax, [bp+arg_6]
    if ((short)_ax > (short)memory16(_ss, _bp + arg_2))//jg short loc_149D5
        goto loc_149D5;
    _ax = memory16(_ss, _bp + arg_4);                //mov ax, [bp+arg_4]
    ...
    if (_ax > _dx)                              //ja short loc_149D5
        goto loc_149D5;
    _ax = memory16(_ss, _bp + arg_4);                //mov ax, [bp+arg_4]
    if ((short)_ax > (short)memory16(_ss, _bp + arg_0))//jg short loc_149D5
        goto loc_149D5;
    _ax = 0x0001;                               //mov ax, 1
...
void sub_149F6()
{
    ...
    _ax = _ax ^ _ax;                            //xor ax, ax
    _al = memory(_es, _si++);//_lods(memory(_es, _si));                    //lods byte ptr es:[si]
    _ax += 1;                                   //inc ax
    _bp = _es;                                  //mov bp, es
...
loc_14A63:                                      //loc_14A63:
    ...
    if (!_flags.carry && !_flags.zero)                                //ja short loc_14A6F
        goto loc_14A6F;
loc_14A68:                                      //loc_14A68:
    if (_flags.carry)                                //jb short loc_14AAA
...
loc_14A8A:                                      //loc_14A8A:
    ...
    {
        _flags.zero = true; // gabo
        goto locret_14AA6;
    }
    _al += 0x22;                                //add al, 22h
    if (_al != 0x5c)                            //jnz short loc_14AA4
    {
        _flags.zero = false; // gabo
        _flags.carry = _al < 0x5c; // gabo??
        goto loc_14AA4;
    }
    if (memory(_ds, _si) != 0x22)               //jnz short loc_14AA4
    {
        _flags.zero = false; // gabo
        _flags.carry = memory(_ds, _si) < 0x22; // gabo??
        goto loc_14AA4;
    }
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    _flags.carry = _cx == 0; // gabo
    _cx -= 1;                                   //dec cx
loc_14AA4:                                      //loc_14AA4:
    _si |= _si;                                 //or si, si
    _flags.zero = _si == 0; // gabo
...
void sub_14BA4()
{
    ...
    memory16(_ss, _bp + var_54) = 0x0000;            //mov [bp+var_54], 0
    memory16(_ss, _bp + var_51) = 0x0050;            //mov [bp+var_51], 50h
    _push(_es);                                 //push es
    _flags.direction = false;                   //cld
    _FIXME_;                                    //lea di, [bp+var_50]
    memory16(_ss, _bp + var_92) = _di;               //mov [bp+var_92], di
loc_14BBF:                                      //loc_14BBF:
    _di = memory16(_ss, _bp + var_92);               //mov di, [bp+var_92]
loc_14BC3:                                      //loc_14BC3:
    _si = memory16(_ss, _bp + arg_2);                //mov si, [bp+arg_2]
loc_14BC6:                                      //loc_14BC6:
    _lodsb<MemAuto, DirAuto>();                 //lodsb
...
loc_14BCF:                                      //loc_14BCF:
    memory(_ds, _di) = _al;                     //mov [di], al
    _di += 1;                                   //inc di
    memory16(_ss, _bp + var_51) -= 1;                //dec [bp+var_51]
...
loc_14BE2:                                      //loc_14BE2:
    memory16(_ss, _bp + var_86) = _si;               //mov [bp+var_86], si
    _lodsb<MemAuto, DirAuto>();                 //lodsb
    if (_al == 0x25)                            //jz short loc_14BCF
        goto loc_14BCF;
    memory16(_ss, _bp + var_92) = _di;               //mov [bp+var_92], di
    _cx = 0;                                    //sub cx, cx
    memory16(_ss, _bp + var_88) = _cx;               //mov [bp+var_88], cx
    memory16(_ss, _bp + var_8A) = _cl;               //mov [bp+var_8A], cl
    memory16(_ss, _bp + var_89) = _cl;               //mov [bp+var_89], cl
    memory16(_ss, _bp + var_8E) = 0xffff;            //mov [bp+var_8E], 0FFFFh
    memory16(_ss, _bp + var_8C) = 0xffff;            //mov [bp+var_8C], 0FFFFh
...
loc_14C60:                                      //loc_14C60:
    if (_ch > 0x00)                             //ja short loc_14C5D
        goto loc_14C5D;
    memory16(_ss, _bp + var_8A) |= 0x0001;           //or [bp+var_8A], 1
    goto loc_14C0B;                             //jmp short loc_14C0B
loc_14C6C:                                      //loc_14C6C:
    if (_ch > 0x00)                             //ja short loc_14C5D
        goto loc_14C5D;
    memory16(_ss, _bp + var_8A) |= 0x0002;           //or [bp+var_8A], 2
    goto loc_14C0B;                             //jmp short loc_14C0B
loc_14C78:                                      //loc_14C78:
    if (_ch > 0x00)                             //ja short loc_14C5D
        goto loc_14C5D;
    if (memory16(_ss, _bp + var_89) == 0x002b)       //jz short loc_14C0B
        goto loc_14C0B;
    memory16(_ss, _bp + var_89) = _dl;               //mov [bp+var_89], dl
    goto loc_14C0B;                             //jmp short loc_14C0B
loc_14C8A:                                      //loc_14C8A:
    memory16(_ss, _bp + var_8A) &= 0x00df;           //and [bp+var_8A], 0DFh
    _ch = 0x05;                                 //mov ch, 5
    goto loc_14C0B;                             //jmp loc_14C0B
loc_14C94:                                      //loc_14C94:
    memory16(_ss, _bp + var_8A) |= 0x0020;           //or [bp+var_8A], 20h
    _ch = 0x05;                                 //mov ch, 5
    goto loc_14C0B;                             //jmp loc_14C0B
loc_14C9E:                                      //loc_14C9E:
    if (_ch > 0x00)                             //ja short loc_14CE3
        goto loc_14CE3;
    if (memory16(_ss, _bp + var_8A) & 0x0002)        //jnz short loc_14CCA
        goto loc_14CCA;
    memory16(_ss, _bp + var_8A) |= 0x0008;           //or [bp+var_8A], 8
    _ch = 0x01;                                 //mov ch, 1
...
loc_14CB6:                                      //loc_14CB6:
    _di = memory16(_ss, _bp + arg_0);                //mov di, [bp+arg_0]
    _ax = memory16(_ds, _di);                   //mov ax, [di]
    memory16(_ss, _bp + arg_0) += 0x0002;            //add [bp+arg_0], 2
    if (_ch >= 0x02)                            //jnb short loc_14CCD
        goto loc_14CCD;
    memory16(_ss, _bp + var_8E) = _ax;               //mov [bp+var_8E], ax
    _ch = 0x03;                                 //mov ch, 3
loc_14CCA:                                      //loc_14CCA:
    goto loc_14C0B;                             //jmp loc_14C0B
loc_14CCD:                                      //loc_14CCD:
    if (_ch != 0x04)                            //jnz short loc_14CB3
        goto loc_14CB3;
    memory16(_ss, _bp + var_8C) = _ax;               //mov [bp+var_8C], ax
    _ch += 1;                                   //inc ch
    goto loc_14CCA;                             //jmp short loc_14CCA
loc_14CDA:                                      //loc_14CDA:
...
loc_14CE3:                                      //loc_14CE3:
    ...
    if (_ch > 0x02)                             //ja short loc_14D01
        goto loc_14D01;
    _ch = 0x02;                                 //mov ch, 2
    _xchg(_ax, memory16(_ss, _bp + var_8E));         //xchg ax, [bp+var_8E]
    _ax |= _ax;                                 //or ax, ax
    if ((short)_ax < (short)_FIXME_)            //jl short loc_14CCA
        goto loc_14CCA;
    _dx = 0x000a;                               //mov dx, 0Ah
    _mul(_dx);                                  //mul dx
    memory16(_ss, _bp + var_8E) += _ax;              //add [bp+var_8E], ax
    goto loc_14CCA;                             //jmp short loc_14CCA
loc_14D01:                                      //loc_14D01:
    if (_ch != 0x04)                            //jnz short loc_14CB3
        goto loc_14CB3;
    _xchg(_ax, memory16(_ss, _bp + var_8C));         //xchg ax, [bp+var_8C]
    _ax |= _ax;                                 //or ax, ax
    if ((short)_ax < (short)_FIXME_)            //jl short loc_14CCA
        goto loc_14CCA;
    _dx = 0x000a;                               //mov dx, 0Ah
    _mul(_dx);                                  //mul dx
    memory16(_ss, _bp + var_8C) += _ax;              //add [bp+var_8C], ax
    goto loc_14CCA;                             //jmp short loc_14CCA
loc_14D19:                                      //loc_14D19:
    memory16(_ss, _bp + var_8A) |= 0x0010;           //or [bp+var_8A], 10h
    _ch = 0x05;                                 //mov ch, 5
    goto loc_14CCA;                             //jmp short loc_14CCA
loc_14D22:                                      //loc_14D22:
    memory16(_ss, _bp + var_8A) &= 0x00ef;           //and [bp+var_8A], 0EFh
    _ch = 0x05;                                 //mov ch, 5
    goto loc_14CCA;                             //jmp short loc_14CCA
loc_14D2B:                                      //loc_14D2B:
    _bh = 0x08;                                 //mov bh, 8
...
loc_14D33:                                      //loc_14D33:
    ...
    _bl += _dl;                                 //add bl, dl
loc_14D39:                                      //loc_14D39:
    memory16(_ss, _bp + var_89) = 0x0000;            //mov [bp+var_89], 0
loc_14D3E:                                      //loc_14D3E:
    memory16(_ss, _bp + var_8F) = 0x0000;            //mov [bp+var_8F], 0
    memory16(_ss, _bp + var_90) = _dl;               //mov [bp+var_90], dl
    _di = memory16(_ss, _bp + arg_0);                //mov di, [bp+arg_0]
    _ax = memory16(_ds, _di);                   //mov ax, [di]
    _dx = 0;                                    //sub dx, dx
...
loc_14D50:                                      //loc_14D50:
    _bh = 0x0a;                                 //mov bh, 0Ah
    memory16(_ss, _bp + var_8F) = 0x0001;            //mov [bp+var_8F], 1
    memory16(_ss, _bp + var_90) = _dl;               //mov [bp+var_90], dl
    _di = memory16(_ss, _bp + arg_0);                //mov di, [bp+arg_0]
    _ax = memory16(_ds, _di);                   //mov ax, [di]
    _cwd();                                     //cwd
loc_14D61:                                      //loc_14D61:
    _di += 1;                                   //inc di
    _di += 1;                                   //inc di
    memory16(_ss, _bp + arg_2) = _si;                //mov [bp+arg_2], si
    if (!(memory16(_ss, _bp + var_8A) & 0x0010))     //jz short loc_14D71
        goto loc_14D71;
    _dx = memory16(_ds, _di);                   //mov dx, [di]
    _di += 1;                                   //inc di
    _di += 1;                                   //inc di
loc_14D71:                                      //loc_14D71:
    memory16(_ss, _bp + arg_0) = _di;                //mov [bp+arg_0], di
    _push(_dx);                                 //push dx
    _push(_ax);                                 //push ax
    _ax |= _dx;                                 //or ax, dx
    if (_ax == 0)                               //jz short loc_14D7F
        goto loc_14D7F;
    memory16(_ss, _bp + var_8A) |= 0x0004;           //or [bp+var_8A], 4
loc_14D7F:                                      //loc_14D7F:
    ...
    _cbw();                                     //cbw
    _push(_ax);                                 //push ax
    _al = memory16(_ss, _bp + var_8F);               //mov al, [bp+var_8F]
    _push(_ax);                                 //push ax
    _push(_bx);                                 //push bx
    sub_143BC();                                //call sub_143BC
    _push(_ss);                                 //push ss
    _es = _pop();                               //pop es
    _dx = memory16(_ss, _bp + var_8C);               //mov dx, [bp+var_8C]
    _dx |= _dx;                                 //or dx, dx
...
loc_14DA1:                                      //loc_14DA1:
    ...
    _bx += 1;                                   //inc bx
    _bx += 1;                                   //inc bx
    memory16(_ss, _bp + arg_0) = _bx;                //mov [bp+arg_0], bx
    if (!(memory16(_ss, _bp + var_8A) & 0x0020))     //jz short loc_14DCC
        goto loc_14DCC;
    _push(memory16(_ds, _bx));                  //push word ptr [bx]
    _bx += 1;                                   //inc bx
    _bx += 1;                                   //inc bx
...
loc_14DCC:                                      //loc_14DCC:
    ...
    memory16(_ss, _bp + var_8F) = 0x0000;            //mov [bp+var_8F], 0
    memory16(_ss, _bp + var_8A) &= 0x00fb;           //and [bp+var_8A], 0FBh
...
loc_14E13:                                      //loc_14E13:
    ...
    memory16(_ss, _bp + var_90) = _dl;               //mov [bp+var_90], dl
    _di = memory16(_ss, _bp + arg_0);                //mov di, [bp+arg_0]
    if (memory16(_ss, _bp + var_8A) & 0x0020)        //jnz short loc_14E30
        goto loc_14E30;
...
loc_14E30:                                      //loc_14E30:
    ...
    memory16(_ss, _bp + arg_0) += 0x0004;            //add [bp+arg_0], 4
    _ax = _es;                                  //mov ax, es
    _ax |= _di;                                 //or ax, di
loc_14E3A:                                      //loc_14E3A:
...
loc_14E41:                                      //loc_14E41:
    ...
    if (_cx <= memory16(_ss, _bp + var_8C))          //jbe short loc_14E51
        goto loc_14E51;
    _cx = memory16(_ss, _bp + var_8C);               //mov cx, [bp+var_8C]
loc_14E51:                                      //loc_14E51:
...
loc_14E69:                                      //loc_14E69:
    ...
    _push(_dx);                                 //push dx
    _ax = 0x0001;                               //mov ax, 1
    _al = _al & memory16(_ss, _bp + var_8A);         //and al, [bp+var_8A]
    _push(_ax);                                 //push ax
    sub_14668();                                //call sub_14668
    memory16(_ss, _bp + arg_0) += 0x0008;            //add [bp+arg_0], 8
    _push(_ss);                                 //push ss
    _es = _pop();                               //pop es
    _FIXME_;                                    //lea di, [bp+var_83]
loc_14E86:                                      //loc_14E86:
    if (!(memory16(_ss, _bp + var_8A) & 0x0008))     //jz short loc_14EA3
        goto loc_14EA3;
    _dx = memory16(_ss, _bp + var_8E);               //mov dx, [bp+var_8E]
    _dx |= _dx;                                 //or dx, dx
    if ((short)_dx <= (short)_FIXME_)           //jle short loc_14EA3
        goto loc_14EA3;
loc_14E95:                                      //loc_14E95:
    _STOP_("call $+3");                         //call $+3
    goto loc_14FF5;                             //jmp loc_14FF5
    ...
    if (_FIXME_)                                //jle short loc_14EA3
        goto loc_14EA3;
    memory16(_ss, _bp + var_88) = _dx;               //mov [bp+var_88], dx
loc_14EA3:                                      //loc_14EA3:
    _al = memory16(_ss, _bp + var_89);               //mov al, [bp+var_89]
    _al |= _al;                                 //or al, al
    ...
    if (memory(_es, _di) == 0x2d)               //jz short loc_14EBF
        goto loc_14EBF;
    _di -= 1;                                   //dec di
    _flags.carry = memory16(_ss, _bp + var_88) < 0x0001;//sub [bp+var_88], 1
    memory16(_ss, _bp + var_88) -= 0x0001;
    memory16(_ss, _bp + var_88) = memory16(_ss, _bp + var_88) + 0x0000 + _flags.carry;
...
loc_14EC5:                                      //loc_14EC5:
    _si = _di;                                  //mov si, di
    _di = memory16(_ss, _bp + var_92);               //mov di, [bp+var_92]
    _bx = memory16(_ss, _bp + var_8E);               //mov bx, [bp+var_8E]
    _al = 0x05;                                 //mov al, 5
    _al = _al & memory16(_ss, _bp + var_8A);         //and al, [bp+var_8A]
    if (_al != 0x05)                            //jnz short loc_14F10
        goto loc_14F10;
    _ah = memory16(_ss, _bp + var_90);               //mov ah, [bp+var_90]
    if (_ah != 0x6f)                            //jnz short loc_14EF1
        goto loc_14EF1;
    if ((short)memory16(_ss, _bp + var_88) > (short)0x0000)
        goto loc_14F10;
    memory16(_ss, _bp + var_88) = 0x0001;            //mov [bp+var_88], 1
...
loc_14EF1:                                      //loc_14EF1:
    ...
    if (_ah != 0x58)                            //jnz short loc_14F10
        goto loc_14F10;
loc_14EFB:                                      //loc_14EFB:
    memory16(_ss, _bp + var_8A) |= 0x0040;           //or [bp+var_8A], 40h
    _bx -= 0x0002;                              //sub bx, 2
    memory16(_ss, _bp + var_88) -= 0x0002;           //sub [bp+var_88], 2
    if (_FIXME_)                                //jge short loc_14F10
        goto loc_14F10;
    memory16(_ss, _bp + var_88) = 0x0000;            //mov [bp+var_88], 0
loc_14F10:                                      //loc_14F10:
    _cx = _cx + memory16(_ss, _bp + var_88);         //add cx, [bp+var_88]
    if (memory16(_ss, _bp + var_8A) & 0x0002)        //jnz short loc_14F2A
        goto loc_14F2A;
...
loc_14F26:                                      //loc_14F26:
    if ((short)_bx > (short)_cx)                //jg short loc_14F1D
        goto loc_14F1D;
loc_14F2A:                                      //loc_14F2A:
    if (!(memory16(_ss, _bp + var_8A) & 0x0040))     //jz short loc_14F43
        goto loc_14F43;
    _al = 0x30;                                 //mov al, 30h
    _STOP_("call $+3");                         //call $+3
    goto loc_15007;                             //jmp loc_15007
    _al = memory16(_ss, _bp + var_90);               //mov al, [bp+var_90]
    _STOP_("call $+3");                         //call $+3
    goto loc_15007;                             //jmp loc_15007
loc_14F43:                                      //loc_14F43:
    _dx = memory16(_ss, _bp + var_88);               //mov dx, [bp+var_88]
    _dx |= _dx;                                 //or dx, dx
    if ((short)_dx <= (short)_FIXME_)           //jle short loc_14F78
        goto loc_14F78;
    _cx -= _dx;                                 //sub cx, dx
    _bx -= _dx;                                 //sub bx, dx
...
loc_14F8E:                                      //loc_14F8E:
    _bx |= _bx;                                 //or bx, bx
    if ((short)_bx <= (short)_FIXME_)           //jle short loc_14F9E
        goto loc_14F9E;
    _cx = _bx;                                  //mov cx, bx
loc_14F94:                                      //loc_14F94:
    _al = 0x20;                                 //mov al, 20h
...
loc_14FA1:                                      //loc_14FA1:
    memory16(_ss, _bp + arg_2) = _si;                //mov [bp+arg_2], si
    _di = memory16(_ss, _bp + arg_0);                //mov di, [bp+arg_0]
    if (memory16(_ss, _bp + var_8A) & 0x0020)        //jnz short loc_14FB8
        goto loc_14FB8;
    _di = memory16(_ds, _di);                   //mov di, [di]
    memory16(_ss, _bp + arg_0) += 0x0002;            //add [bp+arg_0], 2
    _push(_ds);                                 //push ds
...
loc_14FBE:                                      //loc_14FBE:
    _ax = 0x0050;                               //mov ax, 50h
    _al = _al - memory16(_ss, _bp + var_51);         //sub al, [bp+var_51]
    _ax = _ax + memory16(_ss, _bp + var_54);         //add ax, [bp+var_54]
    memory16(_es, _di) = _ax;                   //mov es:[di], ax
    goto loc_14BBF;                             //jmp loc_14BBF
loc_14FCD:                                      //loc_14FCD:
    _si = memory16(_ss, _bp + var_86);               //mov si, [bp+var_86]
    _di = memory16(_ss, _bp + var_92);               //mov di, [bp+var_92]
    _al = 0x25;                                 //mov al, 25h
loc_14FD7:                                      //loc_14FD7:
    _STOP_("call $+3");                         //call $+3
    ...
    if (_al != 0)                               //jnz short loc_14FD7
        goto loc_14FD7;
loc_14FE2:                                      //loc_14FE2:
    if ((short)memory16(_ss, _bp + var_51) >= (short)0x0050)
        goto loc_14FEE;
    _STOP_("call $+3");                         //call $+3
    goto loc_15015;                             //jmp short loc_15015
loc_14FEE:                                      //loc_14FEE:
    _es = _pop();                               //pop es
    _ax = memory16(_ss, _bp + var_54);               //mov ax, [bp+var_54]
...
loc_15015:                                      //loc_15015:
    ...
    memory16(_ss, _bp + var_51) = 0x0050;            //mov [bp+var_51], 50h
    memory16(_ss, _bp + var_54) += _di;              //add [bp+var_54], di
    _FIXME_;                                    //lea di, [bp+var_50]
    _es = _pop();                               //pop es
    _dx = _pop();                               //pop dx
    _cx = _pop();                               //pop cx
...
void sub_15068()
{
    ...
    memory16(_ss, _bp + var_2) = _ax;                //mov [bp+var_2], ax
    _push(_ds);                                 //push ds
    _cx = memory16(_ss, _bp + arg_0);                //mov cx, [bp+arg_0]
    ...
    _flags.direction = true;                    //std
loc_15092:                                      //loc_15092:
    if (memory16(_ss, _bp + var_2) != 0x0000)        //jnz short loc_1509C
        goto loc_1509C;
...
loc_1514C:                                      //loc_1514C:
    ...
    if (_al != 0)                               //jnz short loc_1514C
        goto loc_1514C;
    _ds = _pop();                               //pop ds
    _dx = memory16(_ss, _bp + arg_4+4);           //mov dx, word ptr [bp+arg_4+2]
    _ax = memory16(_ss, _bp + arg_4);           //mov ax, word ptr [bp+arg_4]
    _bp = _pop();                               //pop bp
    _di = _pop();                               //pop di
    _si = _pop();                               //pop si
    _stackReduce(8);                            //retn 8
...
loc_15345:                                      //loc_15345:
    ...
    memory16(_ss, _bp + -4) = _bx;                   //mov [bp-4], bx
loc_1535D:                                      //loc_1535D:
    _ax = memory16(_ss, _bp + -4);                   //mov ax, [bp-4]
    _ax = _ax | memory16(_ss, _bp + -2);             //or ax, [bp-2]
    ...
    assert(0);//_ax = _STOP_;                               //mov ax, offset unk_19165
    _dx = _ds;                                  //mov dx, ds
...
void sub_15409()
{
    ...
    if (_ax == 0)                               //jz short loc_15431
        goto loc_15431;
    if (memory16(_ss, _bp + arg_4) == 0x0000)        //jz short loc_15431
        goto loc_15431;
    _push(memory16(_ss, _bp + arg_4));               //push [bp+arg_4]
    _FIXME_;                                    //les bx, [bp+arg_0]
...
loc_1549B:                                      //loc_1549B:
    //_FIXME_;                                    //les bx, [bp+arg_0]
    _les(_bx, _ss, _bp + arg_0);
//    _bx = memory16(_ss, _bp + arg_0);
//    _es = memory16(_ss, _bp + arg_0+2);

    if (memory16(_es, _bx) != 0x6b70)           //jnz short loc_154DC
        goto loc_154DC;
//    _FIXME_;                                    //les di, [bp+arg_0]
    _les(_di, _ss, _bp + arg_0);
    //_di = memory16(_ss, _bp + arg_0);
    //_es = memory16(_ss, _bp + arg_0+2);
    ...
    _flags.direction = false;                   //cld
    _repne_scasb();                             //repne scasb
    // TODO: treat stack as regular segment!
    memory16(_ss, _bp + var_6) = _di;           //mov word ptr [bp+var_6], di
    memory16(_ss, _bp + var_6+2) = _es;           //mov word ptr [bp+var_6+2], es
    //_FIXME_;//les bx, [bp+var_6]
    _bx = memory16(_ss, _bp + var_6);
    _es = memory16(_ss, _bp + var_6+2);
...
loc_154DC:                                      //loc_154DC:
    ...
    goto loc_1550C;                             //jmp short loc_1550C
loc_154E4:                                      //loc_154E4:
    _push(memory16(_ss, _bp + arg_0+2));          //push word ptr [bp+arg_0+2]
    _push(memory16(_ss, _bp + arg_0));          //push word ptr [bp+arg_0]
    _push(memory16(_ss, _bp + var_6+2));          //push word ptr [bp+var_6+2]
    _push(memory16(_ss, _bp + var_6));          //push word ptr [bp+var_6]
    _les(_bx, _ss, _bp + var_6);
    // es = 1000, bx = 1000 ????
    //_FIXME_;                                    //les bx, [bp+var_6]
    _push(memory16(_es, _bx + 4));              //push word ptr es:[bx+4]
    sub_15441();                                //call sub_15441
    _bx = memory16(_ss, _bp + var_2);                //mov bx, [bp+var_2]
    _bx <<= 1;                                  //shl bx, 1
    _bx <<= 1;                                  //shl bx, 1
...
void sub_15513()
{
    ...
    _flags.direction = false;                   //cld
    _repne_scasb();                             //repne scasb
    memory16(_ss, _bp + var_10) = _di;          //mov word ptr [bp+var_10], di
    memory16(_ss, _bp + var_12) = _es;          //mov word ptr [bp+var_10+2], es
...
loc_15556:                                      //loc_15556:
    _FIXME_;                                    //les bx, [bp+var_10]
    _bx += 0x0002;                              //add bx, 2
    memory16(_ss, _bp + var_C+2) = _es;           //mov word ptr [bp+var_C+2], es
    memory16(_ss, _bp + var_C) = _bx;           //mov word ptr [bp+var_C], bx
    memory16(_ss, _bp + var_8) = 0x056b;             //mov [bp+var_8], 56Bh
    memory16(_ss, _bp + var_2) = 0xffff;             //mov [bp+var_2], 0FFFFh
...
loc_15573:                                      //loc_15573:
    ...
    _ax = memory16(_es, _bx);                   //mov ax, es:[bx]
    _bx = memory16(_ss, _bp + var_8);                //mov bx, [bp+var_8]
    _push(_dx);                                 //push dx
    _push(_ax);                                 //push ax
    _push(_ds);                                 //push ds
    _es = _pop();                               //pop es
    ...
    if (_ax == memory16(_es, _bx))              //jz short loc_155B7
        goto loc_155B7;
loc_15591:                                      //loc_15591:
    if (memory16(_ss, _bp + var_2) >= 0x0000)        //jnb short loc_155AA
        goto loc_155AA;
    _bx = memory16(_ss, _bp + var_8);                //mov bx, [bp+var_8]
    ...
    memory16(_ss, _bp + var_6) = _ax;                //mov [bp+var_6], ax
loc_155AA:                                      //loc_155AA:
    memory16(_ss, _bp + var_8) += 0x000f;            //add [bp+var_8], 0Fh
    memory16(_ss, _bp + var_4) += 1;                 //inc [bp+var_4]
loc_155B1:                                      //loc_155B1:
    if (memory16(_ss, _bp + var_4) < 0x000a)         //jb short loc_15573
        goto loc_15573;
loc_155B7:                                      //loc_155B7:
    if (memory16(_ss, _bp + var_4) < 0x000a)         //jb short loc_155EC
        goto loc_155EC;
    if (memory16(_ss, _bp + var_2) != 0xffff)        //jnz short loc_155CC
        goto loc_155CC;
    _ax = 0xfff5;                               //mov ax, 0FFF5h
    memory16(_ds, 0xA9E) = _ax;                 //mov word_1913E, ax
...
loc_155EC:                                      //loc_155EC:
    ...
    memory16(_ss, _bp + var_12) = _ax;               //mov [bp+var_12], ax
    _bx = _ax;                                  //mov bx, ax
    ...
    _sp += 0x0006;                              //add sp, 6
    _bx = memory16(_ss, _bp + var_12);               //mov bx, [bp+var_12]
    memory16(_ds, _bx + 2) = 0x0000;            //mov word ptr [bx+2], 0
    memory16(_ds, _bx) = 0x0000;                //mov word ptr [bx], 0
    _push(memory16(_ss, _bp + arg_0+2));          //push word ptr [bp+arg_0+2]
    _push(memory16(_ss, _bp + arg_0));          //push word ptr [bp+arg_0]
    _push(memory16(_ss, _bp + var_12));         //push word ptr [bp+var_10+2]
    _push(memory16(_ss, _bp + var_10));         //push word ptr [bp+var_10]
    _FIXME_;                                    //les bx, [bp+var_10]
...
void loc_15661()
{
    _ax = memory16(_ss, _bp + 10);                   //mov ax, [bp+0Ah]
...
void sub_156FB()
{
    ...
    _sp += 0x000a;                              //add sp, 0Ah
    if (memory16(_ss, _bp + arg_2) == 0x0000)        //jz short loc_15740
        goto loc_15740;
    _ax = memory16(_ss, _bp + arg_0);                //mov ax, [bp+arg_0]
    if ((short)_ax < (short)memory16(_ss, _bp + var_2))//jl short loc_15728
        goto loc_15728;
    if ((short)_ax <= (short)memory16(_ss, _bp + var_4))//jle short loc_15740
        goto loc_15740;
loc_15728:                                      //loc_15728:
    if ((short)memory16(_ss, _bp + var_4) >= (short)0x0000)
        goto loc_15736;
...
void sub_157FD()
{
    ...
    _push(_ax);                                 //push ax
    _push(memory16(_ss, _bp + arg_C));               //push [bp+arg_C]
    _push(memory16(_ss, _bp + arg_A));               //push [bp+arg_A]
    _push(memory16(_ss, _bp + arg_8));               //push [bp+arg_8]
    _push(memory16(_ss, _bp + arg_6));               //push [bp+arg_6]
    sub_1517A();                                //call sub_1517A
...
void sub_15AA2()
{
    ...
    _bp = _sp;                                  //mov bp, sp
    _sp -= 0x0008;                              //sub sp, 8
    memory16(_ss, _bp + var_4+2) = _cs;           //mov word ptr [bp+var_4+2], cs
    memory16(_ss, _bp + var_4) = 0x6f70;        //mov word ptr [bp+var_4], 6F70h
...
loc_15AE8:                                      //loc_15AE8:
    _push(memory16(_ss, _bp + arg_4+2));          //push word ptr [bp+arg_4+2]
    _push(memory16(_ss, _bp + arg_4));          //push word ptr [bp+arg_4]
    _push(memory16(_ss, _bp + arg_0+2));          //push word ptr [bp+arg_0+2]
    _push(memory16(_ss, _bp + arg_0));          //push word ptr [bp+arg_0]
    _push(_ds);                                 //push ds
...
loc_15B38:                                      //loc_15B38:
    ...
    memory16(_ss, _bp + var_8+2) = _dx;           //mov word ptr [bp+var_8+2], dx
    memory16(_ss, _bp + var_8) = _ax;           //mov word ptr [bp+var_8], ax
    ...
    memory16(_ss, _bp + var_8) += 1;            //inc word ptr [bp+var_8]
    _bx = memory16(_ss, _bp + var_8);           //mov bx, word ptr [bp+var_8]
...
void loc_15C58()
{
    ...
    memory16(_ds, 0x5F7) = 0x0000;              //mov word ptr dword_18C97, 0
loc_15C79:                                      //loc_15C79:
    _ax = memory16(_ss, _bp + 12);                   //mov ax, [bp+0Ch]
    memory16(_ds, 0xB4F) = _ax;                 //mov word_191EF, ax
    _push(_ax);                                 //push ax
    _push(_cs);                                 //push cs
...
void sub_15D98()
{
    ...
    _si = memory16(_ss, _bp + arg_0);                //mov si, [bp+arg_0]
    _si |= _si;                                 //or si, si
    if ((short)_si < (short)_FIXME_)            //jl short loc_15DD1
        goto loc_15DD1;
    _di |= _di;                                 //or di, di
    if ((short)_di < (short)_FIXME_)            //jl short loc_15DD1
        goto loc_15DD1;
    _ax = memory16(_ss, _bp + arg_4);                //mov ax, [bp+arg_4]
...
void sub_1608C()
{
    ...
    _push(_cs);                                 //push cs
    sub_162FA();                                //call near ptr sub_162FA
    if (_ax >= memory16(_ss, _bp + arg_4))           //jnb short loc_160A8
        goto loc_160A8;
    memory16(_ds, 0xA9E) = 0xfff5;              //mov word_1913E, 0FFF5h
...
loc_16221:                                      //loc_16221:
    ...
    _al = memory(_es, _bx);                     //mov al, es:[bx]
    _ah = 0x00;                                 //mov ah, 0
    memory16(_ss, _bp + -24) = _ax;                  //mov [bp-18h], ax
loc_1622C:                                      //loc_1622C:
    _FIXME_ = 0x0000;                           //mov word ptr [bp-1Ah], 0
    goto loc_16257;                             //jmp short loc_16257
loc_16233:                                      //loc_16233:
    _FIXME_;                                    //les bx, [bp-16h]
    _bx = _bx + memory16(_ss, _bp + -26);            //add bx, [bp-1Ah]
    _al = memory(_es, _bx + 1);                 //mov al, es:[bx+1]
    _cbw();                                     //cbw
    if ((short)_ax <= (short)0xffff)            //jle short loc_16254
        goto loc_16254;
    _bx = memory16(_ss, _bp + -22);                  //mov bx, [bp-16h]
    _bx = _bx + memory16(_ss, _bp + -26);            //add bx, [bp-1Ah]
    _al = memory(_es, _bx + 1);                 //mov al, es:[bx+1]
    _bx = memory16(_ss, _bp + -26);                  //mov bx, [bp-1Ah]
    memory(_ds, _bx + 2879) = _al;              //mov [bx+0B3Fh], al
loc_16254:                                      //loc_16254:
    _FIXME_ += 1;                               //inc word ptr [bp-1Ah]
loc_16257:                                      //loc_16257:
    _ax = memory16(_ss, _bp + -26);                  //mov ax, [bp-1Ah]
    if (_ax < memory16(_ss, _bp + -24))              //jb short loc_16233
        goto loc_16233;
    _FIXME_;                                    //les bx, [bp-16h]
    _al = memory(_es, _bx + 1);                 //mov al, es:[bx+1]
    _cbw();                                     //cbw
...
loc_16294:                                      //loc_16294:
    ...
    _ds = memory16(_cs, 0x1A3);                 //mov ds, cs:word_101A3
    _bp = _sp;                                  //mov bp, sp
    _di = memory16(_ss, _bp + 14);                   //mov di, [bp+0Eh]
    _si = memory16(_ss, _bp + 12);                   //mov si, [bp+0Ch]
    ...
    if (_ax < _si)                              //jb short loc_162D8
        goto loc_162D8;
    _di |= _di;                                 //or di, di
    if ((short)_di < (short)_FIXME_)            //jl short loc_162D8
        goto loc_162D8;
    _ax = _di;                                  //mov ax, di
...
void loc_16388()
{
    ...
    _ax = _ax + memory16(_ss, _bp + -2);             //add ax, [bp-2]
    if (_ax > memory16(_ds, 0xB2B))             //ja short loc_163D0
        goto loc_163D0;
    _ax = memory16(_ss, _bp + 12);                   //mov ax, [bp+0Ch]
    _ax = _ax + memory16(_ds, 0xA94);           //add ax, word_19134
    if ((short)_ax < (short)_FIXME_)            //jl short loc_163D0
        goto loc_163D0;
    _si |= _si;                                 //or si, si
    if (_si <= 0)                               //jbe short loc_163D0
        goto loc_163D0;
    _ax = memory16(_ss, _bp + 14);                   //mov ax, [bp+0Eh]
    _ax = _ax + memory16(_ds, 0xA96);           //add ax, word_19136
    if ((short)_ax < (short)_FIXME_)            //jl short loc_163D0
        goto loc_163D0;
    _FIXME_;                                    //les bx, [bp+10h]
    memory16(_es, _bx + 2) = _si;               //mov es:[bx+2], si
    _push(memory16(_ss, _bp + 20));             //push word ptr [bp+14h]
    _push(memory16(_ss, _bp + 18));             //push word ptr [bp+12h]
    _push(_bx);                                 //push bx
    _push(memory16(_ss, _bp + 14));             //push word ptr [bp+0Eh]
    _push(memory16(_ss, _bp + 12));             //push word ptr [bp+0Ch]
    _push(_cs);                                 //push cs
...
void sub_1643D()
{
    ...
    _si = memory16(_ss, _bp + arg_0);                //mov si, [bp+arg_0]
    _si |= _si;                                 //or si, si
    if ((short)_si < (short)_FIXME_)            //jl short loc_16460
        goto loc_16460;
    if ((short)_si > (short)0x0002)             //jg short loc_16460
        goto loc_16460;
    _di |= _di;                                 //or di, di
    if ((short)_di < (short)_FIXME_)            //jl short loc_16460
        goto loc_16460;
...
void sub_1647D()
{
    ...
    if ((short)_si > (short)0x000a)             //jg short loc_164AC
        goto loc_164AC;
    _si |= _si;                                 //or si, si
    if ((short)_si < (short)_FIXME_)            //jl short loc_164AC
        goto loc_164AC;
    _si |= _si;                                 //or si, si
...
loc_1658C:                                      //loc_1658C:
    ...
    goto loc_16642;                             //jmp loc_16642
loc_16595:                                      //loc_16595:
    _ax = memory16(_ss, _bp + var_C);                //mov ax, [bp+var_C]
...
loc_165B7:                                      //loc_165B7:
    ...
    memory16(_ss, _bp + var_6) = _ax;                //mov [bp+var_6], ax
    _push(_ax);                                 //push ax
    _push(memory16(_ss, _bp + var_C));               //push [bp+var_C]
    _push(_dx);                                 //push dx
    _push(_ax);                                 //push ax
    sub_15208();                                //call sub_15208
    _ax |= _ax;                                 //or ax, ax
...
loc_16642:                                      //loc_16642:
    _si = _si ^ _si;                            //xor si, si
    memory16(_ss, _bp + arg_4) = 0x0001;             //mov [bp+arg_4], 1
loc_16649:                                      //loc_16649:
...
void sub_16721()
{
    ...
    _cx = memory16(_ss, _bp + arg_4);                //mov cx, [bp+arg_4]
    _dx = memory16(_ss, _bp + arg_6);                //mov dx, [bp+arg_6]
    if (memory16(_ss, _bp + arg_8) != 0x0000)        //jnz short loc_16741
        goto loc_16741;
    _ah |= 0x80;                                //or ah, 80h
loc_16741:                                      //loc_16741:
...
loc_167DE:                                      //loc_167DE:
    ...
    _push(_si);                                 //push si
    _push(_di);                                 //push di
    _al = memory16(_ss, _bp + 6);                    //mov al, [bp+6]
    _ah = _ah ^ _ah;                            //xor ah, ah
    _push(_ax);                                 //push ax
...
void sub_16809()
{
    ...
    _push(_si);                                 //push si
    _push(_di);                                 //push di
    _ah = memory16(_ss, _bp + arg_4);                //mov ah, [bp+arg_4]
...
void sub_16867()
{
    ...
    _ax = _ax - memory16(_ss, _bp + 6);              //sub ax, [bp+6]
...
loc_1686E:                                      //loc_1686E:
    ...
    _bx = _pop();                               //pop bx
    _mul(_bx);                                  //mul bx
    _cx = memory16(_ss, _bp + 12);                   //mov cx, [bp+0Ch]
    _cx = _cx - memory16(_ss, _bp + 8);              //sub cx, [bp+8]
...
loc_16A5E:                                      //loc_16A5E:
    ...
    _bx = _pop();                               //pop bx
    _ax = _pop();                               //pop ax
    _cx = memory16(_ss, _bp + 14);                   //mov cx, [bp+0Eh]
    _dx = memory16(_ss, _bp + 16);                   //mov dx, [bp+10h]
...
void sub_16B25()
{
    ...
    _push(_si);                                 //push si
    _push(_di);                                 //push di
    _bl = memory16(_ss, _bp + arg_0);                //mov bl, [bp+arg_0]
    _bh = _bh ^ _bh;                            //xor bh, bh
    _ax = 0xffff;                               //mov ax, 0FFFFh
...
void sub_16BA4()
{
    ...
    _bx = memory16(_ss, _bp + arg_2);                //mov bx, [bp+arg_2]
    _cl = memory16(_ss, _bp + arg_4);                //mov cl, [bp+arg_4]
...
void sub_16C12()
{
    ...
    _push(_si);                                 //push si
    _push(_di);                                 //push di
    _ah = memory16(_ss, _bp + arg_2);                //mov ah, [bp+arg_2]
    memory(_ds, 0x60E) = _ah;                   //mov byte_18CAE, ah
    _al = memory(_ds, 0x60D);                   //mov al, byte_18CAD
    _si = 0x001e;                               //mov si, 1Eh
    dword_18AB2();                              //call dword_18AB2
...
void loc_17964()
{
    ...
    _ax = memory16(_ss, _bp + -20);                  //mov ax, [bp-14h]
...
void sub_17970()
{
    ...
    _dh = _dh + memory16(_ss, _bp + _si + 18);       //add dh, [bp+si+12h]
    _FIXME_ += 1;                               //inc word ptr [bp-12h]
    _bx = memory16(_ss, _bp + -22);                  //mov bx, [bp-16h]
    if (_bx != memory16(_ss, _bp + -18))             //jnz short loc_17985
        goto loc_17985;
    _FIXME_ = 0x0000;                           //mov word ptr [bp-12h], 0
    _imul(_bx);                                 //imul bx
loc_17985:                                      //loc_17985:
    memory16(_ss, _bp + -10) += _ax;                 //add [bp-0Ah], ax
    _ax = memory16(_ss, _bp + -10);                  //mov ax, [bp-0Ah]
    if ((short)_ax < (short)memory16(_ss, _bp + -14))//jl short loc_17964
        { loc_17964(); return; }
    _push(_ds);                                 //push ds
    _es = _pop();                               //pop es
    _push(_cs);                                 //push cs
...
void sub_17995()
{
    ...
    _bx = memory16(_ss, _bp + -2);                   //mov bx, [bp-2]
    _bx += 1;                                   //inc bx
    _bx += 1;                                   //inc bx
...
void sub_17A03()
{
    ...
    if (_ax >= memory16(_ss, _bp + -16))             //jnb short locret_17A32
        goto locret_17A32;
...
loc_17A40:
    ...
    return;                                     //retn
loc_17A50:                                      //loc_17A50:
    if ((short)_ax >= (short)memory16(_ss, _bp + -12))//jge short loc_17A58
        goto loc_17A58;
    memory16(_ss, _bp + -12) = _ax;                  //mov [bp-0Ch], ax
loc_17A58:                                      //loc_17A58:
    if ((short)_ax < (short)memory16(_ss, _bp + -14))//jl short loc_17A40
        goto loc_17A40;
    memory16(_ss, _bp + -14) = _ax;                  //mov [bp-0Eh], ax
...
loc_17A88:                                      //loc_17A88:
    ...
    _ax = _pop();                               //pop ax
    _ax += 1;                                   //inc ax
    if (_ax < memory16(_ss, _bp + -6))               //jb short loc_17A6C
        goto loc_17A6C;
...
void loc_17B9D()
{
    memory16(_ss, _bp + -40) = _ax;                  //mov [bp-28h], ax
    if (memory16(_ss, _bp + 18) & 0xffff)       //jnz short loc_17BAA
        goto loc_17BAA;
    memory16(_ss, _bp + 18) += 1;               //inc word ptr [bp+12h]
loc_17BAA:                                      //loc_17BAA:
    if (memory16(_ss, _bp + 16) & 0xffff)       //jnz short loc_17BB4
        goto loc_17BB4;
    memory16(_ss, _bp + 16) += 1;               //inc word ptr [bp+10h]
loc_17BB4:                                      //loc_17BB4:
    _ax = memory16(_ss, _bp + 16);                   //mov ax, [bp+10h]
    _bx = memory16(_ss, _bp + 18);                   //mov bx, [bp+12h]
...
loc_17BCD:                                      //loc_17BCD:
    memory16(_ss, _bp + -36) = _ax;                  //mov [bp-24h], ax
    memory16(_ss, _bp + -34) = _dx;                  //mov [bp-22h], dx
    _bx = memory16(_ss, _bp + 18);                   //mov bx, [bp+12h]
    sub_17D97();                                //call sub_17D97
    sub_17D97();                                //call sub_17D97
    memory16(_ss, _bp + -8) = _ax;                   //mov [bp-8], ax
    memory16(_ss, _bp + -6) = _dx;                   //mov [bp-6], dx
    _ax = _ax ^ _ax;                            //xor ax, ax
    memory16(_ss, _bp + -2) = _ax;                   //mov [bp-2], ax
    memory16(_ss, _bp + -20) = _ax;                  //mov [bp-14h], ax
    memory16(_ss, _bp + -18) = _ax;                  //mov [bp-12h], ax
    _ax = memory16(_ss, _bp + -36);                  //mov ax, [bp-24h]
    _dx = memory16(_ss, _bp + -34);                  //mov dx, [bp-22h]
    _bx = memory16(_ss, _bp + 16);                   //mov bx, [bp+10h]
    memory16(_ss, _bp + -4) = _bx;                   //mov [bp-4], bx
    sub_17D97();                                //call sub_17D97
    sub_17D97();                                //call sub_17D97
    memory16(_ss, _bp + -12) = _ax;                  //mov [bp-0Ch], ax
    memory16(_ss, _bp + -10) = _dx;                  //mov [bp-0Ah], dx
    sub_17DA9();                                //call sub_17DA9
...
loc_17C0D:                                      //loc_17C0D:
    ...
    goto loc_17C9E;                             //jmp loc_17C9E
loc_17C19:                                      //loc_17C19:
    _flags.carry = _ax < memory16(_ss, _bp + -36);   //sub ax, [bp-24h]
    _ax = _ax - memory16(_ss, _bp + -36);
    _dx -= memory16(_ss, _bp + -34) + _flags.carry;  //sbb dx, [bp-22h]
    memory16(_ss, _bp + -16) = _ax;                  //mov [bp-10h], ax
    memory16(_ss, _bp + -14) = _dx;                  //mov [bp-0Eh], dx
    _flags.carry = !!(_di & 0x8000);            //shl di, 1
    _di <<= 1;
    _rcl(_si, 1);                               //rcl si, 1
    memory16(_ss, _bp + -24) = _di;                  //mov [bp-18h], di
    memory16(_ss, _bp + -22) = _si;                  //mov [bp-16h], si
loc_17C2F:                                      //loc_17C2F:
    sub_17D0D();                                //call sub_17D0D
    sub_17CA4();                                //call sub_17CA4
    _ax = memory16(_ss, _bp + -16);                  //mov ax, [bp-10h]
    _bx = memory16(_ss, _bp + -14);                  //mov bx, [bp-0Eh]
    _flags.carry = (_ax + _ax) >= 0x10000;      //add ax, ax
    _ax += _ax;
    _bx = _bx + _bx + _flags.carry;             //adc bx, bx
    _flags.carry = (_ax + memory16(_ss, _bp + -28)) >= 0x10000;
    _ax = _ax + memory16(_ss, _bp + -28);
    _bx = _bx + memory16(_ss, _bp + -26) + _flags.carry;//adc bx, [bp-1Ah]
    _flags.carry = (_ax + memory16(_ss, _bp + -28)) >= 0x10000;
    _ax = _ax + memory16(_ss, _bp + -28);
    _bx = _bx + memory16(_ss, _bp + -26) + _flags.carry;//adc bx, [bp-1Ah]
    if ((short)_bx < (short)memory16(_ss, _bp + -30))//jl short loc_17C5A
        goto loc_17C5A;
    if (_bx != memory16(_ss, _bp + -30))             //jnz short loc_17C57
        goto loc_17C57;
    if (_ax < memory16(_ss, _bp + -32))              //jb short loc_17C5A
        goto loc_17C5A;
loc_17C57:                                      //loc_17C57:
    sub_17CEB();                                //call sub_17CEB
loc_17C5A:                                      //loc_17C5A:
    sub_17CC9();                                //call sub_17CC9
    _ax = memory16(_ss, _bp + -18);                  //mov ax, [bp-12h]
    if ((short)_ax < (short)memory16(_ss, _bp + -22))//jl short loc_17C2F
        goto loc_17C2F;
    if (_ax != memory16(_ss, _bp + -22))             //jnz short loc_17C6F
        goto loc_17C6F;
    _ax = memory16(_ss, _bp + -20);                  //mov ax, [bp-14h]
    if (_ax < memory16(_ss, _bp + -24))              //jb short loc_17C2F
        goto loc_17C2F;
loc_17C6F:                                      //loc_17C6F:
    sub_17D0D();                                //call sub_17D0D
    sub_17CA4();                                //call sub_17CA4
    _ax = memory16(_ss, _bp + -28);                  //mov ax, [bp-1Ch]
    _bx = memory16(_ss, _bp + -26);                  //mov bx, [bp-1Ah]
    _flags.carry = _bx & 1;                     //shr bx, 1
    _bx >>= 1;
    _rcr(_ax, 1);                               //rcr ax, 1
    _flags.carry = (_ax + memory16(_ss, _bp + -16)) >= 0x10000;
    _ax = _ax + memory16(_ss, _bp + -16);
    _bx = _bx + memory16(_ss, _bp + -14) + _flags.carry;//adc bx, [bp-0Eh]
    if ((short)_bx > (short)memory16(_ss, _bp + -30))//jg short loc_17C94
        goto loc_17C94;
    if (_bx != memory16(_ss, _bp + -30))             //jnz short loc_17C91
        goto loc_17C91;
    if (_ax > memory16(_ss, _bp + -32))              //ja short loc_17C94
        goto loc_17C94;
loc_17C91:                                      //loc_17C91:
    sub_17CC9();                                //call sub_17CC9
loc_17C94:                                      //loc_17C94:
...
{
    _ax = memory16(_ss, _bp + -20);                  //mov ax, [bp-14h]
    _ax = _ax + memory16(_ss, _bp + -8);             //add ax, [bp-8]
    memory16(_ss, _bp + -28) = _ax;                  //mov [bp-1Ch], ax
    _ax = memory16(_ss, _bp + -18);                  //mov ax, [bp-12h]
    _ax = _ax + memory16(_ss, _bp + -6) + _flags.carry; _ASSERT(0);
    memory16(_ss, _bp + -26) = _ax;                  //mov [bp-1Ah], ax
    _ax = memory16(_ss, _bp + -24);                  //mov ax, [bp-18h]
    _ax = _ax - memory16(_ss, _bp + -12);            //sub ax, [bp-0Ch]
    memory16(_ss, _bp + -32) = _ax;                  //mov [bp-20h], ax
    _ax = memory16(_ss, _bp + -22);                  //mov ax, [bp-16h]
    _FIXME_;                                    //sbb ax, [bp-0Ah]
    memory16(_ss, _bp + -30) = _ax;                  //mov [bp-1Eh], ax
}
...
void sub_17CC9()
{
    ...
    _ax = memory16(_ss, _bp + -28);                  //mov ax, [bp-1Ch]
    memory16(_ss, _bp + -16) += _ax;                 //add [bp-10h], ax
    _ax = memory16(_ss, _bp + -26);                  //mov ax, [bp-1Ah]
    memory16(_ss, _bp + -14) = memory16(_ss, _bp + -14) + _ax + _flags.carry; _ASSERT(0);
    _ax = memory16(_ss, _bp + -28);                  //mov ax, [bp-1Ch]
    _ax = _ax + memory16(_ss, _bp + -8);             //add ax, [bp-8]
    memory16(_ss, _bp + -20) = _ax;                  //mov [bp-14h], ax
    _ax = memory16(_ss, _bp + -26);                  //mov ax, [bp-1Ah]
...
void sub_17CEB()
{
    ...
    _ax = memory16(_ss, _bp + -32);                  //mov ax, [bp-20h]
    memory16(_ss, _bp + -16) -= _ax;                 //sub [bp-10h], ax
    _ax = memory16(_ss, _bp + -30);                  //mov ax, [bp-1Eh]
    ...
    _ax = memory16(_ss, _bp + -30);                  //mov ax, [bp-1Eh]
    _FIXME_;                                    //sbb ax, [bp-0Ah]
    memory16(_ss, _bp + -22) = _ax;                  //mov [bp-16h], ax
}

void sub_17D0D()
{
    _dx = memory16(_ss, _bp + 14);                   //mov dx, [bp+0Eh]
    _si = memory16(_ss, _bp + -2);                   //mov si, [bp-2]
    _di = memory16(_ss, _bp + -4);                   //mov di, [bp-4]
    if (memory16(_ss, _bp + 12) & 0x8000)       //jnz short loc_17D3C
        { loc_17D3C(); return; }
...
void sub_17D2E()
{
    _push(_di);                                 //push di
    _push(_si);                                 //push si
    _si = _si + memory16(_ss, _bp + 22);             //add si, [bp+16h]
    _di = _di + memory16(_ss, _bp + 20);             //add di, [bp+14h]
...
void sub_17D4D()
{
    ...
    if (memory16(_ss, _bp + -42) != 0x00)            //jnz short loc_17D65
        goto loc_17D65;
    if ((short)_ax < (short)memory16(_ss, _bp + -38))//jl short locret_17D64
        goto locret_17D64;
    if ((short)_ax <= (short)memory16(_ss, _bp + -40))//jle short sub_17D2E
        { sub_17D2E(); return; }
locret_17D64:                                   //locret_17D64:
    return;                                     //retn
loc_17D65:                                      //loc_17D65:
    if ((short)_ax >= (short)memory16(_ss, _bp + -38))//jge short sub_17D2E
        { sub_17D2E(); return; }
    if ((short)_ax <= (short)memory16(_ss, _bp + -40))//jle short sub_17D2E
        { sub_17D2E(); return; }
}
