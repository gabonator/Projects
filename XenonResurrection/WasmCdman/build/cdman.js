...
if (ENVIRONMENT_IS_NODE) {
  var fs = require('fs');
  Module['wasm'] = fs.readFileSync(__dirname + '/cdman.wasm');
}

if (ENVIRONMENT_IS_SHELL) {
  Module['wasm'] = read('cdman.wasm', 'binary');
}
...
WebAssembly.instantiate(Module['wasm'], imports).then(function(output) {
  ...
  _appInit = asm["appInit"];
  _appLoop = asm["appLoop"];
  _appFinish = asm["appFinish"];
