...
loc_004f:                                       //loc_004f:
    ...
    _ds = _pop();                               //pop ds
    sub_17fe();                                 //call sub_17fe
    _ax = 0x168f;                               //mov ax, 0x168f
    _ds = _ax;                                  //mov ds, ax
    _ax = 0x168f;                               //mov ax, 0x168f
    _ds = _ax;                                  //mov ds, ax
    sub_107d();                                 //call sub_107d
    ...
    sub_183f();                                 //call sub_183f --- greeting
    sub_1198();                                 //call sub_1198
    _ax = 0x4000;                               //mov ax, 0x4000
    _out(64, _al);                              //out 0x40, al
    _al = _ah;                                  //mov al, ah
    _out(64, _al);                              //out 0x40, al
    sub_53a2();                                 //call sub_53a2 --- titus logo
    sub_52ec();                                 //call sub_52ec --- game logo
    sub_24c9();                                 //call sub_24c9
...
loc_00c5:                                       //loc_00c5:
    ...
    sub_0173();                                 //call sub_0173 --- level info
loc_00e9:                                       //loc_00e9:     --- game loop
    sub_3160();                                 //call sub_3160
...
void sub_0333()
{
    ...
    memory16(_ds, 501) = 0x000e;                //mov word ptr [0x1f5], 0xe
    memory16(_ds, 503) = 0x0c80;                //mov word ptr [0x1f7], 0xc80
    _si = 0x0052;                               //mov si, 0x52
    sub_0488();                                 //call sub_0488
    _al = memory(_ds, 0x5250);                  //mov al, [0x5250]
    _cbw();                                     //cbw
    sub_6582();                                 //call sub_6582
    _dx = _ax;                                  //mov dx, ax
    sub_0465();                                 //call sub_0465
    sub_03f2();                                 //call sub_03f2
    sub_3243();                                 //call sub_3243
    sub_03ae();                                 //call sub_03ae
...
loc_0468:                                       //loc_0468:
    ...
    _dx <<= 1;
    _rcl(_ax, 1);                               //rcl ax, 1
    if (_al <= 0x09)                            //jbe loc_0480
        goto loc_0480;
    _al += 0x07;                                //add al, 0x7
loc_0480:                                       //loc_0480:
    _al += 0x30;                                //add al, 0x30
    sub_050e();                                 //call sub_050e
    if (--_cx)                                  //loop loc_0468
        goto loc_0468;
}
...
void sub_0691()
{
    memoryVideoAdd(_ds, _si, _al);                    //add byte ptr [si], al
    _si += _bp;                                 //add si, bp
    memoryVideoAdd(_ds, _si, _al);                    //add byte ptr [si], al
    _si += _bp;                                 //add si, bp
    memoryVideoAdd(_ds, _si, _al);                    //add byte ptr [si], al
...
loc_0b80:                                       //loc_0b80:
    ...
    if (_ax == 0x0100)                          //jz loc_0b6e
        goto loc_0b6e;
    _flags.zero = _ax == 0x0101;
loc_0b8b:                                       //loc_0b8b:
    if (_flags.zero)                          //jz loc_0c02
        goto loc_0c02;
...
loc_0d05:                                       //loc_0d05:
    ...
    _STOP_("continues");                        //sub_0d27 proc near
}
...
void sub_0d51()
{
    ...
    _al = _ah;                                  //mov al, ah
    _out(97, _al);                              //out 0x61, al
    memory(_ds, 1216) = _bl;                    //mov byte ptr [0x4c0], bl
    if (_bl != 0x01)                            //jnz loc_0d79
        goto loc_0d79;
loc_0d79:                                       //loc_0d79:
    if (memory(_cs, 0x6BB3) != 0x00)            //jnz loc_0df9
        goto loc_0df9;
    _ax = 0x0003;                               //mov ax, 0x3
    _interrupt(16);                             //int 0x10
    _si = 0x0127;                               //mov si, 0x127
...
loc_0d8b:                                       //loc_0d8b:
    _lodsb<MemData, DirForward>();              //lodsb
    _al |= _al;                                 //or al, al
    if (_al == 0)                               //jz loc_0d94
        goto loc_0d94;
    _interrupt(16);                             //int 0x10
    goto loc_0d8b;                              //jmp loc_0d8b
loc_0d94:                                       //loc_0d94:
    _al = _al ^ _al;                            //xor al, al
    _out(64, _al);                              //out 0x40, al
    _out(64, _al);                              //out 0x40, al
    _dx = 0x0040;                               //mov dx, 0x40
loc_0d9d:                                       //loc_0d9d:
    _in(_al, _dx);                              //in al, dx
    _ah = _al;                                  //mov ah, al
    _in(_al, _dx);                              //in al, dx
    _xchg(_ah, _al);                            //xchg ah, al
    if (_ax < 0xf000)                           //jc loc_0d9d
        goto loc_0d9d;
loc_0da8:                                       //loc_0da8:
    _in(_al, _dx);                              //in al, dx
    _ah = _al;                                  //mov ah, al
    ...
    _ax = _cs;                                  //mov ax, cs
    _es = _ax;                                  //mov es, ax
    _cx = 0x0dc9;                               //mov cx, 0xdc9
    _di = _di ^ _di;                            //xor di, di
    _rep_stosb<MemData, DirForward>();          //rep stosb
    _di = 0x0df9;                               //mov di, 0xdf9
    _dx = 0x015e;                               //mov dx, 0x15e
loc_0dda:                                       //loc_0dda:
    _cx = 0x0400;                               //mov cx, 0x400
    _rep_stosb<MemData, DirForward>();          //rep stosb
    _di -= 0x0400;                              //sub di, 0x400
    _ax += 0x0040;                              //add ax, 0x40
    _es = _ax;                                  //mov es, ax
    _dx -= 1;                                   //dec dx
    if (_dx != 0)                               //jnz loc_0dda
        goto loc_0dda;
    _al = 0x20;                                 //mov al, 0x20
    ...
    _STOP_("db 00h");                           //db 00h
loc_0df9:                                       //loc_0df9:
    if (_bl != 0x3d)                            //jnz loc_0e1c
        goto loc_0e1c;
    memory(_cs, 0x16E4) = memory(_cs, 0x16E4) ^ 0x02;//xor byte ptr cs:[0x16e4], 0x2
    if (memory(_cs, 0x16E3) == 0x01)            //jz loc_0e1c
        goto loc_0e1c;
    _in(_al, 97);                               //in al, 0x61
    _al &= 0xfc;                                //and al, 0xfc
    if (!(memory(_cs, 0x16E4) & 0x02))          //jz loc_0e1a
        goto loc_0e1a;
    _al |= 0x03;                                //or al, 0x3
loc_0e1a:                                       //loc_0e1a:
    _out(97, _al);                              //out 0x61, al
loc_0e1c:                                       //loc_0e1c:
    ...
    _cbw();                                     //cbw
    _ah = (~_ah);                               //not ah
    memory(_ds, _bx + 1088) = _ah;              //mov byte ptr [bx+0x440], ah
    _al = 0x20;                                 //mov al, 0x20
    _out(32, _al);                              //out 0x20, al
    _ax = _pop();                               //pop ax
    _bx = _pop();                               //pop bx
    _ds = _pop();                               //pop ds
    return;                                     //iret
    _STOP_("sp-trace-fail");                    //sub_0d51 endp_failed
    _STOP_("continues");                        //sub_0e33 proc near
}
...
void sub_0e33()
{
    ...
    _ax = _ax ^ _ax;                            //xor ax, ax
    _ds = _ax;                                  //mov ds, ax
    _al = 0xcf;                                 //mov al, 0xcf
    _ASSERT(0); //_les(_di, _ds, 0x000c);                     //les di, [0xc]
    _stosb<MemData, DirForward>();              //stosb
    memory16(_ds, 4) = 0x1028;                  //mov word ptr [0x4], 0x1028
    memory16(_ds, 6) = _cs;                     //mov word ptr [0x6], cs
    _pushf();                                   //pushf
    _ax = _pop();                               //pop ax
    _ah |= 0x01;                                //or ah, 0x1
    _push(_ax);                                 //push ax
    ...
    _ax = _ax ^ _ax;                            //xor ax, ax
    _ds = _ax;                                  //mov ds, ax
    _bx = 0x0211;                               //mov bx, 0x211
    _ch = 0x00;                                 //mov ch, 0x0
loc_0e68:                                       //loc_0e68:
    _cl = 0x01;                                 //mov cl, 0x1
loc_0e6a:                                       //loc_0e6a:
    _ax = 0x0201;                               //mov ax, 0x201
    _dx = _dx ^ _dx;                            //xor dx, dx
    _pushf();                                   //pushf
    _STOP_("db 00h");                           //db 00h
    _flags.interrupt = false;                   //cli
    _ax = memory16(_cs, 0xFFC);                 //mov ax, cs:[0xffc]
    _ax = _ax | memory16(_cs, 0xFFE);           //or ax, word ptr cs:[0xffe]
    if (_ax != 0)                               //jnz loc_0e92
        goto loc_0e92;
    _cl += 1;                                   //inc cl
    if (_cl != 0x0a)                            //jnz loc_0e6a
        goto loc_0e6a;
    _ch += 1;                                   //inc ch
    if (_ch <= 0x27)                            //jbe loc_0e68
        goto loc_0e68;
    _ah = 0x4c;                                 //mov ah, 0x4c
    _interrupt(33);                             //int 0x21
loc_0e92:                                       //loc_0e92:
    _ax = 0x168f;                               //mov ax, 0x168f
    _ds = _ax;                                  //mov ds, ax
    _es = _ax;                                  //mov es, ax
    _ah = 0x19;                                 //mov ah, 0x19
    _interrupt(33);                             //int 0x21
    _al &= 0x01;                                //and al, 0x1
    memory(_ds, 0x210) = _al;                   //mov [0x210], al
    sub_0efe();                                 //call sub_0efe
    if (!_flags.carry)                          //jnc loc_0ede
        goto loc_0ede;
    sub_0efe();                                 //call sub_0efe
    if (!_flags.carry)                          //jnc loc_0ede
        goto loc_0ede;
    memory(_ds, 528) = memory(_ds, 528) ^ 0x01; //xor byte ptr [0x210], 0x1
    sub_0efe();                                 //call sub_0efe
    if (!_flags.carry)                          //jnc loc_0ede
        goto loc_0ede;
    sub_0efe();                                 //call sub_0efe
    ...
    _ax = 0x0003;                               //mov ax, 0x3
    _interrupt(16);                             //int 0x10
    _dx = 0x01f9;                               //mov dx, 0x1f9
    _ah = 0x09;                                 //mov ah, 0x9
    _interrupt(33);                             //int 0x21
    _ah = 0x0e;                                 //mov ah, 0xe
    _al = memory(_ds, 0x414);                   //mov al, [0x414]
    _al += 0x30;                                //add al, 0x30
    _interrupt(16);                             //int 0x10
    _al = 0x2d;                                 //mov al, 0x2d
    _interrupt(16);                             //int 0x10
    _dx = memory16(_ds, 1045);                  //mov dx, word ptr [0x415]
    sub_1004();                                 //call sub_1004
    _STOP_("goto loc_096c");                    //jmp loc_096c
loc_0ede:                                       //loc_0ede:
    _pushf();                                   //pushf
    if (memory(_ds, 1047) == 0x01)              //jz loc_0ef3
        goto loc_0ef3;
    _ah = 0x19;                                 //mov ah, 0x19
    _interrupt(33);                             //int 0x21
    if (_al < 0x03)                             //jc loc_0ef3
        goto loc_0ef3;
    memory(_ds, 1047) = 0x01;                   //mov byte ptr [0x417], 0x1
loc_0ef3:                                       //loc_0ef3:
    _popf();                                    //popf
    _bp = _pop();                               //pop bp
    _es = _pop();                               //pop es
...
void sub_0efe()
{
    _dl = memory(_ds, 528);                     //mov dl, byte ptr [0x210]
    _ah = _ah ^ _ah;                            //xor ah, ah
    _interrupt(19);                             //int 0x13
    _ax = 0x0201;                               //mov ax, 0x201
    _bx = 0x0211;                               //mov bx, 0x211
    _cx = 0x0002;                               //mov cx, 0x2
    _dl = memory(_ds, 528);                     //mov dl, byte ptr [0x210]
    _dh = 0x00;                                 //mov dh, 0x0
    memory(_ds, 1041) = 0x01;                   //mov byte ptr [0x411], 0x1
    sub_0ffa();                                 //call sub_0ffa
    if (_FIXME_)                                //jc loc_0f7c
        goto loc_0f7c;
    memory(_ds, 1047) = 0x00;                   //mov byte ptr [0x417], 0x0
    _ax = 0x2701;                               //mov ax, 0x2701
    if (memory(_ds, _bx) != 0xf9)               //jnz loc_0f34
        goto loc_0f34;
    memory(_ds, 1047) = 0x01;                   //mov byte ptr [0x417], 0x1
    _ax = 0x4f00;                               //mov ax, 0x4f00
loc_0f34:                                       //loc_0f34:
    memory(_ds, 527) = _ah;                     //mov byte ptr [0x20f], ah
    memory(_ds, 0x20e) = _al;                   //mov [0x20e], al
    memory(_ds, 1041) = 0x02;                   //mov byte ptr [0x411], 0x2
    _cl = 0x01;                                 //mov cl, 0x1
loc_0f42:                                       //loc_0f42:
    _ax = 0x0201;                               //mov ax, 0x201
    _bx = 0x0211;                               //mov bx, 0x211
    _ch = memory(_ds, 527);                     //mov ch, byte ptr [0x20f]
    _dh = memory(_ds, 526);                     //mov dh, byte ptr [0x20e]
    sub_0ffa();                                 //call sub_0ffa
    if (_FIXME_)                                //jc loc_0f7c
        goto loc_0f7c;
    _cl += 1;                                   //inc cl
    if (_cl <= 0x0a)                            //jbe loc_0f42
        goto loc_0f42;
    _ax = 0x0201;                               //mov ax, 0x201
    _cl = 0xf7;                                 //mov cl, 0xf7
    _dl = memory(_ds, 528);                     //mov dl, byte ptr [0x210]
    sub_0ffa();                                 //call sub_0ffa
    memory(_ds, 1041) = 0x03;                   //mov byte ptr [0x411], 0x3
    if (_FIXME_)                                //jnc loc_0f7c
        goto loc_0f7c;
    memory(_ds, 1041) = 0x04;                   //mov byte ptr [0x411], 0x4
    memory16(_ds, 0x0412) = _ax;                //mov [0x412], ax
    if (_ah == 0x10)                            //jz loc_0f90
        goto loc_0f90;
loc_0f7c:                                       //loc_0f7c:
    _al = memory(_ds, 0x411);                   //mov al, [0x411]
    if (memory(_ds, 1044) >= _al)               //jnc loc_0f8e
        goto loc_0f8e;
    memory(_ds, 0x414) = _al;                   //mov [0x414], al
    _ax = memory16(_ds, 0x0412);                //mov ax, [0x412]
    memory16(_ds, 0x0415) = _ax;                //mov [0x415], ax
loc_0f8e:                                       //loc_0f8e:
    _flags.carry = true;                        //stc
    return;                                     //ret
loc_0f90:                                       //loc_0f90:
    memory(_ds, 1041) = 0x05;                   //mov byte ptr [0x411], 0x5
    if (memory16(_ds, 529) != 0x4f4d)           //jnz loc_0f7c
        goto loc_0f7c;
    memory(_ds, 1041) = 0x06;                   //mov byte ptr [0x411], 0x6
    if (memory16(_ds, 531) != 0x544b)           //jnz loc_0f7c
        goto loc_0f7c;
    memory(_ds, 1041) = 0x07;                   //mov byte ptr [0x411], 0x7
    _di = 0x0250;                               //mov di, 0x250
    _bx = _bx ^ _bx;                            //xor bx, bx
loc_0fb4:                                       //loc_0fb4:
    _bx += 1;                                   //inc bx
    if (memory(_ds, _bx + _di) == 0x4e)         //jz loc_0fb4
        goto loc_0fb4;
    memory16(_ds, 1042) = _bx;                  //mov word ptr [0x412], bx
    _lea(_di, _ds, _bx + _di + 10);             //lea di, [bx+di+0xa]
    memory(_ds, 1041) = 0x08;                   //mov byte ptr [0x411], 0x8
    _ah = memory(_ds, _di);                     //mov ah, byte ptr [di]
    _bx = _bx ^ _bx;                            //xor bx, bx
loc_0fcd:                                       //loc_0fcd:
    _bx += 1;                                   //inc bx
    if (memory(_ds, _bx + _di) == _ah)          //jz loc_0fcd
        goto loc_0fcd;
    memory16(_ds, 1042) = _bx;                  //mov word ptr [0x412], bx
    _di += _bx;                                 //add di, bx
    memory(_ds, 1041) = 0x09;                   //mov byte ptr [0x411], 0x9
    _di = 0x0410;                               //mov di, 0x410
    _al = memory(_ds, _di);                     //mov al, byte ptr [di]
    _bx = _bx ^ _bx;                            //xor bx, bx
loc_0fe7:                                       //loc_0fe7:
    _bx -= 1;                                   //dec bx
    if (memory(_ds, _bx + _di) == _al)          //jz loc_0fe7
        goto loc_0fe7;
    _bx = (~_bx);                               //not bx
    memory16(_ds, 1042) = _bx;                  //mov word ptr [0x412], bx
    if (_bx < 0x00a8)                           //jc loc_0f7c
        goto loc_0f7c;
    _flags.carry = false;                       //clc
}
...
void sub_1028()
{
    ...
    _push(_ax);                                 //push ax
    _bp = _sp;                                  //mov bp, sp
    if (memory16(_cs, 0xFFE) != 0x0000)         //jnz loc_1075
        goto loc_1075;
    _STOP_("db 00h");                           //db 00h
    if (_ax < 0xc000)                           //jc loc_107a
        goto loc_107a;
    _STOP_("db 00h");                           //db 00h
    _ax >>= 1;                                  //shr ax, 1
    _ax >>= 1;                                  //shr ax, 1
...
loc_104f:                                       //loc_104f:
    ...
    _STOP_("db 00h");                           //db 00h
    _STOP_("db 00h");                           //db 00h
    if (memory(_ds, _bp + 0) != 0xfa)           //jnz loc_1065
        goto loc_1065;
    _bp = _sp;                                  //mov bp, sp
    _STOP_("db 00h");                           //db 00h
    goto loc_104f;                              //jmp loc_104f
loc_1065:                                       //loc_1065:
    _bp = _sp;                                  //mov bp, sp
    _STOP_("db 00h");                           //db 00h
    memory16(_cs, 0xFFE) = _ax;                 //mov cs:[0xffe], ax
    _STOP_("db 00h");                           //db 00h
    memory16(_cs, 0xFFC) = _ax;                 //mov cs:[0xffc], ax
loc_1075:                                       //loc_1075:
    _STOP_("db 00h");                           //db 00h
loc_107a:                                       //loc_107a:
    _ax = _pop();                               //pop ax
    _bp = _pop();                               //pop bp
    return;                                     //iret
    _STOP_("sp-trace-fail");                    //sub_1028 endp_failed
...
loc_12e5:                                       //loc_12e5:
    ...
    if (!(_al & 0x80))                          //jz loc_12ef
        goto loc_12ef;
    _STOP_("goto loc_1454");                    //jmp loc_1454
loc_12ef:                                       //loc_12ef:
    _ah = _al;                                  //mov ah, al
    _ah &= 0x0f;                                //and ah, 0xf
    _cl = _ah;                                  //mov cl, ah
...
loc_1327:                                       //loc_1327:
    ...
    memory16(_ds, 2325) += 0x0011;              //add word ptr [0x915], 0x11
...
loc_1454:                                       //loc_1454:
    ...
    _STOP_("goto loc_12e5");                    //jmp loc_12e5
loc_146f:                                       //loc_146f:
    _bl = _al;                                  //mov bl, al
    _bx <<= 1;                                  //shl bx, 1
...
void sub_14d5()
{
    memory(_ds, _di + 2) = _al;                 //mov byte ptr [di+0x2], al
}

void sub_14d9()
{
    memory(_ds, _di + 3) = _al;                 //mov byte ptr [di+0x3], al
}
...
void sub_14e1()
{
    memory(_ds, _di + 5) = _al;                 //mov byte ptr [di+0x5], al
}
...
void sub_14e5()
{
    ...
    _STOP_("sp-trace-fail");                    //sub_14e5 endp_failed
    _STOP_("continues");                        //sub_14e9 proc near
}
...
void sub_159c()
{
    ...
    _STOP_("goto loc_1327");                    //jmp loc_1327
}

void sub_15a7()  // Play tone
{
    _push(_dx);                                 //push dx
    _push(_ax);                                 //push ax
    _push(_cx);                                 //push cx
...
loc_165e:                                       //loc_165e:
    ...
    _STOP_("continues");                        //sub_16e5 proc near
}
...
{
    _lea(_ax, _ds, _si + 2);                    //lea ax, [si+0x2]
    memory16(_ds, 0x0b0a) = _ax;                //mov [0xb0a], ax
    _si = memory16(_ds, _si);                   //mov si, word ptr [si]
}

void sub_17d0()
{
    _si = memory16(_ds, 2826);                  //mov si, word ptr [0xb0a]
}
...
{
    _al = memory(_ds, _si);                     //mov al, byte ptr [si]
    memory(_ds, 0xb0c) = _al;                   //mov [0xb0c], al
    _si += 1;                                   //inc si
}

void sub_17df()
{
    memory(_ds, 2828) -= 1;                     //dec byte ptr [0xb0c]
    if (memory(_ds, 2828) == 0)                 //jz loc_17e8
        goto loc_17e8;
    _si = memory16(_ds, _si);                   //mov si, word ptr [si]
    return;                                     //ret
loc_17e8:                                       //loc_17e8:
...
loc_1db0:                                       //loc_1db0:
    ...
    addimage((int)memory16(_cs, 0x1C50), (int)memory16(_cs, 0x1C4E),
             (int)memory(_cs, 0x1C4A), (int)memory(_cs, 0x1C52),
             memory16(_cs, 0x1C5A), memory16(_cs, 0x1C5C),
             memory(_cs, 0x1C48)&1);
    _cl = memory(_cs, 0x0);                     //mov cl, byte ptr cs:[0x0]
    _sar(_ax, _cl);                             //sar ax, cl
...
loc_22fb:                                       //loc_22fb:
    ...
    //_scasb();                                   //scasb
    //_di -= 1;                                   //dec di
    _stosb<MemVideo, DirForward>();              //stosb  ------ tuto 1
...
loc_2339:                                       //loc_2339:
    ...
    //_scasb();                                   //scasb
    //_di -= 1;                                   //dec di
    _stosb<MemVideo, DirForward>();              //stosb   --- 2 draw sprite pixels
...
loc_2356:                                       //loc_2356:
    ...
    _stosb<MemVideo, DirForward>();              //stosb -- background
...
loc_23f4:                                       //loc_23f4:
    ...
    //_scasb();                                   //scasb
    //_di -= 1;                                   //dec di
    _stosb<MemVideo, DirForward>();              //stosb     -- draw
loc_2400:                                       //loc_2400:
    _bl &= _bh;                                 //and bl, bh
    _ah = _bl;                                  //mov ah, bl
    _cl -= 1;                                   //dec cl
...
loc_251a:                                       //loc_251a:
    ...
    _push(_ds);                                 //push ds
    _push(_es);                                 //push es
    sub_097b();                                 //call sub_097b -- js problem
    _es = _pop();                               //pop es
    _ds = _pop();                               //pop ds
...
void sub_2ab1()  // draw background tiles - scroll
{
...
loc_2c38:                                       //loc_2c38:
    ...
    _al = _bl;                                  //mov al, bl
    _bx = memory16(_ds, 25846);                 //mov bx, word ptr [0x64f6]
    { int dd = (memory(_ds, 0x5272) << 8) | memory(_ds, 0x5270);
        std::cout << "upd " << _bx << ", " << (int)_al << ", " << (int)memory(_ds, _bx+_al) << ", " << _es << ":" << (_si) << "," << dd << "\n";}
    _xlat_ds();                                 //xlat ds
    _bh = _bh ^ _bh;                            //xor bh, bh
...
void sub_2df5()  // draw background tile
{
    _push(_si);                                 //push si
    _push(_ds);                                 //push ds
    _ah = _ah ^ _ah;                            //xor ah, ah
...
loc_40d7:                                       //loc_40d7:
    ...
    if (memory16(_ds, 25890) == _dx)            //jz loc_40f4
        goto loc_40f4;
    std::cout << "scroll " << (short)memory16(_ds, 25890) << " / " << (short)_dx << "\n";
...
loc_410b:                                       //loc_410b:
    if (memory16(_ds, _si + 4) == 0xffff)   //jz loc_4133
        goto loc_4133;
    _bx = _bx ^ _bx;                            //xor bx, bx
    _bl = _bl + 0x00 + _flags.carry;            //adc bl, 0x0
...
loc_412d:                                       //loc_412d:
    if (_bx < 0x00c8)                           //jc loc_4146
        goto loc_4146;
loc_4133:                                       //loc_4133:
    _flags.carry = _si + 0x0012 >= 0x10000;
    _si += 0x0012;                              //add si, 0x12
...
loc_4674:                                       //loc_4674:
    if (memory16(_ds, _si + 4) == 0xffff)   //jz loc_4654
        goto loc_4735; //_STOP_("goto loc_4654");
...
void sub_4833()
{
    if (memory(_ds, 25863) == 0x00)             //jz loc_4842
        goto loc_4842;
    _bp = 0x0040;                               //mov bp, 0x40
    sub_4b7d();                                 //call sub_4b7d
    goto loc_4845;                              //jmp loc_4845
loc_4842:                                       //loc_4842:
    sub_4be8();                                 //call sub_4be8
loc_4845:                                       //loc_4845:
    if (memory16(_ds, 25886) > 0x0001)          //ja loc_485c
        goto loc_485c;
    _ax = 0x000c;                               //mov ax, 0xc
    if (memory(_ds, 25865) == 0x00)             //jz loc_4859
        goto loc_4859;
    _ax = 0x0017;                               //mov ax, 0x17
loc_4859:                                       //loc_4859:
    memory16(_ds, 0x5280) = _ax;                //mov [0x5280], ax
loc_485c:                                       //loc_485c:
    _ax = _ax ^ _ax;                            //xor ax, ax
    if (memory(_ds, 25864) == _al)              //jz loc_48c8
        goto loc_48c8;
    _al = 0x06;                                 //mov al, 0x6
    _al = _al + memory(_ds, 25865);             //add al, byte ptr [0x6509]
    _cbw();                                     //cbw
    ...
    sub_4c12();                                 //call sub_4c12
    sub_4c2a();                                 //call sub_4c2a
    memory(_ds, 21116) &= 0xf0;                 //and byte ptr [0x527c], 0xf0
    memory(_ds, 21116) += 0x08;                 //add byte ptr [0x527c], 0x8
    _bx = 0x73a3;                               //mov bx, 0x73a3
    _cl = 0x04;                                 //mov cl, 0x4
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    _al &= 0xf0;                                //and al, 0xf0
    _ax <<= _cl;                                //shl ax, cl
    _di = memory16(_ds, 21116);                 //mov di, word ptr [0x527c]
    _sar(_di, _cl);                             //sar di, cl
    _di += _ax;                                 //add di, ax
    _es = memory16(_ds, 21100);                 //mov es, word ptr [0x526c]
    _al = memory(_es, _di);                     //mov al, byte ptr es:[di]
    _xlat_ds();                                 //xlat ds
    if (_al == 0x06)                            //jz loc_48bc
        goto loc_48bc;
    _dx = 0xfff0;                               //mov dx, 0xfff0
    _al = memory(_es, _di + -1);                //mov al, byte ptr es:[di-0x1]
    _xlat_ds();                                 //xlat ds
    if (_al == 0x06)                            //jz loc_48b8
        goto loc_48b8;
    _dx = -_dx;                                 //neg dx
    _al = memory(_es, _di + 1);                 //mov al, byte ptr es:[di+0x1]
    _xlat_ds();                                 //xlat ds
...
loc_48b8:                                       //loc_48b8:
    memory16(_ds, 21116) += _dx;                //add word ptr [0x527c], dx
loc_48bc:                                       //loc_48bc:
    _ax = 0x0040;                               //mov ax, 0x40
    if (memory(_ds, 1069) == 0x00)              //jz loc_48c8
        goto loc_48c8;
    _ax = -_ax;                                 //neg ax
loc_48c8:                                       //loc_48c8:
    memory16(_ds, 0x528a) = _ax;                //mov [0x528a], ax
...
void sub_48d6()
{
    ...
    sub_4c2a();                                 //call sub_4c2a
    sub_4be8();                                 //call sub_4be8
    if (memory(_ds, 25865) == 0x00)             //jz loc_495a
        goto loc_495a;
    _ax = _ax ^ _ax;                            //xor ax, ax
    _dx = 0xff60;                               //mov dx, 0xff60
    if (memory(_ds, 1069) != 0x00)              //jnz loc_490a
        goto loc_490a;
    _dx = 0xff20;                               //mov dx, 0xff20
    _xchg(_ax, _dx);                            //xchg ax, dx
    if (memory(_ds, 21121) & 0x80)              //jnz loc_48ff
        goto loc_48ff;
    _ax = -_ax;                                 //neg ax
loc_48ff:                                       //loc_48ff:
    _bx = memory16(_ds, 21118);                 //mov bx, word ptr [0x527e]
    _bx -= 0x0010;                              //sub bx, 0x10
    memory16(_ds, 21136) = _bx;                 //mov word ptr [0x5290], bx
loc_490a:                                       //loc_490a:
    _dx |= _dx;                                 //or dx, dx
    if (_dx != 0)                               //jnz loc_4921
        goto loc_4921;
    _bx = memory16(_ds, 21138);                 //mov bx, word ptr [0x5292]
    _bh &= 0x1f;                                //and bh, 0x1f
    if (_bx >= 0x0065)                          //jnc loc_4938
        goto loc_4938;
    if (!(memory(_ds, _bx + 28441) & 0x04))     //jz loc_4938
        goto loc_4938;
loc_4921:                                       //loc_4921:
    sub_4ae9();                                 //call sub_4ae9
    _bx = memory16(_ds, 25833);                 //mov bx, word ptr [0x64e9]
    memory16(_ds, _bx + 14) = _dx;              //mov word ptr [bx+0xe], dx
    _dx = _ax;                                  //mov dx, ax
    _sar(_dx, 1);                               //sar dx, 1
    _sar(_dx, 1);                               //sar dx, 1
    _ax -= _dx;                                 //sub ax, dx
    memory16(_ds, _bx + 6) = _ax;               //mov word ptr [bx+0x6], ax
    goto loc_4949;                              //jmp loc_4949
loc_4938:                                       //loc_4938:
    memory(_ds, 25866) = 0x01;                  //mov byte ptr [0x650a], 0x1
    memory16(_ds, 0x5294) = _ax;                //mov [0x5294], ax
    memory16(_ds, 21148) = _dx;                 //mov word ptr [0x529c], dx
    _al = 0x03;                                 //mov al, 0x3
    sub_11e6();                                 //call sub_11e6
loc_4949:                                       //loc_4949:
    _al = 0x0a;                                 //mov al, 0xa
    ...
    _ah &= 0x80;                                //and ah, 0x80
    memory16(_ds, 0x5280) = _ax;                //mov [0x5280], ax
    memory(_ds, 25865) = 0x00;                  //mov byte ptr [0x6509], 0x0
loc_495a:                                       //loc_495a:
    return;
}
...
void sub_495b()
{
    ...
    sub_4c2a();                                 //call sub_4c2a
    sub_4be8();                                 //call sub_4be8
    if (memory(_ds, 25868) != 0x00)             //jnz loc_49af
        goto loc_49af;
    if (memory16(_ds, 25886) != 0x0001)         //jnz loc_49b2
        goto loc_49b2;
    if (memory(_ds, 25865) == 0x00)             //jz loc_49b2
        goto loc_49b2;
    sub_4ae9();                                 //call sub_4ae9
    _bx = memory16(_ds, 25833);                 //mov bx, word ptr [0x64e9]
    ...
    _xlat_ds();                                 //xlat ds
    _al &= 0x07;                                //and al, 0x7
    if (_al == 0)                               //jz loc_49af
        goto loc_49af;
    _dx = 0xffd0;                               //mov dx, 0xffd0
    _al = _ah;                                  //mov al, ah
    _xlat_ds();                                 //xlat ds
    _al &= 0x07;                                //and al, 0x7
    if (_al == 0)                               //jz loc_49a8
        goto loc_49a8;
    _dx = -_dx;                                 //neg dx
loc_49a8:                                       //loc_49a8:
    _bx = memory16(_ds, 25833);                 //mov bx, word ptr [0x64e9]
    memory16(_ds, _bx + 6) = _dx;               //mov word ptr [bx+0x6], dx
loc_49af:                                       //loc_49af:
    goto loc_4ae3;                              //jmp loc_4ae3
loc_49b2:                                       //loc_49b2:
    if (memory(_ds, 25865) == 0x00)             //jz loc_49bc
        goto loc_49bc;
    goto loc_4ac1;                              //jmp loc_4ac1
loc_49bc:                                       //loc_49bc:
    _di = 0x52a0;                               //mov di, 0x52a0
    _cx = 0x0030;                               //mov cx, 0x30
    _bx = memory16(_ds, 21118);                 //mov bx, word ptr [0x527e]
    _dx = memory16(_ds, 21116);                 //mov dx, word ptr [0x527c]
loc_49ca:                                       //loc_49ca:
    if (memory16(_ds, _di + 4) != 0xffff)   //jnz loc_49d3
        goto loc_49d3;
    goto loc_4ada;                              //jmp loc_4ada
loc_49d3:                                       //loc_49d3:
    _ax = _bx;                                  //mov ax, bx
    _ax = _ax - memory16(_ds, _di + 2);         //sub ax, word ptr [di+0x2]
    if ((short)_ax >= 0)                        //jns loc_49dc
        goto loc_49dc;
    _ax = -_ax;                                 //neg ax
loc_49dc:                                       //loc_49dc:
    if (_ax < 0x0014)                           //jc loc_49e4
        goto loc_49e4;
    goto loc_4ada;                              //jmp loc_4ada
loc_49e4:                                       //loc_49e4:
    _ax = _dx;                                  //mov ax, dx
    _ax = _ax - memory16(_ds, _di);             //sub ax, word ptr [di]
    if (memory(_ds, 21121) & 0x80)              //jnz loc_49f1
        goto loc_49f1;
    _ax = -_ax;                                 //neg ax
loc_49f1:                                       //loc_49f1:
    if (_ax < 0x0014)                           //jc loc_49f9
        goto loc_49f9;
    goto loc_4ada;                              //jmp loc_4ada
loc_49f9:                                       //loc_49f9:
    if (_cx > 0x0008)                           //ja loc_4a11
        goto loc_4a11;
    _bx = memory16(_ds, _di + 4);               //mov bx, word ptr [di+0x4]
    _bh &= 0x1f;                                //and bh, 0x1f
    _al = memory(_ds, _bx + 28538);             //mov al, byte ptr [bx+0x6f7a]
    _al &= 0x0f;                                //and al, 0xf
    if (_al != 0x0f)                            //jnz loc_4a11
        goto loc_4a11;
    goto loc_4ad2;                              //jmp loc_4ad2
loc_4a11:                                       //loc_4a11:
    _bx = memory16(_ds, _di + 4);               //mov bx, word ptr [di+0x4]
    _bh &= 0x1f;                                //and bh, 0x1f
    _bx <<= 1;                                  //shl bx, 1
...
loc_4a27:                                       //loc_4a27:
    _bh = _bh ^ _bh;                            //xor bh, bh
    _ax += _bx;                                 //add ax, bx
    if ((short)_ax >= (short)_dx)               //jge loc_4a32
        goto loc_4a32;
    goto loc_4ad2;                              //jmp loc_4ad2
loc_4a32:                                       //loc_4a32:
    _ax = memory16(_ds, _di + 2);               //mov ax, word ptr [di+0x2]
    ...
    _bl = memory(_ds, _bx + 27640);             //mov bl, byte ptr [bx+0x6bf8]
    _bl -= 1;                                   //dec bl
    if ((short)_ax >= (short)_dx)               //jge loc_4a4e
        goto loc_4a4e;
    _xchg(_ax, _dx);                            //xchg ax, dx
    _bl = 0x0a;                                 //mov bl, 0xa
loc_4a4e:                                       //loc_4a4e:
    _bh = _bh ^ _bh;                            //xor bh, bh
    _ax -= _bx;                                 //sub ax, bx
    if ((short)_ax >= (short)_dx)               //jge loc_4ad2
        goto loc_4ad2;
    if (memory(_ds, _di + 4) < 0x65)            //jc loc_4a90
        goto loc_4a90;
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _di);             //sub ax, word ptr [di]
    if (!(memory(_ds, _di + 5) & 0x80))         //jz loc_4a69
        goto loc_4a69;
    _ax = -_ax;                                 //neg ax
loc_4a69:                                       //loc_4a69:
    _flags.sign = !!(_ax & 0x8000);             //or ax, ax
    _ax |= _ax;
    if (_flags.sign)                            //js loc_4ad2
        goto loc_4ad2;
    _bx = memory16(_ds, _di + 9);               //mov bx, word ptr [di+0x9]
    memory16(_ds, _bx + 4) = 0xffff;            //mov word ptr [bx+0x4], 0xffff
    _bx = memory16(_ds, _di + 4);               //mov bx, word ptr [di+0x4]
    _bh &= 0x1f;                                //and bh, 0x1f
    _bl = memory(_ds, _bx + 28538);             //mov bl, byte ptr [bx+0x6f7a]
    _bl &= 0x0f;                                //and bl, 0xf
    _bh = _bh ^ _bh;                            //xor bh, bh
    _bx <<= 1;                                  //shl bx, 1
    _bx = memory16(_ds, _bx + 28613);           //mov bx, word ptr [bx+0x6fc5]
    _bx += 0x0065;                              //add bx, 0x65
    memory16(_ds, _di + 4) = _bx;               //mov word ptr [di+0x4], bx
loc_4a90:                                       //loc_4a90:
    _al = 0x09;                                 //mov al, 0x9
    sub_11e6();                                 //call sub_11e6
    ...
    memory(_ds, 25873) = 0x04;                  //mov byte ptr [0x6511], 0x4
    _ax = 0xffff;                               //mov ax, 0xffff
    _xchg(memory16(_ds, _di + 4), _ax);         //xchg word ptr [di+0x4], ax
    memory16(_ds, 0x5292) = _ax;                //mov [0x5292], ax
    memory(_ds, 25865) = 0x10;                  //mov byte ptr [0x6509], 0x10
    memory(_ds, 25877) = 0x00;                  //mov byte ptr [0x6515], 0x0
    if (_al != 0x31)                            //jnz loc_4ac1
        goto loc_4ac1;
    memory(_ds, 25859) = 0x00;                  //mov byte ptr [0x6503], 0x0
loc_4ac1:                                       //loc_4ac1:
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
...
loc_4ada:                                       //loc_4ada:
    _di += 0x0012;                              //add di, 0x12
    _cx -= 1;                                   //dec cx
    if (_cx == 0)                               //jz loc_4ae3
        goto loc_4ae3;
    goto loc_49ca;                              //jmp loc_49ca
loc_4ae3:                                       //loc_4ae3:
    memory(_ds, 25868) = 0x01;                  //mov byte ptr [0x650c], 0x1
}
...
void sub_4ca2()
{
    memory(_ds, 25894) |= 0x01;                 //or byte ptr [0x6526], 0x1
}
...
loc_4ceb:                                       //loc_4ceb:
    ...
    //_STOP_("sp-trace-fail");                    //sub_4cd8 endp_failed
...
void sub_4d10()
{
    ...
    _cx = 0x0064;                               //mov cx, 0x64
loc_4d1f:                                       //loc_4d1f:
    if (memory16(_ds, _si + 2) == _di)          //jz loc_4d2b
        goto loc_4d2b;
    _si += 0x0004;                              //add si, 0x4
    if (--_cx)                                  //loop loc_4d1f
        goto loc_4d1f;
    goto loc_4d8f;                              //jmp loc_4d8f
loc_4d2b:                                       //loc_4d2b:
    if (memory(_ds, _si) < 0xfd)                //jc loc_4d39
        goto loc_4d39;
    _ax = 0x0006;                               //mov ax, 0x6
    sub_10ff();                                 //call sub_10ff
    sub_59a1();                                 //call sub_59a1
loc_4d39:                                       //loc_4d39:
    _al = memory(_ds, _si + 1);                 //mov al, byte ptr [si+0x1]
    memory(_es, _di) = _al;                     //mov byte ptr es:[di], al
    _bl = 0x50;                                 //mov bl, 0x50
    _bh = 0x02;                                 //mov bh, 0x2
    if (memory(_cs, 0x1) < 0x03)                //jc loc_4d52
        goto loc_4d52;
    sub_32f4();                                 //call sub_32f4
    _bl = 0x28;                                 //mov bl, 0x28
    _bh = 0x01;                                 //mov bh, 0x1
loc_4d52:                                       //loc_4d52:
    
    /*
                 tile: 1d2a
     fox.js:7110 tile: 1d2c
     fox.js:7110 tile: 1d2e
     */
    _ax = _di;                                  //mov ax, di
    _al = _ah;                                  //mov al, ah
    _ah = _ah ^ _ah;                            //xor ah, ah
    ...
    _di += _ax;                                 //add di, ax
    _al = memory(_ds, _si + 1);                 //mov al, byte ptr [si+0x1]
    sub_2ddc();                                 // bpm 087c:7bb2
    memory(_ds, 25873) = 0x04;                  //mov byte ptr [0x6511], 0x4
    memory(_ds, 25845) = 0x01;                  //mov byte ptr [0x64f5], 0x1
    _flags.carry = false;                       //clc
    goto loc_4d90;                              //jmp loc_4d90
loc_4d8f:                                       //loc_4d8f:
    _flags.carry = true;                        //stc
loc_4d90:                                       //loc_4d90:
    _bp = _pop();                               //pop bp
...
void sub_4d9a()
{
    ...
    sub_10ff();                                 //call sub_10ff
    _al = memory(_ds, 0x5250);                  //mov al, [0x5250]
    memory(_ds, 21072) = 0x0e;                  //mov byte ptr [0x5250], 0xe
    _push(_ax);                                 //push ax
    sub_4db1();                                 //call sub_4db1
    _ax = _pop();                               //pop ax
    memory(_ds, 0x5250) = _al;                  //mov [0x5250], al
}
...
void sub_4dc9()
{
    ...
    memory16(_ds, 0x64e4) = _ax;                //mov [0x64e4], ax
    _dx = memory16(_ds, 21118);                 //mov dx, word ptr [0x527e]
    memory16(_ds, 25830) = _dx;                 //mov word ptr [0x64e6], dx
    _bx = memory16(_ds, 21138);                 //mov bx, word ptr [0x5292]
    _bh &= 0x1f;                                //and bh, 0x1f
    _bx -= 0x0038;                              //sub bx, 0x38
    if (_bx > 0x0001)                           //ja loc_4df8
        goto loc_4df8;
    memory16(_ds, 0x64f8) = _ax;                //mov [0x64f8], ax
    memory16(_ds, 25850) = _dx;                 //mov word ptr [0x64fa], dx
loc_4df8:                                       //loc_4df8:
    return;
}
...
{
    memory(_ds, 21124) = 0x00;                  //mov byte ptr [0x5284], 0x0
    if (memory(_ds, 25872) != 0x00)             //jnz loc_4e10
        goto loc_4e10;
    {sub_4cd8(); return; };                     //
loc_4e10:                                       //loc_4e10:
    {sub_4ca2(); return; };                     //
...
{
    sub_4cd8();                                 //call sub_4cd8
    memory(_ds, 21124) = 0x01;                  //mov byte ptr [0x5284], 0x1
}

void sub_4e1c()
{
    sub_4cd8();                                 //call sub_4cd8
    memory(_ds, 21124) = 0x02;                  //mov byte ptr [0x5284], 0x2
}

void sub_4e25()
{
    sub_4cd8();                                 //call sub_4cd8
    memory(_ds, 21124) = 0x03;                  //mov byte ptr [0x5284], 0x3
}

void sub_4e2e()
{
    if (memory(_ds, 25875) != 0x00)             //jnz sub_4df9
        { sub_4df9(); return; }
    _al = memory(_ds, 0x5287);                  //mov al, [0x5287]
    _al &= 0x0f;                                //and al, 0xf
...
loc_4e40:                                       //loc_4e40:
    ...
    memory16(_ds, 21120) = 0x000e;              //mov word ptr [0x5280], 0xe
    memory16(_ds, 21118) += 0x0008;             //add word ptr [0x527e], 0x8
loc_4e5c:                                       //loc_4e5c:
    _push(_ds);                                 //push ds
    _ds = memory16(_ds, 21100);                 //mov ds, word ptr [0x526c]
...
loc_4e7e:                                       //loc_4e7e:
    ...
    memory(_ds, 25869) = 0x01;                  //mov byte ptr [0x650d], 0x1
}
...
void sub_4e88()
{
    if (memory16(_ds, 21130) == 0x0000)         //jz loc_4ea5
        goto loc_4ea5;
    memory16(_ds, 21130) = 0x0000;              //mov word ptr [0x528a], 0x0
    memory16(_ds, 21118) &= 0xfff0;             //and word ptr [0x527e], 0xfff0
    memory16(_ds, 21118) += 0x0010;             //add word ptr [0x527e], 0x10
    memory(_ds, 25885) = 0xff;                  //mov byte ptr [0x651d], 0xff
    return;                                     //ret
loc_4ea5:                                       //loc_4ea5:
    _al = memory(_ds, 0x5280);                  //mov al, [0x5280]
    if (_al == 0x0a)                            //jz loc_4f02
        goto loc_4f02;
    if (_al == 0x15)                            //jz loc_4f02
        goto loc_4f02;
    if (memory(_ds, 25871) == 0x06)             //jz loc_4f02
        goto loc_4f02;
    memory(_ds, 25870) = 0x01;                  //mov byte ptr [0x650e], 0x1
    if (memory(_ds, 25865) == 0x00)             //jz loc_4f02
        goto loc_4f02;
    sub_4ae9();                                 //call sub_4ae9
    _push(_bx);                                 //push bx
    _push(_di);                                 //push di
    _di = memory16(_ds, 25833);                 //mov di, word ptr [0x64e9]
    _cl = 0x04;                                 //mov cl, 0x4
    _ax = memory16(_ds, _di + 2);               //mov ax, word ptr [di+0x2]
    _sar(_ax, _cl);                             //sar ax, cl
    _bh = _al;                                  //mov bh, al
    ...
    _xlat_ds();                                 //xlat ds
    _al &= 0x01;                                //and al, 0x1
    if (_al == 0)                               //jz loc_4f00
        goto loc_4f00;
    _dx = 0x0010;                               //mov dx, 0x10
    _al = memory(_es, _di + -1);                //mov al, byte ptr es:[di-0x1]
    _xlat_ds();                                 //xlat ds
    _al &= 0x01;                                //and al, 0x1
    if (_al != 0)                               //jnz loc_4efa
        goto loc_4efa;
    _dx = -_dx;                                 //neg dx
loc_4efa:                                       //loc_4efa:
    _di = memory16(_ds, 25833);                 //mov di, word ptr [0x64e9]
...
void sub_4f03()
{
    if ((short)memory16(_ds, 21130) >= (short)0x0000)//jge loc_4f1b
        goto loc_4f1b;
    if (memory16(_ds, 21122) != 0x0000)         //jnz loc_4f1b
        goto loc_4f1b;
    memory(_ds, 25885) = 0x0a;                  //mov byte ptr [0x651d], 0xa
    memory(_ds, 25869) = 0x01;                  //mov byte ptr [0x650d], 0x1
loc_4f1b:                                       //loc_4f1b:
    return;                                     //ret
loc_4f1c:                                       //loc_4f1c:
...
void sub_4f1f()
{
    ...
    _bx = _bx ^ _bx;                            //xor bx, bx
    sub_5045();                                 //call sub_5045
    if (!_flags.carry)                                //jnc loc_4f1c
        goto loc_503b; //_STOP_("goto loc_4f1c");
    memory16(_ds, 21118) = _dx;                 //mov word ptr [0x527e], dx
    _di = _ax;                                  //mov di, ax
    _al = memory(_ds, _di + 4);                 //mov al, byte ptr [di+0x4]
...
loc_5110:                                       //loc_5110:
    ...
    _bx = _pop();                               //pop bx
    _ax = _pop();                               //pop ax
    _flags.carry = true;                        //stc 020d:511b
    return;                                     //ret
loc_511d:                                       //loc_511d:
    _dx = _pop();                               //pop dx
    _bx = _pop();                               //pop bx
...
void sub_5133()  // bouncing
{
    _push(_bx);                                 //push bx
    _push(_bp);                                 //push bp
    _bp = _sp;                                  //mov bp, sp
    _bx = memory16(_ss, _bp + 2 -2 + 0x4);
...
loc_5149:                                       //loc_5149: TODO PARSER EXCEPTION!!!
    _flags.zero = !(memory(_ds, _bx + 0x6f19) & 2);    // -- bouncing
...
void sub_53a2()
{
    ...
    _push(_ds);                                 //push ds
    _push(_es);                                 //push es
    sub_097b();                                 //call sub_097b -- load image
    _es = _pop();                               //pop es
    _ds = _pop();                               //pop ds
    memory16(_ds, 0x04c1) = _ax;                //mov [0x4c1], ax
    memory16(_ds, 0x526c) = _ax;                //mov [0x526c], ax
...
void sub_5737() // hit test, obj update?
{
    _si = 0x7699;                               //mov si, 0x7699
...
loc_5825:                                       //loc_5825:
    ...
    memory16(_ds, _si + 4) = 0xffff;            //mov word ptr [si+0x4], 0xffff
    sub_58b0();                                 //call sub_58b0 -- explosion
loc_584e:                                       //loc_584e:
...
loc_5888:                                       //loc_5888:
    _bp = _sp;                                  //mov bp, sp
    _si = memory16(_ss, _bp + 0);               //mov si, word ptr [bp+0x0]
    memory(_ds, _si + 7) |= 0x80;               // 020d:5888  - set dead flying (1)
loc_5891:                                       //loc_5891:
    _si = _pop();                               //pop si
    _cx = _pop();                               //pop cx
    _bp = 0xffff;                               //mov bp, 0xffff
...
void sub_58b0()
{
    memory16(_ds, 21138) = 0x002d;              //-- sprite index
...
{
    /*
    std::cout << "update sprite ptrs [";
    for (int i=0; i<0x32; i++)
    {
        if (memory16(_ds, 0x7699 + i*0x1a + 4) != 0xffff)
        {
            int b = (memory16(_ds, 0x7699 + i*0x1a + 6) & 0x1f) << 1;
            b = memory16(_ds, b + 36533);
            std::cout << b << ", ";
        }
    }
    std::cout << "]\n";
...
loc_5953:                                       //loc_5953:
     ...
     */
    _indirectCall(memory16(_ds, _bx + 36533));  // -- call to finish !!! 5a58 todo not called!
loc_5965:                                       //loc_5965:
    _si += 0x001a;                              //add si, 0x1a
...
{
    memory(_ds, 25862) = 0x32;                  //mov byte ptr [0x6506], 0x32
    memory(_ds, 1049) += 1;                     //inc byte ptr [0x419]
    if (memory(_ds, 1049) <= 0x10)              //jbe loc_59ba
        goto loc_59ba;
    memory(_ds, 1049) = 0x10;                   //mov byte ptr [0x419], 0x10
    memory(_ds, 1050) += 1;                     //inc byte ptr [0x41a]
loc_59ba:                                       //loc_59ba:
    return;
}
...
void sub_59bb()
{
    if (memory(_ds, 1051) == 0x09)              //jz loc_59c6
        goto loc_59c6;
    memory(_ds, 1051) += 1;                     //inc byte ptr [0x41b]
loc_59c6:                                       //loc_59c6:
...
void loc_5a58()                                       //loc_5a58:
{
    // 020d:5a58 check [bx-414b] @ 020d:5961
    /*
     si    bx    pc
     76cd  0     63bf
     76e7  0     63bf
    ...
    if (_al & 0x40)                             //jnz loc_5a98
        goto loc_5a98;
    memory(_ds, _si + 7) |= 0x40;               // -- kill finished - todo not called
    _bx = memory16(_ds, _si + 4);               //mov bx, word ptr [si+0x4]
    _bh &= 0x1f;                                //and bh, 0x1f
...
{
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz loc_5ac1
        goto loc_5ac1;
    loc_5a58();                    //jmp loc_5a58
    return;
loc_5ac1:                                       //loc_5ac1:
    _ax = memory16(_ds, _si + 20);              //mov ax, word ptr [si+0x14]
    _dx = memory16(_ds, _si + 15);              //mov dx, word ptr [si+0xf]
    _ax -= _dx;                                 //sub ax, dx
    if ((short)memory16(_ds, 21116) < (short)_ax)//jl loc_5b21
        goto loc_5b21;
    _ax += _dx;                                 //add ax, dx
    _ax += _dx;                                 //add ax, dx
    if ((short)memory16(_ds, 21116) > (short)_ax)//jg loc_5b21
        goto loc_5b21;
    _ax = memory16(_ds, _si + 22);              //mov ax, word ptr [si+0x16]
    _dx = memory16(_ds, _si + 17);              //mov dx, word ptr [si+0x11]
    _ax -= _dx;                                 //sub ax, dx
    if ((short)memory16(_ds, 21118) < (short)_ax)//jl loc_5b21
        goto loc_5b21;
    _ax += _dx;                                 //add ax, dx
    _ax += _dx;                                 //add ax, dx
    if ((short)memory16(_ds, 21118) > (short)_ax)//jg loc_5b21
        goto loc_5b21;
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    _flags.sign = !!(_ax & 0x8000);             //or ax, ax
    _ax |= _ax;
    if (!_flags.sign)                           //jns loc_5afa
        goto loc_5afa;
    _ax = -_ax;                                 //neg ax
loc_5afa:                                       //loc_5afa:
    _dx = memory16(_ds, _si);                   //mov dx, word ptr [si]
    if (memory16(_ds, 21116) == _dx)            //jz loc_5b0b
        goto loc_5b0b;
    if ((short)memory16(_ds, 21116) < (short)_dx)//jl loc_5b06
        goto loc_5b06;
    _ax = -_ax;                                 //neg ax
loc_5b06:                                       //loc_5b06:
    ...
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
loc_5b0b:                                       //loc_5b0b:
    _al = memory(_ds, _si + 19);                //mov al, byte ptr [si+0x13]
    _dx = memory16(_ds, _si + 2);               //mov dx, word ptr [si+0x2]
    if (memory16(_ds, 21118) == _dx)            //jz loc_5b1f
        goto loc_5b1f;
    if ((short)memory16(_ds, 21118) < (short)_dx)//jl loc_5b1b
        goto loc_5b1b;
    _al = -_al;                                 //neg al
loc_5b1b:                                       //loc_5b1b:
    _cbw();                                     //cbw
    memory16(_ds, _si + 2) -= _ax;              //sub word ptr [si+0x2], ax
loc_5b1f:                                       //loc_5b1f:
    goto loc_5b4d;                              //jmp loc_5b4d
loc_5b21:                                       //loc_5b21:
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    _flags.sign = !!(_ax & 0x8000);             //or ax, ax
    _ax |= _ax;
    if (!_flags.sign)                           //jns loc_5b2a
        goto loc_5b2a;
    _ax = -_ax;                                 //neg ax
loc_5b2a:                                       //loc_5b2a:
    _dx = memory16(_ds, _si);                   //mov dx, word ptr [si]
    if (memory16(_ds, _si + 20) == _dx)         //jz loc_5b3a
        goto loc_5b3a;
    if ((short)memory16(_ds, _si + 20) < (short)_dx)//jl loc_5b35
        goto loc_5b35;
    _ax = -_ax;                                 //neg ax
loc_5b35:                                       //loc_5b35:
    memory16(_ds, _si + 8) = _ax;               //mov word ptr [si+0x8], ax
...
loc_5b3a:                                       //loc_5b3a:
    _al = memory(_ds, _si + 19);                //mov al, byte ptr [si+0x13]
    _dx = memory16(_ds, _si + 2);               //mov dx, word ptr [si+0x2]
    if (memory16(_ds, _si + 22) == _dx)         //jz loc_5b4d
        goto loc_5b4d;
    if ((short)memory16(_ds, _si + 22) < (short)_dx)//jl loc_5b49
        goto loc_5b49;
    _al = -_al;                                 //neg al
loc_5b49:                                       //loc_5b49:
    _cbw();                                     //cbw
...
void sub_5b4e()
{
    memory(_ds, _si + 7) &= 0x3f;               //and byte ptr [si+0x7], 0x3f
    _ax = memory16(_ds, _si + 19);              //mov ax, word ptr [si+0x13]
    _ax += 1;                                   //inc ax
    if (memory16(_ds, _si + 17) > _ax)          //ja loc_5bb7
        goto loc_5bb7;
    _ax = memory16(_ds, _si);                   //mov ax, word ptr [si]
    _ax = _ax - memory16(_ds, 21116);           //sub ax, word ptr [0x527c]
    if ((short)_ax >= 0)                        //jns loc_5b65
        goto loc_5b65;
    _ax = -_ax;                                 //neg ax
loc_5b65:                                       //loc_5b65:
    if (memory16(_ds, _si + 15) < _ax)          //jc loc_5bb5
        goto loc_5bb5;
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    _ax = _ax - memory16(_ds, _si + 2);         //sub ax, word ptr [si+0x2]
    if ((short)memory16(_ds, _si + 21) < (short)_ax)//jl loc_5bba
        goto loc_5bba;
    _di = 0x528e;                               //mov di, 0x528e
    _ax = 0xffff;                               //mov ax, 0xffff
loc_5b7b:                                       //loc_5b7b:
    _di += 0x0012;                              //add di, 0x12
    if (memory16(_ds, _di + 4) != _ax)          //jnz loc_5b7b
        goto loc_5b7b;
    if (_di >= 0x5570)                          //jnc loc_5bb5
        goto loc_5bb5;
    ...
    _ax = memory16(_ds, _si + 2);               //mov ax, word ptr [si+0x2]
    memory16(_ds, _di + 2) = _ax;               //mov word ptr [di+0x2], ax
    memory(_ds, _di + 11) = 0x03;               //mov byte ptr [di+0xb], 0x3
...
loc_5bb5:                                       //loc_5bb5:
    _ax = _ax ^ _ax;                            //xor ax, ax
loc_5bb7:                                       //loc_5bb7:
    memory16(_ds, _si + 19) = _ax;              //mov word ptr [si+0x13], ax
loc_5bba:                                       //loc_5bba:
    return;
}
...
{
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz loc_5bc5
        goto loc_5bc5;
    loc_5a58();                    //jmp loc_5a58
    return;
loc_5bc5:                                       //loc_5bc5:
    _al = memory(_ds, _si + 14);                //mov al, byte ptr [si+0xe]
    if (_al != 0x00)                            //jnz loc_5c07
        goto loc_5c07;
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    _flags.sign = !!(_ax & 0x8000);             //or ax, ax
    _ax |= _ax;
    if (!_flags.sign)                           //jns loc_5bd5
        goto loc_5bd5;
    _ax = -_ax;                                 //neg ax
loc_5bd5:                                       //loc_5bd5:
    _dx = memory16(_ds, 21116);                 //mov dx, word ptr [0x527c]
    _dx = _dx - memory16(_ds, _si);             //sub dx, word ptr [si]
    if ((short)_dx >= 0)                        //jns loc_5be1
        goto loc_5be1;
    _ax = -_ax;                                 //neg ax
    _dx = -_dx;                                 //neg dx
loc_5be1:                                       //loc_5be1:
    _ax = -_ax;                                 //neg ax
    memory16(_ds, _si + 8) = _ax;               //mov word ptr [si+0x8], ax
    if (memory16(_ds, _si + 23) < _dx)          //jc loc_5c5f
        goto loc_5c5f;
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    _ax = _ax - memory16(_ds, _si + 2);         //sub ax, word ptr [si+0x2]
    if ((short)_ax >= 0)                        //jns loc_5bf5
        goto loc_5bf5;
    _ax = -_ax;                                 //neg ax
loc_5bf5:                                       //loc_5bf5:
    if (_ax > 0x0028)                           //ja loc_5c5f
        goto loc_5c5f;
    sub_64df();                                 //call sub_64df
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    memory16(_ds, _si + 21) = 0x000a;           //mov word ptr [si+0x15], 0xa
    goto loc_5c5f;                              //jmp loc_5c5f
loc_5c07:                                       //loc_5c07:
    if (_al != 0x01)                            //jnz loc_5c23
        goto loc_5c23;
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    _ax = memory16(_ds, _si + 21);              //mov ax, word ptr [si+0x15]
    memory16(_ds, _si + 2) -= _ax;              //sub word ptr [si+0x2], ax
    memory16(_ds, _si + 21) -= 1;               //dec word ptr [si+0x15]
    if (memory16(_ds, _si + 21) != 0)           //jnz loc_5c5f
        goto loc_5c5f;
    sub_64df();                                 //call sub_64df
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    goto loc_5c5f;                              //jmp loc_5c5f
loc_5c23:                                       //loc_5c23:
    if (_al != 0x02)                            //jnz loc_5c49
        goto loc_5c49;
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    _ax = memory16(_ds, _si + 21);              //mov ax, word ptr [si+0x15]
    memory16(_ds, _si + 2) += _ax;              //add word ptr [si+0x2], ax
    memory16(_ds, _si + 21) += 1;               //inc word ptr [si+0x15]
    if (memory16(_ds, _si + 21) <= 0x000a)      //jbe loc_5c5f
        goto loc_5c5f;
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    sub_64df();                                 //call sub_64df
    _al = memory(_ds, _si + 20);                //mov al, byte ptr [si+0x14]
    memory(_ds, _si + 21) = _al;                //mov byte ptr [si+0x15], al
    goto loc_5c5f;                              //jmp loc_5c5f
loc_5c49:                                       //loc_5c49:
    if (_al != 0x03)                            //jnz loc_5c5f
        goto loc_5c5f;
    memory(_ds, _si + 21) -= 1;                 //dec byte ptr [si+0x15]
    if (memory(_ds, _si + 21) != 0)             //jnz loc_5c5f
        goto loc_5c5f;
    sub_64ef();                                 //call sub_64ef
    sub_64ef();                                 //call sub_64ef
    sub_64ef();                                 //call sub_64ef
...
void sub_5c60()
{
    memory(_ds, _si + 7) &= 0x3f;               //and byte ptr [si+0x7], 0x3f
    _al = memory(_ds, _si + 14);                //mov al, byte ptr [si+0xe]
    if (_al != 0x00)                            //jnz loc_5c80
        goto loc_5c80;
    sub_64df();                                 //call sub_64df
    _ax = memory16(_ds, _si + 15);              //mov ax, word ptr [si+0xf]
    memory16(_ds, _si + 17) = _ax;              //mov word ptr [si+0x11], ax
    _ax = memory16(_ds, _si + 2);               //mov ax, word ptr [si+0x2]
    memory16(_ds, _si + 20) = _ax;              //mov word ptr [si+0x14], ax
    memory(_ds, _si + 14) = 0x01;               //mov byte ptr [si+0xe], 0x1
    goto loc_5cc9;                              //jmp loc_5cc9
loc_5c80:                                       //loc_5c80:
    if (_al != 0x01)                            //jnz loc_5c95
        goto loc_5c95;
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    memory16(_ds, _si + 2) -= _ax;              //sub word ptr [si+0x2], ax
    memory16(_ds, _si + 17) -= 1;               //dec word ptr [si+0x11]
    if (memory16(_ds, _si + 17) != 0)           //jnz loc_5cc9
        goto loc_5cc9;
    memory(_ds, _si + 14) = 0x02;               //mov byte ptr [si+0xe], 0x2
    goto loc_5cc9;                              //jmp loc_5cc9
loc_5c95:                                       //loc_5c95:
    if (_al != 0x02)                            //jnz loc_5cbc
        goto loc_5cbc;
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    memory16(_ds, _si + 2) += _ax;              //add word ptr [si+0x2], ax
    memory16(_ds, _si + 17) += 1;               //inc word ptr [si+0x11]
    _ax = memory16(_ds, _si + 20);              //mov ax, word ptr [si+0x14]
    if ((short)memory16(_ds, _si + 2) < (short)_ax)//jl loc_5cc9
        goto loc_5cc9;
    memory16(_ds, _si + 2) = _ax;               //mov word ptr [si+0x2], ax
    _al = memory(_ds, _si + 19);                //mov al, byte ptr [si+0x13]
    memory(_ds, _si + 17) = _al;                //mov byte ptr [si+0x11], al
    memory(_ds, _si + 14) = 0x03;               //mov byte ptr [si+0xe], 0x3
    sub_64ef();                                 //call sub_64ef
    goto loc_5cc9;                              //jmp loc_5cc9
loc_5cbc:                                       //loc_5cbc:
    if (_al != 0x03)                            //jnz loc_5cc9
        goto loc_5cc9;
    memory(_ds, _si + 17) -= 1;                 //dec byte ptr [si+0x11]
    if (memory(_ds, _si + 17) != 0)             //jnz loc_5cc9
        goto loc_5cc9;
    memory(_ds, _si + 14) = 0x00;               //mov byte ptr [si+0xe], 0x0
loc_5cc9:                                       //loc_5cc9:
    return;
...
{
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz loc_5cd4
        goto loc_5cd4;
    loc_5a58();                    //jmp loc_5a58
    return;
loc_5cd4:                                       //loc_5cd4:
    _al = memory(_ds, _si + 14);                //mov al, byte ptr [si+0xe]
    if (_al != 0x00)                            //jnz loc_5d09
        goto loc_5d09;
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _si);             //sub ax, word ptr [si]
    if ((short)_ax >= 0)                        //jns loc_5ce4
        goto loc_5ce4;
    _ax = -_ax;                                 //neg ax
loc_5ce4:                                       //loc_5ce4:
    if (memory16(_ds, _si + 23) < _ax)          //jc loc_5d01
        goto loc_5d01;
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    _ax = _ax - memory16(_ds, _si + 2);         //sub ax, word ptr [si+0x2]
    if ((short)_ax >= 0)                        //jns loc_5cf3
        goto loc_5cf3;
    _ax = -_ax;                                 //neg ax
loc_5cf3:                                       //loc_5cf3:
    if (_ax > 0x001a)                           //ja loc_5d01
        goto loc_5d01;
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    sub_64df();                                 //call sub_64df
...
loc_5d01:                                       //loc_5d01:
    ...
    _STOP_("db c3h");                           //db c3h
loc_5d09:                                       //loc_5d09:
    if (_al != 0x01)                            //jnz loc_5d7a
        goto loc_5d7a;
    sub_6567();                                 //call sub_6567
    _al |= _al;                                 //or al, al
    if (_al != 0)                               //jnz loc_5d17
        goto loc_5d17;
    sub_5eca();                                 //call sub_5eca
loc_5d17:                                       //loc_5d17:
    memory(_ds, _si + 2) &= 0xf0;               //and byte ptr [si+0x2], 0xf0
    _al = memory(_es, _di + 65280);             //mov al, byte ptr es:[di+0xff00]
    _bx = 0x72a3;                               //mov bx, 0x72a3
    _xlat_ds();                                 //xlat ds
    _al &= 0x01;                                //and al, 0x1
    if (_al == 0)                               //jz loc_5d2b
        goto loc_5d2b;
    memory16(_ds, _si + 8) = -memory16(_ds, _si + 8);//neg word ptr [si+0x8]
loc_5d2b:                                       //loc_5d2b:
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    if ((short)memory16(_ds, _si) >= 0)         //jns loc_5d39
        goto loc_5d39;
    _ax = -_ax;                                 //neg ax
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    memory16(_ds, _si + 8) = _ax;               //mov word ptr [si+0x8], ax
loc_5d39:                                       //loc_5d39:
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _si);             //sub ax, word ptr [si]
    if ((short)_ax >= 0)                        //jns loc_5d42
        goto loc_5d42;
    _ax = -_ax;                                 //neg ax
loc_5d42:                                       //loc_5d42:
    if (_ax < 0x0280)                           //jc loc_5d4c
        goto loc_5d4c;
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    goto loc_5d01;                              //jmp loc_5d01
loc_5d4c:                                       //loc_5d4c:
    _flags.carry = memory(_ds, _si + 20) < 0x01;//sub byte ptr [si+0x14], 0x1
    memory(_ds, _si + 20) -= 0x01;
    memory(_ds, _si + 20) = memory(_ds, _si + 20) + 0x00 + _flags.carry;
    if (_FIXME_)                                //jnz loc_5dcd
        goto loc_5dcd;
    if (_ax > 0x0040)                           //ja loc_5dcd
        goto loc_5dcd;
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    _ax = _ax - memory16(_ds, _si + 2);         //sub ax, word ptr [si+0x2]
    if ((short)_ax >= 0)                        //jns loc_5d65
        goto loc_5d65;
    _ax = -_ax;                                 //neg ax
loc_5d65:                                       //loc_5d65:
    if (_ax > 0x0014)                           //ja loc_5dcd
        goto loc_5dcd;
    sub_621c();                                 //call sub_621c
    memory(_ds, _si + 14) = 0x03;               //mov byte ptr [si+0xe], 0x3
    sub_64df();                                 //call sub_64df
    memory(_ds, _si + 20) = 0x14;               //mov byte ptr [si+0x14], 0x14
    goto loc_5dcd;                              //jmp loc_5dcd
loc_5d7a:                                       //loc_5d7a:
    if (_al != 0x02)                            //jnz loc_5db0
        goto loc_5db0;
    _cl = 0x04;                                 //mov cl, 0x4
    _ax = memory16(_ds, _si + 15);              //mov ax, word ptr [si+0xf]
    _sar(_ax, _cl);                             //sar ax, cl
    _ax = _ax - memory16(_ds, 21104);           //sub ax, word ptr [0x5270]
    if (_ax >= 0x0015)                          //jnc loc_5d9c
        goto loc_5d9c;
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    _sar(_ax, _cl);                             //sar ax, cl
    _ax = _ax - memory16(_ds, 21106);           //sub ax, word ptr [0x5272]
    if (_ax <= 0x000d)                          //jbe loc_5dcd
        goto loc_5dcd;
loc_5d9c:                                       //loc_5d9c:
    _ax = memory16(_ds, _si + 15);              //mov ax, word ptr [si+0xf]
    memory16(_ds, _si) = _ax;                   //mov word ptr [si], ax
    ...
    goto loc_5dcd;                              //jmp loc_5dcd
loc_5db0:                                       //loc_5db0:
    if (_al != 0x03)                            //jnz loc_5dcd
        goto loc_5dcd;
    if (!(memory(_ds, _si + 7) & 0x20))         //jz loc_5dcd
        goto loc_5dcd;
    sub_592d();                                 //call sub_592d
    if (_flags.carry)                           //jc loc_5dc6
        goto loc_5dc6;
...
{
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz loc_5efc
        goto loc_5efc;
    loc_5a58();                    //jmp loc_5a58
    return;
loc_5efc:                                       //loc_5efc:
    _al = memory(_ds, _si + 14);                //mov al, byte ptr [si+0xe]
    if (_al != 0x00)                            //jnz loc_5f2a
        goto loc_5f2a;
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _si);             //sub ax, word ptr [si]
    if ((short)_ax >= 0)                        //jns loc_5f0c
        goto loc_5f0c;
    _ax = -_ax;                                 //neg ax
loc_5f0c:                                       //loc_5f0c:
    if (memory16(_ds, _si + 23) < _ax)          //jc loc_5f29
        goto loc_5f29;
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    _ax = _ax - memory16(_ds, _si + 2);         //sub ax, word ptr [si+0x2]
    if ((short)_ax >= 0)                        //jns loc_5f1b
        goto loc_5f1b;
    _ax = -_ax;                                 //neg ax
loc_5f1b:                                       //loc_5f1b:
    if (_ax > 0x003c)                           //ja loc_5f29
        goto loc_5f29;
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    sub_64df();                                 //call sub_64df
    sub_621c();                                 //call sub_621c
loc_5f29:                                       //loc_5f29:
    return;                                     //ret
loc_5f2a:                                       //loc_5f2a:
    if (_al != 0x01)                            //jnz loc_5f98
        goto loc_5f98;
    memory(_ds, 25856) += 1;                    //inc byte ptr [0x6500]
    if (memory(_ds, 25856) & 0x04)              //jnz loc_5f44
        goto loc_5f44;
    if (memory16(_ds, 25854) & 0x01ff)          //jnz loc_5f44
        goto loc_5f44;
    sub_64df();                                 //call sub_64df
loc_5f44:                                       //loc_5f44:
    if (memory(_ds, 25854) & 0x7f)              //jnz loc_5f55
        goto loc_5f55;
    _al = 0x03;                                 //mov al, 0x3
    memory(_ds, _si + 14) = _al;                //mov byte ptr [si+0xe], al
    sub_64df();                                 //call sub_64df
    goto loc_5f98;                              //jmp loc_5f98
loc_5f55:                                       //loc_5f55:
    sub_6567();                                 //call sub_6567
    _al |= _al;                                 //or al, al
    if (_al != 0)                               //jnz loc_5f5f
        goto loc_5f5f;
    sub_5eca();                                 //call sub_5eca
loc_5f5f:                                       //loc_5f5f:
    memory(_ds, _si + 2) &= 0xf0;               //and byte ptr [si+0x2], 0xf0
    ...
    _xlat_ds();                                 //xlat ds
    _al &= 0x01;                                //and al, 0x1
    if (_al == 0)                               //jz loc_5f76
        goto loc_5f76;
    memory16(_ds, _si + 8) = -memory16(_ds, _si + 8);//neg word ptr [si+0x8]
loc_5f76:                                       //loc_5f76:
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    if ((short)memory16(_ds, _si) >= 0)         //jns loc_5f84
        goto loc_5f84;
    _ax = -_ax;                                 //neg ax
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    memory16(_ds, _si + 8) = _ax;               //mov word ptr [si+0x8], ax
loc_5f84:                                       //loc_5f84:
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _si);             //sub ax, word ptr [si]
    if ((short)_ax >= 0)                        //jns loc_5f8d
        goto loc_5f8d;
    _ax = -_ax;                                 //neg ax
loc_5f8d:                                       //loc_5f8d:
    if (_ax < 0x0500)                           //jc loc_5f29
        goto loc_5f29;
    memory(_ds, _si + 14) = 0x02;               //mov byte ptr [si+0xe], 0x2
    goto loc_5ff8;                              //jmp loc_5ff8
loc_5f98:                                       //loc_5f98:
    if (_al != 0x02)                            //jnz loc_5fce
        goto loc_5fce;
    _cl = 0x04;                                 //mov cl, 0x4
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    _ax >>= _cl;                                //shr ax, cl
    _ax = _ax - memory16(_ds, 21106);           //sub ax, word ptr [0x5272]
    if (_ax > 0x000c)                           //ja loc_5fba
        goto loc_5fba;
    _ax = memory16(_ds, _si + 15);              //mov ax, word ptr [si+0xf]
    _ax >>= _cl;                                //shr ax, cl
    _ax = _ax - memory16(_ds, 21104);           //sub ax, word ptr [0x5270]
    if (_ax < 0x0019)                           //jc loc_5ff8
        goto loc_5ff8;
loc_5fba:                                       //loc_5fba:
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    memory16(_ds, _si + 2) = _ax;               //mov word ptr [si+0x2], ax
    ...
    goto loc_5ff8;                              //jmp loc_5ff8
loc_5fce:                                       //loc_5fce:
    if (_al != 0x03)                            //jnz loc_5ff8
        goto loc_5ff8;
    if (memory(_ds, _si + 5) & 0x20)            //jnz loc_5feb
        goto loc_5feb;
    sub_64df();                                 //call sub_64df
    memory16(_ds, _si + 10) -= 0x0002;          //sub word ptr [si+0xa], 0x2
    sub_64ff();                                 //call sub_64ff
    sub_621c();                                 //call sub_621c
    memory(_ds, _si + 14) = 0x01;               //mov byte ptr [si+0xe], 0x1
    goto loc_5ff8;                              //jmp loc_5ff8
loc_5feb:                                       //loc_5feb:
    if (!(memory(_ds, _si + 7) & 0x20))         //jz loc_5ff8
        goto loc_5ff8;
    sub_621c();                                 //call sub_621c
    memory(_ds, _si + 14) = 0x01;               //mov byte ptr [si+0xe], 0x1
loc_5ff8:                                       //loc_5ff8:
...
loc_6008:                                       //loc_6008:
    return;                                     //ret
    memory(_ds, _si + 7) &= 0x3f;               //and byte ptr [si+0x7], 0x3f
    goto loc_6019;                              //jmp loc_6019
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz loc_6019
        goto loc_6019;
    loc_5a58();                    //jmp loc_5a58
    return;
loc_6019:                                       //loc_6019:
    _al = memory(_ds, _si + 14);                //mov al, byte ptr [si+0xe]
    if (_al != 0x00)                            //jnz loc_604a
        goto loc_604a;
    _ax = memory16(_ds, _si);                   //mov ax, word ptr [si]
    _ax = _ax - memory16(_ds, 21116);           //sub ax, word ptr [0x527c]
    if ((short)_ax >= 0)                        //jns loc_602a
        goto loc_602a;
    _ax = -_ax;                                 //neg ax
loc_602a:                                       //loc_602a:
    if (_ax > 0x0154)                           //ja loc_603f
        goto loc_603f;
    _ax = memory16(_ds, _si + 2);               //mov ax, word ptr [si+0x2]
    _ax = _ax - memory16(_ds, 21118);           //sub ax, word ptr [0x527e]
    if ((short)_ax >= 0)                        //jns loc_603a
        goto loc_603a;
    _ax = -_ax;                                 //neg ax
loc_603a:                                       //loc_603a:
    if (_ax < 0x00e6)                           //jc loc_6064
        goto loc_6064;
loc_603f:                                       //loc_603f:
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    sub_64df();                                 //call sub_64df
    sub_621c();                                 //call sub_621c
    goto loc_6064;                              //jmp loc_6064
loc_604a:                                       //loc_604a:
    if (_al != 0x01)                            //jnz loc_60ab
        goto loc_60ab;
    sub_6567();                                 //call sub_6567
    _al |= _al;                                 //or al, al
    if (_al != 0)                               //jnz loc_6065
        goto loc_6065;
    if (memory16(_ds, _si + 21) >= 0x0010)      //jnc loc_605e
        goto loc_605e;
    memory16(_ds, _si + 21) += 1;               //inc word ptr [si+0x15]
loc_605e:                                       //loc_605e:
    _ax = memory16(_ds, _si + 21);              //mov ax, word ptr [si+0x15]
...
loc_6064:                                       //loc_6064:
    return;                                     //ret
loc_6065:                                       //loc_6065:
    if (memory16(_ds, _si + 21) == 0x0000)      //jz loc_606e
        goto loc_606e;
    sub_621c();                                 //call sub_621c
loc_606e:                                       //loc_606e:
    memory16(_ds, _si + 21) = 0x0000;           //mov word ptr [si+0x15], 0x0
    memory(_ds, _si + 2) &= 0xf0;               //and byte ptr [si+0x2], 0xf0
    sub_5ee4();                                 //call sub_5ee4
    _al = memory(_es, _di + 65280);             //mov al, byte ptr es:[di+0xff00]
    _bx = 0x72a3;                               //mov bx, 0x72a3
    _xlat_ds();                                 //xlat ds
    _al &= 0x01;                                //and al, 0x1
    if (_al == 0)                               //jz loc_608a
        goto loc_608a;
    memory16(_ds, _si + 8) = -memory16(_ds, _si + 8);//neg word ptr [si+0x8]
loc_608a:                                       //loc_608a:
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    if ((short)memory16(_ds, _si) >= 0)         //jns loc_6098
        goto loc_6098;
    _ax = -_ax;                                 //neg ax
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    memory16(_ds, _si + 8) = _ax;               //mov word ptr [si+0x8], ax
loc_6098:                                       //loc_6098:
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _si);             //sub ax, word ptr [si]
    if ((short)_ax >= 0)                        //jns loc_60a1
        goto loc_60a1;
    _ax = -_ax;                                 //neg ax
loc_60a1:                                       //loc_60a1:
    if (_ax < 0x0280)                           //jc loc_60df
        goto loc_60df;
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    goto loc_60df;                              //jmp loc_60df
loc_60ab:                                       //loc_60ab:
    if (_al != 0x02)                            //jnz loc_60df
        goto loc_60df;
    _cl = 0x04;                                 //mov cl, 0x4
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    _ax >>= _cl;                                //shr ax, cl
    _ax = _ax - memory16(_ds, 21106);           //sub ax, word ptr [0x5272]
    if (_ax > 0x000c)                           //ja loc_60cd
        goto loc_60cd;
    _ax = memory16(_ds, _si + 15);              //mov ax, word ptr [si+0xf]
    _ax >>= _cl;                                //shr ax, cl
    _ax = _ax - memory16(_ds, 21104);           //sub ax, word ptr [0x5270]
    if (_ax < 0x0013)                           //jc loc_60df
        goto loc_60df;
loc_60cd:                                       //loc_60cd:
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    memory16(_ds, _si + 2) = _ax;               //mov word ptr [si+0x2], ax
...
{
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz loc_60ea
        goto loc_60ea;
    loc_5a58();                    //jmp loc_5a58
    return;
loc_60ea:                                       //loc_60ea:
    _al = memory(_ds, _si + 14);                //mov al, byte ptr [si+0xe]
    if (_al != 0x00)                            //jnz loc_6123
        goto loc_6123;
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    if ((short)memory16(_ds, _si + 2) > (short)_ax)//jg loc_6140
        goto loc_6140;
    _ax = memory16(_ds, _si);                   //mov ax, word ptr [si]
    _ax = _ax - memory16(_ds, 21116);           //sub ax, word ptr [0x527c]
    if ((short)_ax >= 0)                        //jns loc_6103
        goto loc_6103;
    _ax = -_ax;                                 //neg ax
loc_6103:                                       //loc_6103:
    if (memory16(_ds, _si + 23) < _ax)          //jc loc_6140
        goto loc_6140;
    _ax = memory16(_ds, _si + 2);               //mov ax, word ptr [si+0x2]
    _ax = _ax - memory16(_ds, 21118);           //sub ax, word ptr [0x527e]
    if ((short)_ax >= 0)                        //jns loc_6113
        goto loc_6113;
    _ax = -_ax;                                 //neg ax
loc_6113:                                       //loc_6113:
    if (_ax > 0x00c8)                           //ja loc_6140
        goto loc_6140;
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    sub_64df();                                 //call sub_64df
    sub_621c();                                 //call sub_621c
    goto loc_6140;                              //jmp loc_6140
loc_6123:                                       //loc_6123:
    if (_al == 0x01)                            //jz loc_612a
        goto loc_612a;
    goto loc_61d4;                              //jmp loc_61d4
loc_612a:                                       //loc_612a:
    sub_6567();                                 //call sub_6567
    _al |= _al;                                 //or al, al
    if (_al != 0)                               //jnz loc_6141
        goto loc_6141;
    if (memory16(_ds, _si + 21) >= 0x0010)      //jnc loc_613a
        goto loc_613a;
    memory16(_ds, _si + 21) += 1;               //inc word ptr [si+0x15]
loc_613a:                                       //loc_613a:
    _ax = memory16(_ds, _si + 21);              //mov ax, word ptr [si+0x15]
...
loc_6140:                                       //loc_6140:
    return;                                     //ret
loc_6141:                                       //loc_6141:
    if (memory16(_ds, _si + 21) == 0x0000)      //jz loc_614a
        goto loc_614a;
    sub_621c();                                 //call sub_621c
loc_614a:                                       //loc_614a:
    memory16(_ds, _si + 21) = 0x0000;           //mov word ptr [si+0x15], 0x0
    ...
    _xlat_ds();                                 //xlat ds
    _al &= 0x01;                                //and al, 0x1
    if (_al == 0)                               //jz loc_6166
        goto loc_6166;
    memory16(_ds, _si + 8) = -memory16(_ds, _si + 8);//neg word ptr [si+0x8]
loc_6166:                                       //loc_6166:
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    if ((short)memory16(_ds, _si) >= 0)         //jns loc_6174
        goto loc_6174;
    _ax = -_ax;                                 //neg ax
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
    memory16(_ds, _si + 8) = _ax;               //mov word ptr [si+0x8], ax
loc_6174:                                       //loc_6174:
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _si);             //sub ax, word ptr [si]
    if ((short)_ax >= 0)                        //jns loc_617d
        goto loc_617d;
    _ax = -_ax;                                 //neg ax
loc_617d:                                       //loc_617d:
    if (_ax > 0x0280)                           //ja loc_6191
        goto loc_6191;
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    _ax = _ax - memory16(_ds, _si + 2);         //sub ax, word ptr [si+0x2]
    if ((short)_ax >= 0)                        //jns loc_618c
        goto loc_618c;
    _ax = -_ax;                                 //neg ax
loc_618c:                                       //loc_618c:
    if (_ax < 0x0190)                           //jc loc_6198
        goto loc_6198;
loc_6191:                                       //loc_6191:
    memory(_ds, _si + 14) = 0x02;               //mov byte ptr [si+0xe], 0x2
    goto loc_621b;                              //jmp loc_621b
loc_6198:                                       //loc_6198:
    if (memory(_ds, _si + 14) != 0x01)          //jnz loc_621b
        goto loc_621b;
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _si);             //sub ax, word ptr [si]
    if ((short)_ax >= 0)                        //jns loc_61a7
        goto loc_61a7;
    _ax = -_ax;                                 //neg ax
loc_61a7:                                       //loc_61a7:
    _bx = memory16(_ds, _si + 4);               //mov bx, word ptr [si+0x4]
    _bh &= 0x1f;                                //and bh, 0x1f
    _bx <<= 1;                                  //shl bx, 1
    _dl = memory(_ds, _bx + 26213);             //mov dl, byte ptr [bx+0x6665]
    _dh = _dh ^ _dh;                            //xor dh, dh
    _dx += 0x0006;                              //add dx, 0x6
    if (_ax > _dx)                              //ja loc_621b
        goto loc_621b;
    _ax = memory16(_ds, 0x527e);                //mov ax, [0x527e]
    _ax = _ax - memory16(_ds, _si + 2);         //sub ax, word ptr [si+0x2]
    if ((short)_ax >= 0)                        //jns loc_61c6
        goto loc_61c6;
    _ax = -_ax;                                 //neg ax
loc_61c6:                                       //loc_61c6:
    if (_ax > 0x0008)                           //ja loc_621b
        goto loc_621b;
    memory(_ds, _si + 14) = 0x03;               //mov byte ptr [si+0xe], 0x3
    sub_64df();                                 //call sub_64df
    goto loc_621b;                              //jmp loc_621b
loc_61d4:                                       //loc_61d4:
    if (_al != 0x02)                            //jnz loc_620a
        goto loc_620a;
    _cl = 0x04;                                 //mov cl, 0x4
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    _ax >>= _cl;                                //shr ax, cl
    _ax = _ax - memory16(_ds, 21106);           //sub ax, word ptr [0x5272]
    if (_ax > 0x000d)                           //ja loc_61f6
        goto loc_61f6;
    _ax = memory16(_ds, _si + 15);              //mov ax, word ptr [si+0xf]
    _ax >>= _cl;                                //shr ax, cl
    _ax = _ax - memory16(_ds, 21104);           //sub ax, word ptr [0x5270]
    if (_ax < 0x0015)                           //jc loc_621b
        goto loc_621b;
loc_61f6:                                       //loc_61f6:
    _ax = memory16(_ds, _si + 17);              //mov ax, word ptr [si+0x11]
    memory16(_ds, _si + 2) = _ax;               //mov word ptr [si+0x2], ax
    ...
    goto loc_621b;                              //jmp loc_621b
loc_620a:                                       //loc_620a:
    if (_al != 0x03)                            //jnz loc_621b
        goto loc_621b;
    if (memory(_ds, _si + 7) & 0x20)            //jnz loc_6217
        goto loc_6217;
    goto loc_612a;                              //jmp loc_612a
loc_6217:                                       //loc_6217:
    memory(_ds, _si + 14) = 0x01;               //mov byte ptr [si+0xe], 0x1
loc_621b:                                       //loc_621b:
    return;
...
{
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz loc_6238
        goto loc_6238;
    loc_5a58();                    //jmp loc_5a58
    return;
loc_6238:                                       //loc_6238:
    sub_63c9();                                 //call sub_63c9
    if (memory(_ds, _si + 5) & 0x20)            //jnz loc_6244
        goto loc_6244;
    goto loc_62c8;                              //jmp loc_62c8
loc_6244:                                       //loc_6244:
    _al = memory(_ds, _si + 14);                //mov al, byte ptr [si+0xe]
    if (_al != 0x00)                            //jnz loc_6284
        goto loc_6284;
    _dx = 0xfffe;                               //mov dx, 0xfffe
    _ax = memory16(_ds, _si + 2);               //mov ax, word ptr [si+0x2]
    _ax = _ax - memory16(_ds, 21118);           //sub ax, word ptr [0x527e]
    if ((short)_ax >= 0)                        //jns loc_625b
        goto loc_625b;
    _ax = -_ax;                                 //neg ax
    _dx = -_dx;                                 //neg dx
loc_625b:                                       //loc_625b:
    _cl = memory(_ds, _si + 19);                //mov cl, byte ptr [si+0x13]
    _ch = _ch ^ _ch;                            //xor ch, ch
    if (_ax > _cx)                              //ja loc_62c8
        goto loc_62c8;
    _ax = memory16(_ds, _si);                   //mov ax, word ptr [si]
    _ax = _ax - memory16(_ds, 21116);           //sub ax, word ptr [0x527c]
    if ((short)_ax >= 0)                        //jns loc_626e
        goto loc_626e;
    _ax = -_ax;                                 //neg ax
loc_626e:                                       //loc_626e:
    if (_ax > 0x0028)                           //ja loc_62c8
        goto loc_62c8;
    _ax = memory16(_ds, _si + 2);               //mov ax, word ptr [si+0x2]
    memory16(_ds, _si + 22) = _ax;              //mov word ptr [si+0x16], ax
    memory16(_ds, _si + 20) = _dx;              //mov word ptr [si+0x14], dx
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    sub_64df();                                 //call sub_64df
    goto loc_62c8;                              //jmp loc_62c8
loc_6284:                                       //loc_6284:
    if (_al != 0x01)                            //jnz loc_62ac
        goto loc_62ac;
    _ax = memory16(_ds, _si + 20);              //mov ax, word ptr [si+0x14]
    memory16(_ds, _si + 2) += _ax;              //add word ptr [si+0x2], ax
    _ax = memory16(_ds, _si + 2);               //mov ax, word ptr [si+0x2]
    _ax = _ax - memory16(_ds, _si + 22);        //sub ax, word ptr [si+0x16]
    if ((short)_ax >= 0)                        //jns loc_6298
        goto loc_6298;
    _ax = -_ax;                                 //neg ax
loc_6298:                                       //loc_6298:
    _cl = memory(_ds, _si + 19);                //mov cl, byte ptr [si+0x13]
    _ch = _ch ^ _ch;                            //xor ch, ch
    if (_ax < _cx)                              //jc loc_62c8
        goto loc_62c8;
    memory16(_ds, _si + 20) = -memory16(_ds, _si + 20);
    sub_64df();                                 //call sub_64df
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    goto loc_62c8;                              //jmp loc_62c8
loc_62ac:                                       //loc_62ac:
    if (_al != 0x02)                            //jnz loc_62c8
        goto loc_62c8;
    _ax = memory16(_ds, _si + 20);              //mov ax, word ptr [si+0x14]
    memory16(_ds, _si + 2) += _ax;              //add word ptr [si+0x2], ax
    _ax = memory16(_ds, _si + 22);              //mov ax, word ptr [si+0x16]
    if (memory16(_ds, _si + 2) != _ax)          //jnz loc_62c8
        goto loc_62c8;
    sub_64ef();                                 //call sub_64ef
    sub_64ef();                                 //call sub_64ef
    memory(_ds, _si + 14) = 0x00;               //mov byte ptr [si+0xe], 0x0
...
{
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz loc_62d3
        goto loc_62d3;
    loc_5a58();                    //jmp loc_5a58
    return;
loc_62d3:                                       //loc_62d3:
    _al = memory(_ds, _si + 14);                //mov al, byte ptr [si+0xe]
    if (_al != 0x00)                            //jnz loc_6342
        goto loc_6342;
    sub_63c9();                                 //call sub_63c9
    if (!(memory(_ds, _si + 5) & 0x20))         //jz loc_6341
        goto loc_6341;
    _ax = memory16(_ds, _si + 2);               //mov ax, word ptr [si+0x2]
    _ax = _ax - memory16(_ds, 21118);           //sub ax, word ptr [0x527e]
    _ah |= _ah;                                 //or ah, ah
    if (_ah != 0)                               //jnz loc_6341
        goto loc_6341;
    if (memory(_ds, _si + 19) < _al)            //jc loc_6341
        goto loc_6341;
    _cl = _al;                                  //mov cl, al
    _dh = _dh ^ _dh;                            //xor dh, dh
    _ax = memory16(_ds, _si);                   //mov ax, word ptr [si]
    _ax = _ax - memory16(_ds, 21116);           //sub ax, word ptr [0x527c]
    if ((short)_ax >= 0)                        //jns loc_6303
        goto loc_6303;
    _ax = -_ax;                                 //neg ax
    _dh = 0x80;                                 //mov dh, 0x80
loc_6303:                                       //loc_6303:
    _dl = memory(_ds, _si + 5);                 //mov dl, byte ptr [si+0x5]
    _dl &= 0x80;                                //and dl, 0x80
    if (_dl != _dh)                             //jnz loc_6341
        goto loc_6341;
    if ((short)_ax >= (short)0x0030)            //jge loc_6341
        goto loc_6341;
    _ax = memory16(_ds, 0x527c);                //mov ax, [0x527c]
    _ax = _ax - memory16(_ds, _si + 15);        //sub ax, word ptr [si+0xf]
    if ((short)_ax >= 0)                        //jns loc_631c
        goto loc_631c;
    _ax = -_ax;                                 //neg ax
loc_631c:                                       //loc_631c:
    if (memory16(_ds, _si + 17) < _ax)          //jc loc_6341
        goto loc_6341;
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    _dx = _dx ^ _dx;                            //xor dx, dx
loc_6326:                                       //loc_6326:
    ...
    memory16(_ds, _si + 22) = _ax;              //mov word ptr [si+0x16], ax
    sub_64df();                                 //call sub_64df
    goto loc_63be;                              //jmp loc_63be
loc_6341:                                       //loc_6341:
    return;                                     //ret
loc_6342:                                       //loc_6342:
    if (!(memory(_ds, _si + 5) & 0x20))         //jz loc_6341
        goto loc_6341;
    if (_al != 0x01)                            //jnz loc_6391
        goto loc_6391;
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    _ax <<= 1;                                  //shl ax, 1
    _ax <<= 1;                                  //shl ax, 1
    ...
    memory16(_ds, _si + 2) += _ax;              //add word ptr [si+0x2], ax
    _ax += 1;                                   //inc ax
    if (_ax == 0)                               //jz loc_636f
        goto loc_636f;
    memory16(_ds, _si + 20) = _ax;              //mov word ptr [si+0x14], ax
    _ax = memory16(_ds, _si + 22);              //mov ax, word ptr [si+0x16]
    _flags.carry = _al < memory(_ds, _si + 19); //sub al, byte ptr [si+0x13]
    _al = _al - memory(_ds, _si + 19);
    _ah -= 0x00 + _flags.carry;                 //sbb ah, 0x0
    if ((short)memory16(_ds, _si + 2) > (short)_ax)//jg loc_63be
        goto loc_63be;
loc_636f:                                       //loc_636f:
    sub_64df();                                 //call sub_64df
    memory(_ds, _si + 14) += 1;                 //inc byte ptr [si+0xe]
    memory16(_ds, _si + 20) = 0x0000;           //mov word ptr [si+0x14], 0x0
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    _flags.sign = !!(_ax & 0x8000);             //or ax, ax
    _ax |= _ax;
    if (!_flags.sign)                           //jns loc_6383
        goto loc_6383;
    _ax = -_ax;                                 //neg ax
loc_6383:                                       //loc_6383:
    _dx = memory16(_ds, _si + 15);              //mov dx, word ptr [si+0xf]
    if ((short)memory16(_ds, _si) <= (short)_dx)//jle loc_638c
        goto loc_638c;
    _ax = -_ax;                                 //neg ax
loc_638c:                                       //loc_638c:
    memory16(_ds, _si + 8) = _ax;               //mov word ptr [si+0x8], ax
...
loc_6391:                                       //loc_6391:
    ...
    memory16(_ds, _si + 20) = _ax;              //mov word ptr [si+0x14], ax
    _ax = memory16(_ds, _si + 22);              //mov ax, word ptr [si+0x16]
    if ((short)memory16(_ds, _si + 2) < (short)_ax)//jl loc_63be
        goto loc_63be;
    memory16(_ds, _si + 2) = _ax;               //mov word ptr [si+0x2], ax
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
    memory16(_ds, _si) -= _ax;                  //sub word ptr [si], ax
...
void sub_63bf()                              // check dead flying (2) 0x2027
{ // si = 76b3, ds:si+7 = 0x80
    _al = memory(_ds, _si + 7);                 //mov al, byte ptr [si+0x7]
    if (!(_al & 0xc0))                          //jz sub_63c9
        { sub_63c9(); return; }
    loc_5a58();                    //jmp loc_5a58
    return;
} // 020d:63c6 - si=7699  [si+7] = 0xc0        7700
            //   si=76b3  [si+7] =             76ba
void sub_63c9()
{
    _ax = memory16(_ds, _si + 8);               //mov ax, word ptr [si+0x8]
...
void sub_64ff()
{
    if (memory(_ds, _si + 7) & 0xc0)            //jnz loc_654b
        goto loc_654b;
    memory(_ds, _si + 7) &= 0xdf;               //and byte ptr [si+0x7], 0xdf
    _bx = memory16(_ds, _si + 10);              //mov bx, word ptr [si+0xa]
loc_650c:                                       //loc_650c:
    _ax = memory16(_ds, _bx);                   //mov ax, word ptr [bx]
    _flags.sign = !!(_ax & 0x8000);             //or ax, ax
    _ax |= _ax;
    if (!_flags.sign)                           //jns loc_6516
        goto loc_6516;
    _bx += _ax;                                 //add bx, ax
    goto loc_650c;                              //jmp loc_650c
loc_6516:                                       //loc_6516:
    if (_ax != 0x55aa)                          //jnz loc_6527
        goto loc_6527;
    memory16(_ds, _di + 4) = 0xffff;            //mov word ptr [di+0x4], 0xffff
    memory16(_ds, _si + 4) = 0x05aa;            //mov word ptr [si+0x4], 0x5aa
    {sub_655c(); return; };                     //
loc_6527:                                       //loc_6527:
    _dh = _ah;                                  //mov dh, ah
    _dh &= 0x20;                                //and dh, 0x20
    _ah &= 0xdf;                                //and ah, 0xdf
    memory(_ds, _si + 7) |= _dh;                //or byte ptr [si+0x7], dh
    _dh = memory(_ds, _si + 9);                 //mov dh, byte ptr [si+0x9]
    _dh &= 0x80;                                //and dh, 0x80
    _ah |= _dh;                                 //or ah, dh
    memory16(_ds, _si + 4) = _ax;               //mov word ptr [si+0x4], ax
    _ax += 0x0065;                              //add ax, 0x65
    memory16(_ds, _di + 4) = _ax;               //mov word ptr [di+0x4], ax
    sub_655c();                                 //call sub_655c
    memory16(_ds, _si + 10) = _bx;              //mov word ptr [si+0xa], bx
    goto loc_6557;                              //jmp loc_6557
loc_654b:                                       //loc_654b:
    _ax = memory16(_ds, _si + 4);               //mov ax, word ptr [si+0x4]
    _ah &= 0xdf;                                //and ah, 0xdf
    _ax += 0x0065;                              //add ax, 0x65
...
void sub_65be()
{
    ...
    _push(_bp);                                 //push bp
    _push(_si);                                 //push si
    memory(_cs, 0x66D9) = _al;                  //mov cs:[0x66d9], al
    memory(_cs, 0x66DA) = _ah;                  //mov byte ptr cs:[0x66da], ah
    _mul(_ah);                                  //mul ah
    memory16(_cs, 0x66DD) = _ax;                //mov cs:[0x66dd], ax
    _ax = 0x168f;                               //mov ax, 0x168f
    _es = _ax;                                  //mov es, ax
    _ax = memory16(_es, 1217);                  //mov ax, es:[0x4c1]
    _ax += 0x07d1;                              //add ax, 0x7d1
    _es = _ax;                                  //mov es, ax
    _di = _di ^ _di;                            //xor di, di
    _bp = _bp ^ _bp;                            //xor bp, bp
loc_65e9:                                       //loc_65e9:
    _al = memory(_cs, 0x66DA);                  //mov al, cs:[0x66da]
    memory(_cs, 0x66D8) = _al;                  //mov cs:[0x66d8], al
loc_65f1:                                       //loc_65f1:
    _bx = memory16(_cs, 0x66DD);                //mov bx, word ptr cs:[0x66dd]
    _ah = memory(_ds, _bx + _si);               //mov ah, byte ptr [bx+si]
    _dx = _dx ^ _dx;                            //xor dx, dx
    memory16(_cs, 0x66DB) = _dx;                //mov word ptr cs:[0x66db], dx
    if (memory(_cs, 0x66DF) != _dl)             //jnz loc_6611
        goto loc_6611;
    _bx <<= 1;                                  //shl bx, 1
    _dl = memory(_ds, _bx + _si);               //mov dl, byte ptr [bx+si]
    _bx = _bx + memory16(_cs, 0x66DD);          //add bx, word ptr cs:[0x66dd]
    _dh = memory(_ds, _bx + _si);               //mov dh, byte ptr [bx+si]
loc_6611:                                       //loc_6611:
    _lodsb<MemData, DirForward>();              //lodsb
    _cx = 0x0008;                               //mov cx, 0x8
loc_6615:                                       //loc_6615:
    _bx = _bx ^ _bx;                            //xor bx, bx
    _flags.carry = !!(_dh & 0x80);              //shl dh, 1
    _dh <<= 1;
    _rcl(_bx, 1);                               //rcl bx, 1
    ...
    _bx <<= 1;                                  //shl bx, 1
    _bx += _bp;                                 //add bx, bp
    _bx = _bx + memory16(_cs, 0x6676);          //add bx, word ptr cs:[0x6676]
    _bl = memory(_cs, _bx);                     //mov bl, byte ptr cs:[bx]
    _bp = _bp ^ 0x0001;                         //xor bp, 0x1
    _flags.carry = !!(_bl & 0x80);              //shl bl, 1
    _bl <<= 1;
    _rcl(memory16(_cs, 0x66DB), 1);             //rcl word ptr cs:[0x66db], 1
    _flags.carry = !!(_bl & 0x80);              //shl bl, 1
    _bl <<= 1;
    _rcl(memory16(_cs, 0x66DB), 1);             //rcl word ptr cs:[0x66db], 1
    if (--_cx)                                  //loop loc_6615
        goto loc_6615;
    _ax = memory16(_cs, 0x66DB);                //mov ax, cs:[0x66db]
    _xchg(_ah, _al);                            //xchg ah, al
    _stosw<MemData, DirForward>();              //stosw
    memory(_cs, 0x66D8) -= 1;                   //dec byte ptr cs:[0x66d8]
    if (memory(_cs, 0x66D8) != 0)               //jnz loc_65f1
        goto loc_65f1;
    _bp = _bp ^ 0x0001;                         //xor bp, 0x1
    memory(_cs, 0x66D9) -= 1;                   //dec byte ptr cs:[0x66d9]
    if (memory(_cs, 0x66D9) != 0)               //jnz loc_65e9
        goto loc_65e9;
    _di = _pop();                               //pop di
    _si = _si ^ _si;                            //xor si, si
    _push(_ds);                                 //push ds
    ...
    _ds = _pop();                               //pop ds
    _es = _pop();                               //pop es
    _cx = memory16(_cs, 0x66DD);                //mov cx, word ptr cs:[0x66dd]
    _rep_movsw<MemData, MemData, DirForward>(); //rep movsw
    _bp = _pop();                               //pop bp
    _es = _pop();                               //pop es
    _ds = _pop();                               //pop ds
