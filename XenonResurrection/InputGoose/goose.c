...
loc_10D3A:                                      //loc_10D3A:
    ...
    if (_bl == memory(_cs, 0xD95))              //jz short loc_10D4F
      goto loc_10D4F;
    _out(_dx, _ax);                             //out dx, ax
    memory(_es, _di) &= _bl;                    //and es:[di], bl
loc_10D4F:                                      //loc_10D4F:
    _ah >>= 1;                                  //shr ah, 1
...
loc_10D56:                                      //loc_10D56:
    ...
    if (_bh == memory(_cs, 0xD95))              //jz short loc_10D64
      goto loc_10D64;
    _out(_dx, _ax);                             //out dx, ax
    memory(_es, _di) &= _bh;                    //and es:[di], bh
loc_10D64:                                      //loc_10D64:
    _ah >>= 1;                                  //shr ah, 1
...
loc_11036:                                      //loc_11036:
    ...
    _bx -= 1;                                   //dec bx
    _bx <<= 1;                                  //shl bx, 1
    switch (_bx)                                //call cs:off_1105A[bx]
    {
...
loc_1261E:                                      //loc_1261E:
    ...
    memory(_es, _di + 8192) = _bl;              //mov es:[di+2000h], bl
loc_1262D:                                      //loc_1262D:
...
loc_12D3D:                                      //loc_12D3D:
    ...
    _out(_dx, _ax);                             //out dx, ax
    memory(_es, _di) &= _bl;                    //and es:[di], bl
    memory(_es, _di + 8192) &= _bl;             //and es:[di+2000h], bl
loc_12D55:                                      //loc_12D55:
    _ah >>= 1;                                  //shr ah, 1
...
loc_12D5C:                                      //loc_12D5C:
    ...
    _out(_dx, _ax);                             //out dx, ax
    memory(_es, _di) &= _bh;                    //and es:[di], bh
    memory(_es, _di + 8192) &= _bh;             //and es:[di+2000h], bh
loc_12D6D:                                      //loc_12D6D:
    _ah >>= 1;                                  //shr ah, 1
