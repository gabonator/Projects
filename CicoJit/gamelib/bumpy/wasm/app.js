...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 2097152;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
assert(INITIAL_MEMORY == 2097152, 'Detected runtime INITIAL_MEMORY setting.  Use -sIMPORTED_MEMORY to define wasmMemory dynamically');
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 2097152);
...
/** @type {function(...*):?} */
var _appMemory = Module["_appMemory"] = createExportWrapper("appMemory");

/** @type {function(...*):?} */
var _appVideo = Module["_appVideo"] = createExportWrapper("appVideo");

/** @type {function(...*):?} */
var _appLoop = Module["_appLoop"] = createExportWrapper("appLoop");

/** @type {function(...*):?} */
var _appFinish = Module["_appFinish"] = createExportWrapper("appFinish");

/** @type {function(...*):?} */
var _appInit = Module["_appInit"] = createExportWrapper("appInit");
