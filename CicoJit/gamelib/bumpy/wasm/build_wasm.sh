...
CONFIGURATION="-s TOTAL_STACK=1024 -s TOTAL_MEMORY=1048576 -s MINIMAL_RUNTIME=1 -s WASM=1 -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s WARN_ON_UNDEFINED_SYMBOLS=0 -s ASSERTIONS=1 -s SUPPORT_LONGJMP=wasm"
DEFINES="-DEMSCRIPTEN"
