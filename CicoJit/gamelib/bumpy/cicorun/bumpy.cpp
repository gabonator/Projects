...
void sub_4835()
{
    ...
    sub_ca53();
loc_4841:
    if (!(memoryAGet(ds, 0x8244) & 0x04)) //keyb
        goto loc_484d;
    sub_654d();
    goto loc_4874;
loc_484d:
...
void sub_6133()
{
    ...
    sub_ca53();
loc_6142:
//    memoryASet(ds, 0x8244, 0x00); //keyb!!!
    al = memoryAGet(ds, 0x8242);
    ah = 0x00;
    if (ax)
        goto loc_61a5;
...
loc_842a:
    ...
    if (ax)
        goto loc_8455;
    if (memoryAGet(ds, 0x8244) & 0x10) //keyb
        goto loc_8441;
    if (!(memoryAGet(ds, 0x8244) & 0x01))
        goto loc_8455;
loc_8441:
...
void sub_9472() // setkeyb state - al
{
    push(0x7777);
    push(bp);
    bp = sp;
...
loc_94c9:
    al = memoryAGet(es, si); // 1228:4cd2 5 8
    si++;
    if (al >= 0xfd)
        goto loc_94e6;
    dh = al;
loc_94d3:
    ...
    if (al >= 0xfd)
        goto loc_94e6;
    al &= 0x7f;
    al = memory(ds, bx+al); // setkey gabo !!
    if (al == 0)
        goto loc_94d3;
    dl |= dh;
    goto loc_94d3;
