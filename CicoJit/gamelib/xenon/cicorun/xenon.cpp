...
void sub_107ed()
{
  ...
  bp <<= 1;
  bp <<= 1;
  callIndirect(memoryAGet16(cs, bp+0x7FB));
}
void sub_1080f()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x81d));
}
void sub_10831()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x83f));
}
void sub_10853()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x861));
}
void sub_10875()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x883));
}
void sub_10897()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x8a5));
}
void sub_108b9()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x8c7));
}
void sub_1091f()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x92d));
}
void sub_10941()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x94f));
}
void sub_10963()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x971));
}
void sub_10985()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x993));
}
void sub_109a7()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x9b5));
}
void sub_109eb()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0x9f9));
}
void sub_10a0d()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp+0xa1b));
...
void sub_10a2f()
{
  ...
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xa3d));
}
void sub_10a51()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xa5f));
    sync();
}
void sub_10a73()
{
  ...
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xa81));
}
void sub_10a95()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xaa3));
}
void sub_10afb()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xb09));
}
void sub_10b3f()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xb4d));
}
void sub_10b83()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xb91));
}
void sub_10ba5()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xbb3));
}
void sub_10bc7()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xbd5));
}
void sub_10be9()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xbf7));
}
void sub_10c0b()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xc19));
}
void sub_10c2d()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xc3b));
}
void sub_10c4f()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xc5d));
}
void sub_10c71()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xc7f));
}
void sub_10c93()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xca1));
}
void sub_10cb5()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xcc3));
}
void sub_10cd7()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xce5));
}
void sub_10cf9()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xd07));
}
void sub_10d1b()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xd29));
//  callIndirect(memoryAGet16(cs, bp + 0xd29]
}
void sub_10d5f()
{
  ...
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xd6d));
//  callIndirect(memoryAGet16(cs, bp + 0xd6d]
}
void sub_10d81()
{
  ...
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xd8f));
...
void sub_10da3()
{
  ...
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xdb1));
//  callIndirect(memoryAGet16(cs, bp + 0xdb1]
}
void sub_10dc5()
{
  ...
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xdd3));
}
void sub_10de7()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xdf5));
//  callIndirect(memoryAGet16(cs, bp + 0xdf5]
}
void sub_10e09()
{
  ...
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xe17));
}
void sub_10e2b()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xe39));
}
void sub_10e4d()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xe5b));
}
void sub_10e6f()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xe7d));
}
void sub_10e91()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xe9f));
}
void sub_10eb3()
{
  bp = memoryAGet16(ds, 0x3044);
  bp <<= 1;
  bp <<= 1;
    callIndirect(memoryAGet16(cs, bp + 0xec1));
}
void sub_10ef5()
{
  push(es);
...
loc_10b1d:
  ...
  bp <<= 1;
  bp <<= 1;
      callIndirect(memoryAGet16(cs, bp + 0xb2b));
  return;
  //   gap of 19538 bytes
loc_1577d:
  ax = memoryAGet16(ds, 0x915a);
...
loc_20D04:                                      //loc_20D04:
    ...
    si += 0x0006;                              //add si, 6
    bp -= 1;                                   //dec bp
    if (bp != 0)                               //jnz short loc_20D04
      goto loc_20D04;
    bp = pop();                               //pop bp
    di = pop();                               //pop di
    di += 0x0028;                              //add di, 28h
    if (--cx)                                  //loop loc_20D02
      goto loc_20D02;
    bp = pop();                               //pop bp
    cx = pop();                               //pop cx
    di = pop();                               //pop di
...
//      goto loc_205B3;
    memory16(ds, 0x3046) = 0x0000;             //mov word_2B576, 0
    bx = memoryAGet16(ds, 0x425B);                //mov bx, word_2C78B
    ax = memoryAGet16(ds, 0x4259);                //mov ax, word_2C789
    memoryASet16(ds, 0x425B, ax);                //mov word_2C78B, ax
    memoryASet16(ds, 0x4259, bx);                //mov word_2C789, bx
    dx = memoryAGet16(ds, 0x4257);                //mov dx, word_2C787
    dl += 0x06;                                //add dl, 6
loc_205D5:                                      //loc_205D5:
    in(al, dx);                              //in al, dx
    if (al & 0x08)                             //jnz short loc_205D5
      goto loc_205D5;
    dl -= 0x06;                                //sub dl, 6
    flags.interrupts = false;                   //cli
    ah = bh;                                  //mov ah, bh
    al = 0x0c;                                 //mov al, 0Ch
    out(dx, ax);                             //out dx, ax
    flags.interrupts = true;                    //sti
    dl += 0x06;                                //add dl, 6
loc_205E7:                                      //loc_205E7:
    in(al, dx);                              //in al, dx
    if (!(al & 0x08))                          //jz short loc_205E7
      goto loc_205E7;
}
...
void sub_20AC0()
{
    ...
    push(cx);
loc_20AC2:
    lodsb<MemData, DirAuto>();
    stosb<MemVideo, DirAuto>();
    lodsb<MemData, DirAuto>();
...
{
    ax = 0x0028;
    mul(memory16(ds, 0x3752));
    di = ax;
    push(memory16(ds, si + 20));
    push(si);
    memory(ds, si + 20) = 0x00;
    sub_20a2e();
    si = pop();
    memory16(ds, si + 20) = pop();
}

void sub_20a3c()
{
    bp = 0x2300;                               //mov bp, 2300h
    cx = 0x000e;                               //mov cx, 0Eh
    sub_20a47();                                //call near ptr sub_20A47
}

void sub_20a1d()
{
    push(memoryAGet16(ds, si + 15));             //push word ptr [si+0Fh]
    push(si);                                 //push si
    memory(ds, si + 15) = 0x00;               //mov byte ptr [si+0Fh], 0
    sub_20a3c();                                //call near ptr sub_20A3C
    si = pop();                               //pop si
    memoryASet16(ds, si + 15, pop());           //pop word ptr [si+0Fh]
}
...
void sub_209e9()
{
    ...
    memoryASet16(ds, 0x3752, 0x000c);             //mov word_2BC82, 0Ch
    si = 0x352b;                               //mov si, 352Bh
    sub_20973();                                //call near ptr sub_20973
    si = 0x358f;                               //mov si, 358Fh
    di = 0x05f4;                               //mov di, 5F4h
    cx = 0x000a;                               //mov cx, 0Ah
loc_20A03:                                      //loc_20A03:
    push(si);                                 //push si
    push(di);                                 //push di
    push(cx);                                 //push cx
    ...
    di = pop();                               //pop di
    si = pop();                               //pop si
    si += 0x000f;                              //add si, 0Fh
    di += 0x0280;                              //add di, 280h
    if (--cx)                                  //loop loc_20A03
      goto loc_20A03;
