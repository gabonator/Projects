...
INCLUDES=
EXPORTED_EXTRAS="'_lemmingsMouse', '_lemmingsButton', '_lemmingsStartupLevel'"
EXPORTED="['_appLoop', '_appInit', '_appFinish', '_appMemory', '_appBlit', '_appVideo', '_asyncifyBuffer', ${EXPORTED_EXTRAS}]"
