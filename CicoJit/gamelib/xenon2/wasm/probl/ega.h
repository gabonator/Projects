...
public:
    ...
    virtual bool PortRead8(int port, uint8_t& data) = 0;
...
//            crtReg = data;
    ...
    virtual bool PortRead8(int port, uint8_t& val) override
    {
        ...
        if (port == 0x3c9)
        {
            ...
            vgareadcolorindex++;
            val = ((uint8_t*)palette)[cindex*4+2-cch]/4;
            return true;
        }
