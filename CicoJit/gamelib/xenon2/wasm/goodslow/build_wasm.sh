...
SOURCE="wasmhost.cpp xenon2.cpp"

NAME=app
BASE=http://localhost:8084/

INCLUDES=
EXPORTED="['_appLoop', '_appInit', '_appFinish', '_appMemory', '_appBlit', '_appVideo', '_asyncifyBuffer']"
CONFIGURATION="-s TOTAL_STACK=1024 -s TOTAL_MEMORY=4587520 -s MINIMAL_RUNTIME=1 -s WASM=1 -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s WARN_ON_UNDEFINED_SYMBOLS=0 -s ASSERTIONS=1 -sASYNCIFY "
DEFINES=
