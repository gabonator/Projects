...
{    static int keys = 0;
  if (k == SDL_SCANCODE_ESCAPE) exit(1);
    switch (k)
    {
        case SDL_SCANCODE_Q: CicoContext::ctx->memory8(0x1040, 0x7e44) = p ? 0xff:0; break;
        case SDL_SCANCODE_W: CicoContext::ctx->memory8(0x1040, 0x7e44) = p ? 0x40:0; break;
        case SDL_SCANCODE_E: CicoContext::ctx->memory8(0x1040, 0x7e44) = p ? 0x80:0; break;
        case SDL_SCANCODE_R: CicoContext::ctx->memory8(0x168f, 1084) = p; break;
        ...
        case SDL_SCANCODE_SPACE:
            CicoContext::ctx->memory8(0x1040, 0x7e43) = 0x39;
        ...
        case SDL_SCANCODE_A: CicoContext::ctx->memory8(0x1040, 0x7d6c) = p ? 0xff : 0x00; break; // ESC
        case SDL_SCANCODE_P: CicoContext::ctx->memory8(0x168f, 0x459) = p; break;
    }
    CicoContext::ctx->memory8(0x1040, 0x7e44) = keys;
}
...
uint8_t& cicocontext_t::memory8(int seg, int ofs){
    if (seg == 0x1532 && ofs >= 0xe5b9 && ofs <= 0xe5b9+128)
    {
        int scancode = ofs - 0xe5b9;
        if (scancode < 128)
        switch (scancode)
        {
            case 1: break; // esc
            ...
            case 43: break; // "\ "
            case 57: break; // space
            case 73: break; // pageup
            case 79: break; // end
            case 81: break; // pagedown
            case 128: break; // alt+9 ?
            case 129: break; // alt+0 ?
            case 59: break; // f1
            case 60: break; // f2
            case 61: break; // f3
            case 62: break; // f4
...
//                c -= 'a' - 'A';
        ...
        char fullname[128] = "/Users/gabrielvalky/Documents/git/Projects/CicoJit/gamelib/rick1/dos/";
...
int main(int argc, const char * argv[])
{
    ...
    FILE* f = fopen("/Users/gabrielvalky/Documents/git/Projects/CicoJit/gamelib/rick1/dos/rick1.exe", "rb");
    fread(mem, 159936, 1, f);
    fclose(f);
    assert(CicoContext::ctx->memory8(0x341b, 0x0) == 0xe8);
    assert(CicoContext::ctx->memory8(0x341b, 0x1) == 0x6d);
    assert(CicoContext::ctx->memory8(0x341b, 0x2) == 0x05);

    assert(CicoContext::ctx->memory8(0x1040, 0x0102) == 0xa4);
    assert(CicoContext::ctx->memory8(0x1040, 0x0103) == 0x01);
