...
#./cicodis dos/rick1.exe -assume_ds 1040 -reloc -ctx -recursive start,341b:1448,341b:22cb,341b:228c,341b:259b,341b:2575,341b:1a01,341b:1a48,341b:2313,341b:2861,341b:25a3 \
#  > rick0.cpp

#./cicodis dos/rick1.exe -segofscomment 341b:2263 \
#  -jumptable 341b:228a 1040:80bf 24 jumpwords di > temp
#exit 0

# fromRelative: return address_t{segment, (int)offset - 0x41b0};
./cicodis dos/rick1.exe -segofscomment -assume_ds 1040 -reloc -ctx -recursive start,341b:1448,341b:22cb,341b:228c,341b:259b,341b:2575,341b:1a01,341b:1a48,341b:2313,341b:2861,341b:25a3 \
   -jumptable 341b:228a 1040:80bf 24 jumpwords di \
  > rick1.cpp

patch rick1.cpp ch1.patch
#   -jumptable 341b:228a 1040:80bf 24 jumpwords di \
...
#diff rick1.cpp cicorun/rick1.cpp
#rm cicodis
