...
class CEgaVgaBgi : public CVideoAdapter
{
    ...
    void drawchar(int x, int y, int c1, int c0, char c)
    {
        c = c - 59;        
        for (int _y=0; _y<8; _y++)
        {
            ...
            {
                //        /__font8
                if (__font8[c*8+_y] & (1<<(7-_x)))
                    SetPixel(x+_x, y+_y, c1);
                else
                    SetPixel(x+_x, y+_y, c0);
            }
        }
    }
    virtual bool Interrupt(CicoContext::cicocontext_t* ctx)
    {
        switch (ctx->_si)
        {
            ...
            case 0x0c:
                ...
                break;
            case 0x12:
                bar(ctx->a.r16, ctx->b.r16, ctx->c.r16, ctx->d.r16, (color >>4) & 0x0f);
                //line(ctx->a.r16, ctx->b.r16, ctx->c.r16, ctx->d.r16, color & 0x0f);
                break;
            case 0x32:
                //printf("bitmap util\n");
            ...
            case 0x26:
                ...
                for (int i=0; ctx->memory8(ctx->_es, ctx->b.r16+i); i++)
                    drawchar(x+i*8, y, color, 0, ctx->memory8(ctx->_es, ctx->b.r16+i));
                break;
...
// dd if=EGAVGA.BGI of=font8 bs=1 skip=$((0x9A8)) count=1024 status=none
// xxd -i ./font8 > font8.h
unsigned char __font8[] = {
  0x88, 0x00, 0x22, 0x00, 0x88, 0x00, 0x22, 0x00, 0xff, 0xff, 0xff, 0xff,
  0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x01, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x00, 0x00, 0x00, 0x00, 0x0e, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x38, 0x6c, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0x00, 0xfc, 0xc6, 0xc6, 0xfc,
  0xc6, 0xc6, 0xfc, 0x00, 0x7c, 0xc6, 0xc6, 0xc0, 0xc0, 0xc6, 0x7c, 0x00,
  0xf8, 0xcc, 0xc6, 0xc6, 0xc6, 0xcc, 0xf8, 0x00, 0xfe, 0xc0, 0xc0, 0xfc,
  0xc0, 0xc0, 0xfe, 0x00, 0xfe, 0xc0, 0xc0, 0xfc, 0xc0, 0xc0, 0xc0, 0x00,
  0x7c, 0xc6, 0xc0, 0xce, 0xc6, 0xc6, 0x7e, 0x00, 0xc6, 0xc6, 0xc6, 0xfe,
  ...
  0xfc, 0xc6, 0xc6, 0xfc, 0xc0, 0xc0, 0xc0, 0x00, 0x7c, 0xc6, 0xc6, 0xc6,
  0xc6, 0xc6, 0x7c, 0x06, 0xfc, 0xc6, 0xc6, 0xfc, 0xc6, 0xc6, 0xc6, 0x00,
  0x78, 0xcc, 0x60, 0x30, 0x18, 0xcc, 0x78, 0x00, 0xfc, 0x30, 0x30, 0x30,
  ...
  ,
