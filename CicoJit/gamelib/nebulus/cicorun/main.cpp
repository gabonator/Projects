...
void onKey(int k, int p)
{
  if (k == SDL_SCANCODE_ESCAPE) exit(1);
    ...
    switch (k)
    {
        case SDL_SCANCODE_Y: ofs = 21; break;
        case SDL_SCANCODE_N: ofs = 49; break;
        case SDL_SCANCODE_A: ofs = 2; break;
        case SDL_SCANCODE_B: ofs = 3; break;
        case SDL_SCANCODE_C: ofs = 4; break;
        case SDL_SCANCODE_D: ofs = 6; break;
        case SDL_SCANCODE_P: ofs = 25; break;
        case SDL_SCANCODE_SPACE: ofs = 57; break;
        case SDL_SCANCODE_LEFT: ofs = 24; break;
        case SDL_SCANCODE_RIGHT: ofs = 25; break;
        case SDL_SCANCODE_UP: ofs = 16; break;
            /*
        case SDL_SCANCODE_A: ofs = 0xe5ea; break; // scancode N 49
        case SDL_SCANCODE_B: ofs = 0xe5ce; break; // scancode Y  21
        case SDL_SCANCODE_C: ofs = 0xe5bb; break;
        case SDL_SCANCODE_D: ofs = 0xe5bc; break;
        case SDL_SCANCODE_E: ofs = 0xe602; break;
             case 1: break; // esc
             case 2: break; // 1
             case 3: break; // 2
             case 4: break; // 3
             case 5: break; // 4
             case 7: break; // 6
             case 16: break; // q      - key up
             case 21: break; // y
             case 30: break; // a
             case 24: break; // o      - key left
             case 25: break; // p      - key right
             case 49: break; // n
             case 43: break; // "\ "
             case 57: break; // space
    ...
    if (ofs)
      CicoContext::ctx->memory8(0x1532, 0xe5b9+ofs) = p;
}
...
int main(int argc, const char * argv[])
{
    ...
    FILE* f = fopen("NEBEGA.EXE", "rb");
    fread(mem, 306912, 1, f);
    fclose(f);
