...
INCLUDES=
EXPORTED_EXTRAS="'_egaPalette', '_egaMemory', '_lastKey', '_cdmanStartupLevel'"
EXPORTED="['_appLoop', '_appInit', '_appFinish', '_appMemory', '_appBlit', '_appVideo', '_asyncifyBuffer', '_seed', ${EXPORTED_EXTRAS}]"
CONFIGURATION="-s TOTAL_STACK=1024 -s TOTAL_MEMORY=4194304 -s MINIMAL_RUNTIME=1 -s WASM=1 -s ERROR_ON_UNDEFINED_SYMBOLS=0 -s WARN_ON_UNDEFINED_SYMBOLS=0 -s ASSERTIONS=1 -sASYNCIFY "
#DEFINES=-DNDEBUG
