...
void start()
{
    ...
    ss = 0x0c41;
    sp = 0x364c;
    load("/Users/gabrielvalky/Documents/git/Projects/CicoJit/gamelib/tuneller/dos/dos", "TUNNELER.EXE", 39552);
    fixReloc(cs);
    sub_79ed();
}
void fixReloc(uint16_t seg)
{
    memory16(0x0000 + seg, 0x0018) += seg; // 06e3 -> 08d0
    memory16(0x0000 + seg, 0x0034) += seg; // 06e3 -> 08d0
    memory16(0x0000 + seg, 0x0043) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0052) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0057) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0065) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x007a) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0186) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x0198) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x01aa) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x01af) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x01cb) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x01d0) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x01ea) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x01ef) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0201) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0206) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0218) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x021d) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x022f) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0240) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x024b) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0250) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0269) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x026e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0280) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0285) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x029e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x02a3) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x02b5) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x02ba) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x02c2) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x02d4) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x02d9) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x02e1) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x0302) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0313) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x0318) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x033c) += seg; // 06e3 -> 08d0
    memory16(0x0000 + seg, 0x041a) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0660) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0665) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x066a) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0882) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x088a) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0892) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0897) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x09c5) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x09e7) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0a28) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x0a3a) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0a3f) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0dba) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0e3c) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x0f0f) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x0f16) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x10c4) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x10ce) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x10eb) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x10f5) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x1f08) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x1f27) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x1f48) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x1f5d) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x1f72) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x1f87) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x22fd) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2347) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x243b) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2458) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x24fb) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2877) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2882) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x288d) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x289d) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x28a2) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x28bc) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x28c1) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x28d7) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x28dc) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x28e7) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x28f9) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2907) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2914) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2919) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2924) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2934) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2939) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2953) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2958) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x296e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2973) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x297b) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2986) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2998) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x299d) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x29a8) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x29bb) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x29c0) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x29c8) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x29d3) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x29e5) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x29ea) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x29f5) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2a08) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2a0d) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x2a58) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2a6f) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2b32) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2bd0) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2be4) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2c1f) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2c34) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2c49) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2c5e) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2cd2) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2ce5) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2cee) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2cf6) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2cfe) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2d03) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x2d19) += seg; // 06d3 -> 08c0
    memory16(0x0000 + seg, 0x2d41) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x2d77) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x32e0) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x32ee) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3309) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3317) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x348f) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x353a) += seg; // 05ea -> 07d7
    memory16(0x0000 + seg, 0x3542) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x3547) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x35ef) += seg; // 06d3 -> 08c0
    memory16(0x0000 + seg, 0x3634) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3641) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x37a9) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x37bd) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x37ef) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3830) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3854) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x38e2) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x38f8) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3914) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3929) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x39c2) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x39d4) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x39fa) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3a13) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3a40) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3a91) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3ac7) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3ade) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3aed) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3b56) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3b6c) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3b88) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3b9d) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3c6c) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3c7e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3ca1) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3cba) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3cca) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3cf1) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3ea8) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3eb7) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3ef3) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x3f20) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x406f) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x407a) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x4089) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x409b) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x40a0) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x40a8) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x40b7) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x40c9) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x40ce) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x40d6) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x40ef) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x40ff) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4104) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x411e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4123) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4139) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x413e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4150) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4155) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4167) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x416c) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x417e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4183) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4195) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x419a) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x41aa) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x41af) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x41c9) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x41ce) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x41e4) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x41e9) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x41fa) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x421e) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x4234) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x4244) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4249) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4260) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x4268) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x4273) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x4285) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x428a) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4294) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x429e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x42cd) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x42df) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x42e4) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4302) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x4314) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4319) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4323) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x432b) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x433d) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4342) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4355) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x436f) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4374) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x4384) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x438c) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x439e) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x43a3) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x43b6) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x43d0) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x43d5) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x43e5) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x43ed) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0
+= seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x5e34) += seg; // 06f4 -> 08e1
    memory16(0x0000 + seg, 0x5e46) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x5e4b) += seg; // 075a -> 0947
    memory16(0x0000 + seg, 0x5e9e) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0009) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0026) += seg; // 06e3 -> 08d0
    memory16(0x05ea + seg, 0x0035) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0097) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x017c) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x01ab) += seg; // 06e3 -> 08d0
    memory16(0x05ea + seg, 0x01bc) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0265) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0277) += seg; // 0631 -> 081e
    memory16(0x05ea + seg, 0x028e) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x02f2) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0311) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0323) += seg; // 06f4 -> 08e1
    memory16(0x05ea + seg, 0x0338) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x03b7) += seg; // 06e3 -> 08d0
    memory16(0x05ea + seg, 0x03ee) += seg; // 06e3 -> 08d0
    memory16(0x05ea + seg, 0x0406) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x040e) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0416) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x041b) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x0430) += seg; // 075a -> 0947
    memory16(0x05ea + seg, 0x044c) += seg; // 06e3 -> 08d0
    memory16(0x05ea + seg, 0x0455) += seg; // 06f4 -> 08e1
    memory16(0x05ea + seg, 0x045f) += seg; // 0631 -> 081e
    memory16(0x0631 + seg, 0x006f) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x0074) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x0079) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x008d) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x0092) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x0097) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x009f) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x00b3) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x00d5) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x02ce) += seg; // 075a -> 0947
    memory16(0x0631 + seg, 0x0367) += seg; // 0631 -> 081e
    memory16(0x0631 + seg, 0x03db) += seg; // 0631 -> 081e
    memory16(0x0631 + seg, 0x0445) += seg; // 0631 -> 081e
    memory16(0x06d3 + seg, 0x0008) += seg; // 075a -> 0947
    memory16(0x06d3 + seg, 0x0015) += seg; // 06e3 -> 08d0
    memory16(0x06d3 + seg, 0x0024) += seg; // 06e3 -> 08d0
    memory16(0x06d3 + seg, 0x003a) += seg; // 075a -> 0947
    memory16(0x06d3 + seg, 0x0048) += seg; // 075a -> 0947
    memory16(0x06d3 + seg, 0x005f) += seg; // 06e3 -> 08d0
    memory16(0x06d3 + seg, 0x0079) += seg; // 08d6 -> 0ac3
    memory16(0x06d3 + seg, 0x00ba) += seg; // 075a -> 0947
    memory16(0x06f4 + seg, 0x0016) += seg; // 075a -> 0947
    memory16(0x06f4 + seg, 0x0029) += seg; // 075a -> 0947
    memory16(0x06f4 + seg, 0x017d) += seg; // 08d6 -> 0ac3
    memory16(0x075a + seg, 0x0001) += seg; // 08d6 -> 0ac3
    memory16(0x075a + seg, 0x01f8) += seg; // 08d6 -> 0ac3
}
void sub_1ed0();
void sub_21c4();
void sub_21da();
...
// INJECT: Error: cannot inject flag in sub_8b5a() because of being label!
// INJECT: Error: cannot inject zero flag in sub_8b8a() because no traceback!
// INJECT: Error: cannot inject flag in sub_9844() because of being label!
// INJECT: Error: cannot inject flag in sub_9f5d() because of being label!
// INJECT: Error: cannot inject carry flag in sub_9fe9()!
// INJECT: Error: cannot inject zero flag in sub_a7bc()!
// INJECT: Error: cannot inject flag in sub_a93e() because of being label!
