...
void cicocontext_t::_int(int i)
{
    ...
    if (i == 0x21 && ctx->a.r8.h == 0x3d)
    {
        ...
        char fullname[128] = "/Users/gabrielvalky/Documents/git/Projects/CicoJit/games/goose/";
...
uint8_t cicocontext_t::sar(uint8_t r, uint8_t l)
{
    assert(0);
    return 0;
}
uint16_t cicocontext_t::sar(uint16_t r, uint8_t l)
{
    int16_t sr = (short)r;
    sr >>= l;
    return sr;
...
int main(int argc, const char * argv[])
{
    ...
    FILE* f = fopen("/Users/gabrielvalky/Documents/git/Projects/CicoJit/games/goose/GOOSE.EXE", "rb");
    fread(mem, 53684, 1, f);
    fclose(f);
