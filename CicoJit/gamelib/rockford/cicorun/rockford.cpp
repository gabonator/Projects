...
void start()
{
  ...
  ss = 0x2cdb;
  sp = 0x0200;
  load("/Users/gabrielvalky/Documents/git/Projects/CicoJit/gamelib/_rockford/dos", "R.EXE", 143040);
  sub_2d2a5();
}
void sub_2d277();
void sub_2d2a5();
...
// INJECT: Error: cannot inject zero flag in sub_2e59c()!
void sub_2e59c()
{
...
// INJECT: Error: cannot inject zero flag in sub_2e6d0()!
void sub_2e6d0()
{
...
// INJECT: Error: cannot inject zero flag in sub_2e84d()!
void sub_2e84d()
{
...
// INJECT: Error: cannot inject zero flag in sub_2e9ca()!
void sub_2e9ca()
{
...
loc_2fa88:
  al = 0x54;
//  repne_scasb<MemAuto, DirAuto>(al); // tandy?
//  if (stop(/*1*/))
//    goto loc_2fa92;
  al = 0;
  goto loc_2fab6;
...
// INJECT: Error: cannot inject zero flag in sub_3001f()!
void sub_3001f()
{
  if (al != 0x00)
    goto loc_30028;
