...
loc_10668:
    ax = 0;
    temp_cf = !!(dx & 0x8000) /*ggg5*/;
    dx <<= 1;
    flags.carry = temp_cf /*ggg6*/;
    ax = rcl16(ax, 0x0001);
    temp_cf1 = !!(dx & 0x8000) /*ggg5*/;
    dx <<= 1;
    flags.carry = temp_cf1 /*ggg6*/;
    ax = rcl16(ax, 0x0001);
    temp_cf2 = !!(dx & 0x8000) /*ggg5*/;
    dx <<= 1;
    flags.carry = temp_cf2 /*ggg6*/;
    ax = rcl16(ax, 0x0001);
    temp_cf3 = !!(dx & 0x8000) /*ggg5*/;
    dx <<= 1;
    flags.carry = temp_cf3 /*ggg6*/;
    ax = rcl16(ax, 0x0001);
    if (al <= 0x09)
        goto loc_10680;
    al += 0x07;
...
void sub_107b7()
{
    ...
    temp_cf = memoryAGet(ds, 0x6506) < 0x01;
    memoryASet(ds, 0x6506, memoryAGet(ds, 0x6506) - 0x01);
    memoryASet(ds, 0x6506, memoryAGet(ds, 0x6506) + (0x00 + temp_cf));
...
void sub_109b0() // +returnCarry
{
    ...
    temp_cf = al & 1;
    al >>= 1;
    memoryASet(ds, 0x042b, memoryAGet(ds, 0x042b) - bh - temp_cf);
    temp_cf1 = al & 1;
    al >>= 1;
    memoryASet(ds, 0x042b, memoryAGet(ds, 0x042b) - bh - temp_cf1);
...
loc_10e48:
    ...
    si = bx;
    temp_cf = (bl + memoryAGet(ds, 0x0009)) >= 0x100;
...
loc_10eaf:
    ...
    ch = 0x10;
    ch -= cl;
    temp_cf1 = ch < memoryAGet(ds, 0x0009);
...
loc_11a11:
    mul16(bp);
    temp_cf = !!(cx & 0x8000) /*ggg5*/;
    cx <<= 1;
    flags.carry = temp_cf /*ggg6*/;
    dh = rcl8(dh, 0x01);
    temp_cf1 = !!(cx & 0x8000) /*ggg5*/;
    cx <<= 1;
    flags.carry = temp_cf1 /*ggg6*/;
    dh = rcl8(dh, 0x01);
    temp_cf2 = !!(cx & 0x8000) /*ggg5*/;
    cx <<= 1;
    flags.carry = temp_cf2 /*ggg6*/;
    dh = rcl8(dh, 0x01);
    temp_cf3 = !!(cx & 0x8000) /*ggg5*/;
    cx <<= 1;
    flags.carry = temp_cf3 /*ggg6*/;
    dh = rcl8(dh, 0x01);
    al += dh;
...
loc_11fb0:
    ...
    cl = memoryAGet(cs, 0x0000);
    ax >>= cl;
    temp_cf3 = (al + memoryAGet(cs, 0x1c4a)) >= 0x100;
    al += memoryAGet(cs, 0x1c4a);
    ah += 0x00 + temp_cf3;
    temp_cf4 = ax < memoryAGet16(ds, 0x525c);
...
//    stop("stack_bad");
    ...
    ax = memoryAGet16(ds, si + 14);
    ax = -ax;
    temp_cond1 = (short)ax + (short)0x0030 < 0;
    ax += 0x0030;
    if (temp_cond1)
        goto loc_13f55;
    ax = 0;
...
loc_13f77:
    ...
    if ((char)al >= (char)dl)
        goto loc_13f87;
    temp_cond = (short)memoryAGet16(ds, si + 14) + (short)0x0010 <= 0;
...
loc_144d2:
    if (memoryAGet(ds, si + 11) != al)
        goto loc_144b9;
    temp_cf = (memoryAGet16(ds, 0x651e) + 0x0001) >= 0x10000;
    memoryASet16(ds, 0x651e, memoryAGet16(ds, 0x651e) + 0x0001);
    memoryASet16(ds, 0x651e, memoryAGet16(ds, 0x651e) - 0x0000 - temp_cf);
loc_144e1:
    true ? cbw() : cwde();
    bx = ax;
    bx <<= 1;
...
loc_145d4:
    ...
    ax = memoryAGet16(ds, 0x527e);
    bx <<= 1;
    temp_cf9 = al < memoryAGet(ds, bx + 27640);
    al -= memoryAGet(ds, bx + 27640);
    ah = ah - 0x00 - temp_cf9;
    ax++;
    memoryASet16(ds, 0x5290, ax);
...
loc_145fd:
    dx = 0x0001;
    temp_cf1 = memoryAGet(ds, 0x651b) < dl;
    memoryASet(ds, 0x651b, memoryAGet(ds, 0x651b) - dl);
    memoryASet(ds, 0x651b, memoryAGet(ds, 0x651b) + (dh + temp_cf1));
    temp_cf2 = memoryAGet(ds, 0x6516) < dl;
    memoryASet(ds, 0x6516, memoryAGet(ds, 0x6516) - dl);
    memoryASet(ds, 0x6516, memoryAGet(ds, 0x6516) + (dh + temp_cf2));
    temp_cf3 = memoryAGet(ds, 0x6504) < dl;
    memoryASet(ds, 0x6504, memoryAGet(ds, 0x6504) - dl);
    memoryASet(ds, 0x6504, memoryAGet(ds, 0x6504) + (dh + temp_cf3));
    temp_cf4 = memoryAGet(ds, 0x6510) < dl;
    memoryASet(ds, 0x6510, memoryAGet(ds, 0x6510) - dl);
    memoryASet(ds, 0x6510, memoryAGet(ds, 0x6510) + (dh + temp_cf4));
    temp_cf5 = memoryAGet(ds, 0x6511) < dl;
    memoryASet(ds, 0x6511, memoryAGet(ds, 0x6511) - dl);
    memoryASet(ds, 0x6511, memoryAGet(ds, 0x6511) + (dh + temp_cf5));
    temp_cf7 = memoryAGet(ds, 0x6512) < dl;
    memoryASet(ds, 0x6512, memoryAGet(ds, 0x6512) - dl);
    memoryASet(ds, 0x6512, memoryAGet(ds, 0x6512) + (dh + temp_cf7));
    temp_cf8 = memoryAGet(ds, 0x6514) < dl;
    memoryASet(ds, 0x6514, memoryAGet(ds, 0x6514) - dl);
    memoryASet(ds, 0x6514, memoryAGet(ds, 0x6514) + (dh + temp_cf8));
    if (memoryAGet16(ds, 0x528a) != 0x0000)
        goto loc_14647;
    temp_cf10 = memoryAGet(ds, 0x6513) < dl;
    memoryASet(ds, 0x6513, memoryAGet(ds, 0x6513) - dl);
    memoryASet(ds, 0x6513, memoryAGet(ds, 0x6513) + (dh + temp_cf10));
loc_14647:
    ax = memoryAGet16(ds, 0x5282);
    ax |= memoryAGet16(ds, 0x528a);
    if (ax)
...
loc_14654:
    temp_cf11 = memoryAGet(ds, 0x6505) < dl;
    memoryASet(ds, 0x6505, memoryAGet(ds, 0x6505) - dl);
    memoryASet(ds, 0x6505, memoryAGet(ds, 0x6505) + (dh + temp_cf11));
...
loc_1489a:
    ...
    ax = memoryAGet16(ds, si);
    dx = memoryAGet16(ds, 0x527c);
    temp_cf = dl < memoryAGet(ds, 0x692f);
...
loc_14eeb:
    ...
    memoryASet16(ds, 0x528a, 0x0000);
    temp_cf = memoryAGet(ds, 0x650f) < 0x01;
    memoryASet(ds, 0x650f, memoryAGet(ds, 0x650f) - 0x01);
    memoryASet(ds, 0x650f, memoryAGet(ds, 0x650f) + (0x00 + temp_cf));
...
loc_152c5:
    ...
    bx <<= 1;
    ax = memoryAGet16(ds, di);
    temp_cf = al < memoryAGet(ds, bx + 26927);
    al -= memoryAGet(ds, bx + 26927);
    ah = ah - 0x00 - temp_cf;
    bl = memoryAGet(ds, bx + 27639);
    bl >>= 1;
...
void sub_15333() // +returnZero +stackDrop16
{
    bool temp_zf;
    ...
    goto loc_1534e;
loc_15349:
    temp_zf = !(memoryAGet(ds, bx + 28441) & 0x02);
loc_1534e:
    bp = pop();
    bx = pop();
    flags.zero = temp_zf;
...
loc_156dc:
    al = lodsb<DS_SI>();
    al = memoryAGet(cs, bx+al);
    temp_cf = !!(al & 0x80) /*ggg5*/;
    al <<= 1;
    flags.carry = temp_cf /*ggg6*/;
    ah = rcl8(ah, 0x01);
    temp_cf1 = !!(al & 0x80) /*ggg5*/;
    al <<= 1;
    flags.carry = temp_cf1 /*ggg6*/;
    ah = rcl8(ah, 0x01);
    cl--;
...
loc_15a0a:
    ...
    bx = memoryAGet16(ds, si + 4);
    bh &= 0x1f;
    temp_zf = !(memoryAGet(ds, bx + 28441) & 0x10);
    bx = ax;
    if (!temp_zf)
        goto loc_15a20;
    sub_15295();
...
loc_15ad0:
    ...
    ax = memoryAGet16(ds, si);
    ax >>= cl;
    temp_cf = ax < memoryAGet16(ds, 0x5270);
    ax -= memoryAGet16(ds, 0x5270);
    if (temp_cf)
        goto loc_15b0a;
    temp_zf = ax == 0x0014;
...
loc_15af0:
    ...
    ax = memoryAGet16(ds, si + 2);
    ax >>= cl;
    temp_cf1 = ax < memoryAGet16(ds, 0x5272);
    ax -= memoryAGet16(ds, 0x5272);
    if (temp_cf1)
        goto loc_15b0a;
    if ((short)ax <= (short)0x00c0)
...
loc_15f42:
    ...
    goto loc_15f01;
loc_15f4c:
    temp_cf = memoryAGet(ds, si + 20) < 0x01;
    memoryASet(ds, si + 20, memoryAGet(ds, si + 20) - 0x01);
    memoryASet(ds, si + 20, memoryAGet(ds, si + 20) + (0x00 + temp_cf));
...
loc_16542:
    ...
    memoryASet16(ds, si + 20, ax);
    ax = memoryAGet16(ds, si + 22);
    temp_cf = al < memoryAGet(ds, si + 19);
    al -= memoryAGet(ds, si + 19);
    ah = ah - 0x00 - temp_cf;
    if ((short)memoryAGet16(ds, si + 2) > (short)ax)
        goto loc_165be;
...
loc_1661e:
    ...
    if (al)
        goto loc_16676;
    temp_cf = memoryAGet(ds, si + 15) < 0x01;
    memoryASet(ds, si + 15, memoryAGet(ds, si + 15) - 0x01);
    memoryASet(ds, si + 15, memoryAGet(ds, si + 15) + (0x00 + temp_cf));
...
void sub_16782()
{
    ...
    temp_cf = !!(ax & (1 << (cl-1))) /*ggg - TODO BAD!*/;
    ax = ror16(ax, cl);
    cx = 0x0008;
loc_167ad:
    bool temp_cft = (ax + memoryAGet16(es, si) + temp_cf) >= 0x10000;
    ax += memoryAGet16(es, si) + temp_cf;
    temp_cf = temp_cft;
    si++;
    si++;
    if (--cx)
...
loc_16815:
    bx = 0;
    temp_cf = !!(dh & 0x80) /*ggg5*/;
    dh <<= 1;
    flags.carry = temp_cf /*ggg6*/;
    bx = rcl16(bx, 0x0001);
    temp_cf1 = !!(dl & 0x80) /*ggg5*/;
    dl <<= 1;
    flags.carry = temp_cf1 /*ggg6*/;
    bx = rcl16(bx, 0x0001);
    temp_cf2 = !!(ah & 0x80) /*ggg5*/;
    ah <<= 1;
    flags.carry = temp_cf2 /*ggg6*/;
    bx = rcl16(bx, 0x0001);
    temp_cf3 = !!(al & 0x80) /*ggg5*/;
    al <<= 1;
    flags.carry = temp_cf3 /*ggg6*/;
    bx = rcl16(bx, 0x0001);
    bx <<= 1;
    ...
    bl = memoryAGet(cs, bx);
    bp ^= 0x0001;
    temp_cf4 = !!(bl & 0x80) /*ggg5*/;
    bl <<= 1;
    flags.carry = temp_cf4 /*ggg6*/;
    memoryASet16(cs, 0x66db, rcl16(memoryAGet16(cs, 0x66db), 0x01));
    temp_cf5 = !!(bl & 0x80) /*ggg5*/;
    bl <<= 1;
    flags.carry = temp_cf5 /*ggg6*/;
    memoryASet16(cs, 0x66db, rcl16(memoryAGet16(cs, 0x66db), 0x01));
    if (--cx)
        goto loc_16815;
