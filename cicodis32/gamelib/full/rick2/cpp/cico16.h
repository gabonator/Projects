...
void overlay(const char*, const char*, int, int, int);
...
//  assert(sp > 0); TODO: REMOVE COMMENT
}
void interrupt(int);
void cbw()
{
...
//    if (msg == "stack_bad")
//        return false;
    if (strcmp(msg, "stack_below") == 0 || strcmp(msg, "stack_below_retf, 10/6") == 0 || strcmp(msg, "stack_unbalanced") == 0)
        return false;
    assert(0);
    return false;
}
