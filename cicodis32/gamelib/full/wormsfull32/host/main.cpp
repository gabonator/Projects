...
uint8_t memoryAGet(int s, int o)
{
    ...
    if (o >= 0x197000 && o < 0x197000 + codeObject.size())
        return codeObject[o-0x197000];
    if (o >= 0x1d5000 && o < 0x1d5000 + dataObject.size()) // 0x1d1000+2244480= 3F4F80h
    {
        if (dataObject[o-0x1d5000] == '(' && dataObject[o-0x1d5000+1] == '0' && dataObject[o-0x1d5000+2] == ')')
        {
            int f= 9;
        }
        return dataObject[o-0x1d5000];
    }
    if (o >= 0x410000 && o < 0x410000 + allocator.size())
        return allocator[o-0x410000];
...
void memoryASet(int s, int o, int v)
{
    ...
    if (o >= 0x197000 && o < 0x197000 + codeObject.size())
    {
        codeObject[o-0x197000] = v;
    }
    else if (o >= 0x1d5000 && o < 0x1d5000 + dataObject.size()) // 0x1d1000+2244480= 3F4F80h
        dataObject[o-0x1d5000] = v;
    else if (o >= 0x410000 && o < 0x410000 + allocator.size())
        allocator[o-0x410000] = v;
...
{
    assert(ofs >= 0x410000 && ofs+len < 0x410000 + allocator.size());
    uint8_t* ptr = &allocator[0] + ofs - 0x410000;
...
int main(int argc, const char * argv[]) {
    ...
    // Overlay1: base 0x1a8000 size 0x3dbdf
    // Overlay2: base 0x1e6000 size 0x222840

    codeObject = GetFileContents("/Users/gabrielvalky/Documents/git/Projects/cicodis32/jit3/WRMS_1.bin");
    dataObject = GetFileContents("/Users/gabrielvalky/Documents/git/Projects/cicodis32/jit3/WRMS_2.bin");
    allocator.resize(0x140000);
    zeroSeg.resize(0xa000);
    sdl.Init();
