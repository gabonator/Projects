...
const memorybuf = new ArrayBuffer(0x1240000);
const memory = new Uint8Array(memorybuf, 0, 0x1240000);
const memorys = new Int8Array(memorybuf, 0, 0x1240000);
...
{
  console.assert(ofs >= 0x401000 && ofs < 0x1240000);
