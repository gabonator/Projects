...
void init()
{
    ...
    ss = 0x1cfc;
    sp = 0x0100;
    load("goose.zip", "GOOSE.EXE", 53684);
...
void sub_10010() // 1000:0010 +entry
{
    ax = 0x13a5;
    ds = ax;
    bx = 0x9670;
...
void sub_100fd() // 1000:00fd
{
    memoryASet(ds, 0x0006, 0x01);
}
void sub_10103() // 1000:0103
{
...
void sub_10588() // 1000:0588
{
    ax = 0x0000;
    interrupt(0x33);
    memoryASet(ds, 0x8f0a, al);
}
void sub_10591() // 1000:0591
{
    al = 0x1c;
    ah = 0x35;
    interrupt(0x21);
...
void sub_10644() // 1000:0644
{
    ax = ds;
    memoryASet16(ds, 0x8f20, ax);
    sub_1064d();
}
void sub_1064d() // 1000:064d
{
    push(di);
    push(cx);
    ax = 0x3d00;
...
void sub_107fd() // 1000:07fd +stackDrop4
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_108ba() // 1000:08ba +stackDrop2
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_109b5() // 1000:09b5 +stackDrop6
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_109e9() // 1000:09e9 +stackDrop4
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_10ad5() // 1000:0ad5 +stackDrop4
{
    sp -= 2;
    push(bp);
    bp = sp;
...
loc_10b28: // 1000:0b28
    ...
    push(bx);
    bx -= dx;
    if ((short)bx > (short)memoryAGet16(ss, bp + 6))
        goto loc_10b47;
    bx += dx;
    bx += dx;
    if ((short)bx < (short)memoryAGet16(ss, bp + 6))
...
void sub_10c24() // 1000:0c24 +stackDrop8
{
    sp -= 2;
    push(bp);
    bp = sp;
...
loc_10c44: // 1000:0c44
    ...
    if ((short)memoryAGet16(ss, bp + 4) >= 0)
        goto loc_10c54;
    goto loc_10d8f;
loc_10c54: // 1000:0c54
    if (memoryAGet16(ss, bp + 4))
        goto loc_10c59;
    goto loc_10d8f;
loc_10c59: // 1000:0c59
    ax = -ax;
...
void sub_11b4a() // 1000:1b4a
{
    memoryASet16(ds, si + 7, memoryAGet16(ds, si + 7) - 0x0002);
    memoryASet16(ds, si + 7, memoryAGet16(ds, si + 7) & 0x03ff);
    sub_110a0();
}
void sub_11b57() // 1000:1b57
{
    ax = memoryAGet16(ds, 0x1b8f);
    push(ax);
    ax = memoryAGet16(ds, 0x9528);
...
void sub_11c0a() // 1000:1c0a +stackDrop4
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_12092() // 1000:2092
{
    di = 0x1427;
    sub_120a0();
}
void sub_12099() // 1000:2099
{
    di = 0x12de;
    sub_120a0();
}
void sub_120a0() // 1000:20a0
{
    al = memoryAGet(ds, di);
    memoryASet(ds, si, al);
...
void sub_125e3() // 1000:25e3 +stackDrop4
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_1269e() // 1000:269e +stackDrop8
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_129ae() // 1000:29ae +stackDrop4
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_12cea() // 1000:2cea +stackDrop10
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_12d9a() // 1000:2d9a +stackDrop8
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_1315e() // 1000:315e
{
    cx = -cx;
    cx += 0x006a;
    memoryASet16(ds, si + 7, cx);
}
void sub_13170() // 1000:3170
{
    cx += 0x0080;
    memoryASet16(ds, si + 5, cx);
}
void sub_13181() // 1000:3181
{
    cx += 0x006a;
    memoryASet16(ds, si + 7, cx);
}
void sub_13191() // 1000:3191
{
    cx = -cx;
    cx += 0x0080;
    memoryASet16(ds, si + 5, cx);
}
void sub_131a4() // 1000:31a4
{
    ax = memoryAGet16(ds, 0x94f8);
    es = ax;
    di = 0x0144;
...
void sub_13291() // 1000:3291 +stackDrop4
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_135bc() // 1000:35bc +stackDrop4
{
    sp -= 2;
    push(bp);
    bp = sp;
...
void sub_136d4() // 1000:36d4 +stackDrop8
{
    sp -= 2;
    push(bp);
    bp = sp;
...
loc_13737: // 1000:3737
    ...
    if ((short)ax >= 0)
        goto loc_13751;
    ax = -ax;
    memoryASet16(ss, bp - 10, 0xffe0);
    goto loc_13756;
loc_13751: // 1000:3751
    memoryASet16(ss, bp - 10, 0x0020);
loc_13756: // 1000:3756
    memoryASet16(ss, bp - 4, ax);
...
void fixReloc(uint16_t seg)
{
    memoryASet16(seg, 0x0011, memoryAGet16(seg, 0x0011) + seg); // 03a5 -> 13a5; lin=11
    memoryASet16(seg, 0x04d1, memoryAGet16(seg, 0x04d1) + seg); // 03a5 -> 13a5; lin=4d1
    memoryASet16(seg, 0x05d8, memoryAGet16(seg, 0x05d8) + seg); // 03a5 -> 13a5; lin=5d8
    memoryASet16(seg, 0x0b59, memoryAGet16(seg, 0x0b59) + seg); // 03a5 -> 13a5; lin=b59
}
...
int GetProcAt(int seg, int ofs)
{
    ...
    int map[] = {
        0x10010, 0x1000, 0x10, 0x1000, 0x65, 0x10010, 0x1000, 0x67, 0x1000, 0x96, 
        0x100a9, 0x1000, 0xa9, 0x1000, 0xcf, 0x100cf, 0x1000, 0xcf, 0x1000, 0xfd, 
        0x100fd, 0x1000, 0xfd, 0x1000, 0x103, 0x10103, 0x1000, 0x103, 0x1000, 0x19d, 
        0x1019d, 0x1000, 0x19d, 0x1000, 0x1ad, 0x101ad, 0x1000, 0x1ad, 0x1000, 0x1c0, 
        0x101c0, 0x1000, 0x96, 0x1000, 0xa9, 0x101c0, 0x1000, 0x1c0, 0x1000, 0x33b, 
        0x1033b, 0x1000, 0x33b, 0x1000, 0x442, 0x10442, 0x1000, 0x442, 0x1000, 0x4a5, 
        0x104a5, 0x1000, 0x4a5, 0x1000, 0x4b7, 0x104f3, 0x1000, 0x4f3, 0x1000, 0x528, 
        0x10529, 0x1000, 0x529, 0x1000, 0x541, 0x10541, 0x1000, 0x541, 0x1000, 0x588, 
        0x10588, 0x1000, 0x588, 0x1000, 0x591, 0x10591, 0x1000, 0x591, 0x1000, 0x5bc, 
        0x105bc, 0x1000, 0x5bc, 0x1000, 0x5ce, 0x105ec, 0x1000, 0x5ec, 0x1000, 0x5fc, 
        0x10600, 0x1000, 0x600, 0x1000, 0x637, 0x10637, 0x1000, 0x637, 0x1000, 0x644, 
        0x10644, 0x1000, 0x644, 0x1000, 0x64d, 0x1064d, 0x1000, 0x64d, 0x1000, 0x674, 
